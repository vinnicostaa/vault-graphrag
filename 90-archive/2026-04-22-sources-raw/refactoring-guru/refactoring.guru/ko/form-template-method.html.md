...
-   Code duplication doesn\'t always refer to cases of simple
    copy/paste. Often duplication occurs at a higher level, such as when
    you have a method for sorting numbers and a method for sorting
    object collections that are differentiated only by the comparison of
...
:::: dl
::: dt
[템플릿 메서드](design-patterns/template-method.html)
:::
::::
:::::
