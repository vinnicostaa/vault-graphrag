...
-   If you need to add a new interface view, create new presentation
    classes; you don\'t need to touch the code of the business logic
...
1.  Hide direct access to domain data in the *GUI class*. For this,
    it\'s best to use [Self Encapsulate
    Field](self-encapsulate-field.html). So you create the getters and
    setters for this data.
...
:::: dl
::: dt
[옵서버](design-patterns/observer.html)
:::
::::
:::::
