...
# 타입스크립트로 작성된 **데코레이터** {#타입스크립트로-작성된-데코레이터 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 데코레이터는 타입스크립트 코드, 특히 스트림과 관련된
코드에서 꽤 표준적입니다.
...
복합체](../../composite/typescript/example.html){.btn .btn-default
rel="prev"}
:::
