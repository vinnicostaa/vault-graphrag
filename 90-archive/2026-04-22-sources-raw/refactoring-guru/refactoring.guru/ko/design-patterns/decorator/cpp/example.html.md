...
[데코레이터](../../decorator.html){.type} / [C++](../../cpp.html){.type}
:::
...
# C++로 작성된 **데코레이터** {#c로-작성된-데코레이터 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 데코레이터는 C++ 코드, 특히 스트림과 관련된 코드에서 꽤
표준적입니다.
...
복합체](../../composite/cpp/example.html){.btn .btn-default rel="prev"}
:::
