...
[커맨드](../../command.html){.type} / [러스트](../../rust.html){.type}
:::
...
# 러스트로 작성된 **커맨드** {#러스트로-작성된-커맨드 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} 러스트로 작성된 책임
연쇄](../../chain-of-responsibility/rust/example.html){.btn .btn-default
rel="prev"}
:::
