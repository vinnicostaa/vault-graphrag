...
[브리지](../../bridge.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **브리지** {#c으로-작성된-브리지 .pattern-example-title-block-title}
::::
...
어댑터](../../adapter/csharp/example.html){.btn .btn-default rel="prev"}
:::
