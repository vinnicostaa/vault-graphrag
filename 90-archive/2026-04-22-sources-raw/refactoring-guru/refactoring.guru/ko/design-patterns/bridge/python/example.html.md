...
[브리지](../../bridge.html){.type} / [파이썬](../../python.html){.type}
:::
...
# 파이썬으로 작성된 **브리지** {#파이썬으로-작성된-브리지 .pattern-example-title-block-title}
::::
...
어댑터](../../adapter/python/example.html){.btn .btn-default rel="prev"}
:::
