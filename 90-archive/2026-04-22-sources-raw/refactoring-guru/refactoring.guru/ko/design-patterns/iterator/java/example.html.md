...
[반복자](../../iterator.html){.type} / [자바](../../java.html){.type}
:::
...
# 자바로 작성된 **반복자** {#자바로-작성된-반복자 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 이 패턴은 자바 코드에 자주 사용됩니다. 많은
프레임워크들과 라이브러리들은 이 패턴을 컬렉션을 탐색하는 표준 방법을
제공하기 위해 사용합니다.

다음은 코어 자바 라이브러리로부터 가져온 몇 가지 예시들입니다:

-   [`java.util.Iterator`](http://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html)와
    [`java.util.Scanner`](http://docs.oracle.com/javase/8/docs/api/java/util/Scanner.html)의
    모든 구현.

-   [`java.util.Enumeration`](http://docs.oracle.com/javase/8/docs/api/java/util/Enumeration.html)의
    모든 구현.
...
## 소셜 네트워크 프로필을 순회하기 {#example-0-title}

이 예시는 반복자 패턴을 사용하여 클라이언트 코드에 아무런 통신 내용을
노출하지 않은 상태로 원격 소셜 네트워크 컬렉션의 소셜 프로필들을
순회하는 방법을 다룹니다.

### []{#example-0--iterators .anchor} **iterators** {#iterators .example-title}

#### []{#example-0--iterators-ProfileIterator-java .anchor} **iterators/ProfileIterator.java:** 프로필 인터페이스의 정의
...
#### []{#example-0--iterators-FacebookIterator-java .anchor} **iterators/FacebookIterator.java:** 페이스북 프로필들에 대한 순회의 구현
...
#### []{#example-0--iterators-LinkedInIterator-java .anchor} **iterators/LinkedInIterator.java:** 링크드인 프로필들에 대한 순회의 구현
...
#### []{#example-0--social_networks-SocialNetwork-java .anchor} **social_networks/SocialNetwork.java:** 공통 소셜 네트워크 인터페이스의 정의
...
#### []{#example-0--social_networks-Facebook-java .anchor} **social_networks/Facebook.java:** 페이스북
...
#### []{#example-0--social_networks-LinkedIn-java .anchor} **social_networks/LinkedIn.java:** 링크드인
...
#### []{#example-0--profile-Profile-java .anchor} **profile/Profile.java:** 소셜 프로필
...
#### []{#example-0--spammer-SocialSpammer-java .anchor} **spammer/SocialSpammer.java:** 메시지 전송 앱
...
커맨드](../../command/java/example.html){.btn .btn-default rel="prev"}
:::
