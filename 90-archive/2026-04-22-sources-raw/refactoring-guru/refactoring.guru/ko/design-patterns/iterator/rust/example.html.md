...
[반복자](../../iterator.html){.type} / [러스트](../../rust.html){.type}
:::
...
# 러스트로 작성된 **반복자** {#러스트로-작성된-반복자 .pattern-example-title-block-title}
::::
...
커맨드](../../command/rust/example.html){.btn .btn-default rel="prev"}
:::
