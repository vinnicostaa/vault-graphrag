...
[복합체](../../composite.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **복합체** {#c으로-작성된-복합체 .pattern-example-title-block-title}
::::
...
브리지](../../bridge/csharp/example.html){.btn .btn-default rel="prev"}
:::
