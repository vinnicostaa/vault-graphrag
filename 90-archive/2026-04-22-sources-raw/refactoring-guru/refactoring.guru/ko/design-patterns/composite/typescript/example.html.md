...
# 타입스크립트로 작성된 **복합체** {#타입스크립트로-작성된-복합체 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 복합체 패턴은 타입스크립트 코드에서 매우 일반적입니다.
...
브리지](../../bridge/typescript/example.html){.btn .btn-default
rel="prev"}
:::
