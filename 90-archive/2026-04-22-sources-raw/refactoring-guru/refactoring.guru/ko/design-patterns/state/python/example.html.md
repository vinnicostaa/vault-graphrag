...
[상태](../../state.html){.type} / [파이썬](../../python.html){.type}
:::
...
# 파이썬으로 작성된 **상태** {#파이썬으로-작성된-상태 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 상태 패턴은 일반적으로 파이썬에서 대규모 `switch` 기반
...
옵서버](../../observer/python/example.html){.btn .btn-default
rel="prev"}
:::
