...
[상태](../../state.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **상태** {#c으로-작성된-상태 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 상태 패턴은 일반적으로 C#에서 대규모 `switch` 기반 상태
머신들을 객체들로 변환하는 데 사용됩니다.
...
옵서버](../../observer/csharp/example.html){.btn .btn-default
rel="prev"}
:::
