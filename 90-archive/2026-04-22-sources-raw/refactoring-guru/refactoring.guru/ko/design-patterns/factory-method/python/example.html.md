...
# 파이썬으로 작성된 **팩토리 메서드** {#파이썬으로-작성된-팩토리-메서드 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 팩토리 메서드 패턴은 파이썬 코드에서 널리 사용되며
...
빌더](../../builder/python/example.html){.btn .btn-default rel="prev"}
:::
