...
메서드](../../factory-method.html){.type} / [C++](../../cpp.html){.type}
:::
...
# C++로 작성된 **팩토리 메서드** {#c로-작성된-팩토리-메서드 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 팩토리 메서드 패턴은 C++ 코드에서 널리 사용되며 코드에
...
빌더](../../builder/cpp/example.html){.btn .btn-default rel="prev"}
:::
