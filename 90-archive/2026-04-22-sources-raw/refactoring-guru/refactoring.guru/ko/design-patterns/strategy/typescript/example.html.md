...
# 타입스크립트로 작성된 **전략** {#타입스크립트로-작성된-전략 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 전략 패턴은 타입스크립트 코드에서 매우 일반적으로
...
상태](../../state/typescript/example.html){.btn .btn-default rel="prev"}
:::
