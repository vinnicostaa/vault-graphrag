...
[전략](../../strategy.html){.type} / [C++](../../cpp.html){.type}
:::
...
# C++로 작성된 **전략** {#c로-작성된-전략 .pattern-example-title-block-title}
::::
...
상태](../../state/cpp/example.html){.btn .btn-default rel="prev"}
:::
