...
[메멘토](../../memento.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **메멘토** {#c으로-작성된-메멘토 .pattern-example-title-block-title}
::::
...
이는 C 코드에서 매우 일반적입니다. 직렬화는 객체 상태의 스냅숏을 만드는
...
중재자](../../mediator/csharp/example.html){.btn .btn-default
rel="prev"}
:::
