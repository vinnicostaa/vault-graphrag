...
# 타입스크립트로 작성된 **메멘토** {#타입스크립트로-작성된-메멘토 .pattern-example-title-block-title}
::::
...
이는 타입스크립트 코드에서 매우 일반적입니다. 직렬화는 객체 상태의
스냅숏을 만드는 유일한 또는 가장 효율적인 방법은 아니나 다른 객체로부터
...
중재자](../../mediator/typescript/example.html){.btn .btn-default
rel="prev"}
:::
