...
# 타입스크립트로 작성된 **비지터** {#타입스크립트로-작성된-비지터 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} 타입스크립트로 작성된 템플릿
메서드](../../template-method/typescript/example.html){.btn .btn-default
rel="prev"}
:::
