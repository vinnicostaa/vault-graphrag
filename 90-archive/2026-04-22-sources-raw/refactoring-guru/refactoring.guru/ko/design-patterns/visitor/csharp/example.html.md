...
[비지터](../../visitor.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **비지터** {#c으로-작성된-비지터 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} C#으로 작성된 템플릿
메서드](../../template-method/csharp/example.html){.btn .btn-default
rel="prev"}
:::
