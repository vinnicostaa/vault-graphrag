...
[비지터](../../visitor.html){.type} / [파이썬](../../python.html){.type}
:::
...
# 파이썬으로 작성된 **비지터** {#파이썬으로-작성된-비지터 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} 파이썬으로 작성된 템플릿
메서드](../../template-method/python/example.html){.btn .btn-default
rel="prev"}
:::
