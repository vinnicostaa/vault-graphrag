...
[비지터](../../visitor.html){.type} / [러스트](../../rust.html){.type}
:::
...
# 러스트로 작성된 **비지터** {#러스트로-작성된-비지터 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} 러스트로 작성된 템플릿
메서드](../../template-method/rust/example.html){.btn .btn-default
rel="prev"}
:::
