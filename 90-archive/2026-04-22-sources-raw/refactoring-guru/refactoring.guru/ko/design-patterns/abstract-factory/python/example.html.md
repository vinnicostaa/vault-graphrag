...
# 파이썬으로 작성된 **추상 팩토리** {#파이썬으로-작성된-추상-팩토리 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 추상 팩토리 패턴은 파이썬 코드에 자주 사용됩니다. 많은
...
[[]{.fa .fa-arrow-left} 파이썬으로 작성된 디자인
패턴들](../../python.html){.btn .btn-default rel="prev"}
:::
