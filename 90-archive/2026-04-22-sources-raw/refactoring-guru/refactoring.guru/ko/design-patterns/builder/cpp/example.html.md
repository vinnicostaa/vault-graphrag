...
[빌더](../../builder.html){.type} / [C++](../../cpp.html){.type}
:::
...
# C++로 작성된 **빌더** {#c로-작성된-빌더 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} C++로 작성된 추상
팩토리](../../abstract-factory/cpp/example.html){.btn .btn-default
rel="prev"}
:::
