...
[빌더](../../builder.html){.type} / [스위프트](../../swift.html){.type}
:::
...
# 스위프트로 작성된 **빌더** {#스위프트로-작성된-빌더 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 빌더 패턴은 스위프트 개발자들에게 잘 알려진 패턴이며,
...
[[]{.fa .fa-arrow-left} 스위프트로 작성된 추상
팩토리](../../abstract-factory/swift/example.html){.btn .btn-default
rel="prev"}
:::
