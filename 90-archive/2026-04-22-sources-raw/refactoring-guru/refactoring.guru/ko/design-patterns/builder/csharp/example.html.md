...
[빌더](../../builder.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **빌더** {#c으로-작성된-빌더 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 빌더 패턴은 C 개발자들에게 잘 알려진 패턴이며, 가능한
...
[[]{.fa .fa-arrow-left} C#으로 작성된 추상
팩토리](../../abstract-factory/csharp/example.html){.btn .btn-default
rel="prev"}
:::
