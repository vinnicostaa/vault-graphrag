...
[빌더](../../builder.html){.type} / [러스트](../../rust.html){.type}
:::
...
# 러스트로 작성된 **빌더** {#러스트로-작성된-빌더 .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} 러스트로 작성된 추상
팩토리](../../abstract-factory/rust/example.html){.btn .btn-default
rel="prev"}
:::
