...
# 타입스크립트로 작성된 **빌더** {#타입스크립트로-작성된-빌더 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 빌더 패턴은 타입스크립트 개발자들에게 잘 알려진
패턴이며, 가능한 설정 옵션이 많은 객체를 만들어야 할 때 특히 유용합니다.
...
[[]{.fa .fa-arrow-left} 타입스크립트로 작성된 추상
팩토리](../../abstract-factory/typescript/example.html){.btn
