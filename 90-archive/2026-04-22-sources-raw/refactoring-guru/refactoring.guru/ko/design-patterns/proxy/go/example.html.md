...
[프록시](../../proxy.html){.type} / [Go](../../go.html){.type}
:::
...
# Go로 작성된 **프록시** {#go로-작성된-프록시 .pattern-example-title-block-title}
::::
...
Nginx 같은 웹서버는 당신의 애플리케이션 서버의 프록시 역할을 할 수
있습니다:
...
#### []{#example-0--server-go .anchor} **server.go:** 주제
...
#### []{#example-0--nginx-go .anchor} **nginx.go:** 프록시
...
#### []{#example-0--application-go .anchor} **application.go:** 실제 주제
...
플라이웨이트](../../flyweight/go/example.html){.btn .btn-default
rel="prev"}
:::
