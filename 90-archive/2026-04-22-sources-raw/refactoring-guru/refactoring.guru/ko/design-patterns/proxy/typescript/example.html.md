...
# 타입스크립트로 작성된 **프록시** {#타입스크립트로-작성된-프록시 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 프록시 패턴은 대부분의 타입스크립트 앱에서 일반적으로
...
플라이웨이트](../../flyweight/typescript/example.html){.btn .btn-default
rel="prev"}
:::
