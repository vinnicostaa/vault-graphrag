...
# 타입스크립트로 작성된 **책임 연쇄** {#타입스크립트로-작성된-책임-연쇄 .pattern-example-title-block-title}
::::
...
**사용 예시들:** 책임 연쇄 패턴은 타입스크립트 코드에 매우 일반적이며,
당신의 코드가 필터, 이벤터 체인 등과 같은 객체 체인과 함께 작동할 때
특히 유용합니다.
...
프록시](../../proxy/typescript/example.html){.btn .btn-default
rel="prev"}
:::
