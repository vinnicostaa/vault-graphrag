...
[퍼사드](../../facade.html){.type} / [C#](../../csharp.html){.type}
:::
...
# C#으로 작성된 **퍼사드** {#c으로-작성된-퍼사드 .pattern-example-title-block-title}
::::
...
**사용 사례들:** 퍼사드 패턴은 일반적으로 C 코드로 작성된 앱에서
...
데코레이터](../../decorator/csharp/example.html){.btn .btn-default
rel="prev"}
:::
