...
Create a superclass constructor and move the code that\'s the same in
the subclasses to it. Call the superclass constructor in the subclass
constructors.
:::
:::::
...
1.  In Java, subclasses can\'t inherit a constructor, so you can\'t
    simply apply [Pull Up Method](pull-up-method.html) to the subclass
