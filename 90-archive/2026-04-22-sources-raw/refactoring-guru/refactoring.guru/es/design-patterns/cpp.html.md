...
# [PATRONES]{.dp1-h-1} [de]{.dp-h-article} [DISEÑO]{.dp1-h-2} [en]{.dp-lang-in} [C++]{.dp-lang} {#patrones-de-diseño-en-c .dp1-h .dp-abs .dp-c .dp-h1}
::::
...
[ Uso en C++](builder/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](adapter/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Ejemplo
conceptual](adapter/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso en C++](bridge/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](facade/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](proxy/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ Ejemplo de código](proxy/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso en C++](command/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](iterator/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](mediator/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](memento/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](observer/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](state/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ Ejemplo de código](state/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso en C++](strategy/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Uso en C++](visitor/cpp/example.html#lang-features){.dp-pattern-link}
