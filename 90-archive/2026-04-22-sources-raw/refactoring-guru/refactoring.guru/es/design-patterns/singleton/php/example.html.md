...
# **Singleton** en PHP {#singleton-en-php .pattern-example-title-block-title}
::::
...
El patrón **Singleton** es famoso por limitar la reutilización de código
y complicar las pruebas de unidad. No obstante, sigue resultando muy
útil en algunos casos. En particular, viene bien cuando debes controlar
recursos compartidos. Por ejemplo, un objeto de registro global debe
controlar el acceso a un archivo de registro. Otro buen ejemplo: un
