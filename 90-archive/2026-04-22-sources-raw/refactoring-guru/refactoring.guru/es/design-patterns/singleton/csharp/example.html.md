...
role="tab" aria-controls="example-1" aria-selected="true"} [¿Quieres
más?](#example-2){#example-2-tab .nav-item .nav-link toggle="tab"
...
#### []{#example-1--Program-cs .anchor} **Program.cs:** Ejemplo conceptual
...
## ¿Quieres más? {#example-2-title}

Existen variedades aún más especiales del patrón Singleton en C#.
Consulta este artículo para saber más:

[C# en profundidad: Implementar
...
[¿Quieres más?](#example-2){#example-2-tab-bottom .nav-item .nav-link
