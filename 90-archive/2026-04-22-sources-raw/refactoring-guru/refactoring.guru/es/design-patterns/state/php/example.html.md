...
[State](../../state.html){.type} / [PHP](../../php.html){.type}
:::
...
# **State** en PHP {#state-en-php .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** El patrón State se utiliza ocasionalmente en PHP
para convertir grandes y voluminosas máquinas de estados basadas en
operadores `switch`, en objetos.
...
Este ejemplo ilustra la estructura del patrón de diseño **State** y se
...
el siguiente ejemplo basado en un caso de uso real en PHP.
...
En este ejemplo, el patrón **State** se utiliza para representar varios
estados de la Factura. Este enfoque permite implementar varias
verificaciones de condiciones al hacer la transición de la factura de un
estado a otro, así como encapsular la lógica de cada estado en una clase
separada.

#### []{#example-1--index-php .anchor} **index.php:** Ejemplo conceptual
...
PHP](../../observer/php/example.html){.btn .btn-default rel="prev"}
:::
