...
# **State** en Swift {#state-en-swift .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** El patrón State se utiliza habitualmente en Swift
...
el siguiente ejemplo basado en un caso de uso real en Swift.
