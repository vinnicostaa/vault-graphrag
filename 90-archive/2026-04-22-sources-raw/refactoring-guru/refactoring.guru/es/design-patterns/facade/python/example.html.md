...
# **Facade** en Python {#facade-en-python .pattern-example-title-block-title}
::::
...
aplicaciones escritas en Python. Es de especial utilidad al trabajar con
...
Este ejemplo ilustra la estructura del patrón de diseño **Facade**. Se
