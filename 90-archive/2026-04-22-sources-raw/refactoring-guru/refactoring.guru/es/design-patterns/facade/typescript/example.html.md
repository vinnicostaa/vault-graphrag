...
# **Facade** en TypeScript {#facade-en-typescript .pattern-example-title-block-title}
::::
...
aplicaciones escritas en TypeScript. Es de especial utilidad al trabajar
con bibliotecas y API complejas.
