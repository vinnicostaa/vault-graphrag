...
# **Memento** en Python {#memento-en-python .pattern-example-title-block-title}
::::
...
utilizando la serialización, que es bastante habitual en Python. Aunque
