...
# **Memento** en TypeScript {#memento-en-typescript .pattern-example-title-block-title}
::::
...
utilizando la serialización, que es bastante habitual en TypeScript.
Aunque no es la única forma ni la más efectiva de realizar instantáneas
del estado de un objeto, permite almacenar copias de seguridad del
estado mientras protege de otros objetos la estructura del originador.
:::::::::::
