...
# **Memento** en PHP {#memento-en-php .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** La aplicabilidad real del patrón Memento en PHP es
muy cuestionable. En la mayoría de los casos, puedes realizar una copia
del estado de un objeto con más facilidad utilizando la serialización.
::::::::::::::
...
En este ejemplo, el patrón **Memento** se usa para implementar un flujo
de gestión de configuración para una aplicación web en PHP. Muchas
aplicaciones permiten a los usuarios personalizar sus ajustes y, en
ocasiones, esos usuarios desean revertir los cambios y restaurar la
configuración anterior. El patrón Memento puede emplearse para
implementar esta funcionalidad capturando y almacenando el estado del
objeto de configuración antes de que se haga cualquier cambio.
