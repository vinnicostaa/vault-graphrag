...
# **Builder** en Python {#builder-en-python .pattern-example-title-block-title}
::::
...
Python. Resulta especialmente útil cuando debes crear un objeto con
