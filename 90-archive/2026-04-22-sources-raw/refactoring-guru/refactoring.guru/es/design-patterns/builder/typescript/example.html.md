...
# **Builder** en TypeScript {#builder-en-typescript .pattern-example-title-block-title}
::::
...
TypeScript. Resulta especialmente útil cuando debes crear un objeto con
...
[Factory Method en TypeScript []{.fa
