...
[Builder](../../builder.html){.type} / [C++](../../cpp.html){.type}
:::
...
# **Builder** en C++ {#builder-en-c .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** El patrón Builder es muy conocido en el mundo C++.
...
Este ejemplo ilustra la estructura del patrón de diseño **Builder**. Se
