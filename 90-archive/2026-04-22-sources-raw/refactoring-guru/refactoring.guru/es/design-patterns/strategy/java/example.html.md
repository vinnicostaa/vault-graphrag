...
[Strategy](../../strategy.html){.type} / [Java](../../java.html){.type}
:::
...
# **Strategy** en Java {#strategy-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Medio de pago en una aplicación de comercio electrónico](#example-0)
:::
...
**Ejemplos de uso:** El patrón Strategy es muy común en el código Java.
...
Java 8 brindó el soporte de funciones lambda, que pueden servir como
alternativas más sencillas al patrón Strategy.

Aquí tienes algunos ejemplos del patrón Strategy en las principales
bibliotecas Java:

-   [`java.util.Comparator#compare()`](http://docs.oracle.com/javase/8/docs/api/java/util/Comparator.html#compare-T-T-)
    invocado desde el método `Collections#sort()`.

-   [`javax.servlet.http.HttpServlet`](http://docs.oracle.com/javaee/7/api/javax/servlet/http/HttpServlet.html):
    `service()`, más todos los métodos `doXXX()` que aceptan objetos
    `HttpServletRequest` y `HttpServletResponse` como argumentos.
...
## Medio de pago en una aplicación de comercio electrónico {#example-0-title}

En este ejemplo, el patrón Strategy se utiliza para implementar los
distintos medios de pago de una aplicación de comercio electrónico. Una
vez seleccionado el producto a comprar, un cliente elige un medio de
pago: Paypal o tarjeta de crédito.

Las estrategias concretas no solo realizan el propio pago, sino que
además alteran el comportamiento del formulario de pago, proporcionando
campos adecuados para el registro de los datos del pago.

### []{#example-0--strategies .anchor} **strategies** {#strategies .example-title}

#### []{#example-0--strategies-PayStrategy-java .anchor} **strategies/PayStrategy.java:** Interfaz común de los medios de pago
...
#### []{#example-0--strategies-PayByPayPal-java .anchor} **strategies/PayByPayPal.java:** Pago con PayPal
...
#### []{#example-0--strategies-PayByCreditCard-java .anchor} **strategies/PayByCreditCard.java:** Pago con tarjeta de crédito
...
#### []{#example-0--strategies-CreditCard-java .anchor} **strategies/CreditCard.java:** Una clase de tarjeta de crédito
...
#### []{#example-0--order-Order-java .anchor} **order/Order.java:** Clase de pedido
