...
**Ejemplos de uso:** El patrón Strategy es muy común en el código C#. Se
utiliza a menudo en varios *frameworks* para proporcionar a los usuarios
una forma de cambiar el comportamiento de una clase sin extenderla.
