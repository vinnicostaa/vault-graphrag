...
# **Strategy** en Swift {#strategy-en-swift .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** El patrón Strategy es muy común en el código Swift.
