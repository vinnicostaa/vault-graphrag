...
# **Template Method** en Python {#template-method-en-python .pattern-example-title-block-title}
::::
...
*frameworks* Python. Los desarrolladores lo utilizan a menudo para
