...
# **Template Method** en Java {#template-method-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Pasos estándar para sobrescribir un algoritmo](#example-0)
:::
...
*frameworks* de Java. Los desarrolladores lo utilizan a menudo para
proporcionar a los usuarios de *frameworks* medios sencillos para
extender la funcionalidad estándar utilizando la herencia.

Aquí tienes algunos ejemplos del patrón Template Method en las
principales bibliotecas Java:
...
-   [`javax.servlet.http.HttpServlet`](http://docs.oracle.com/javaee/7/api/javax/servlet/http/HttpServlet.html),
    todos los métodos `doXXX()` por defecto envían un mensaje de error
    HTTP 405 "Método no permitido" como respuesta. Puedes sobrescribir
    cualquiera de ellos.
...
## Pasos estándar para sobrescribir un algoritmo {#example-0-title}

En este ejemplo, el patrón Template Method define un algoritmo para
trabajar con una red social. Las subclases que coinciden con una red
social particular implementan estos pasos de acuerdo con la API
suministrada por la red social.

### []{#example-0--networks .anchor} **networks** {#networks .example-title}

#### []{#example-0--networks-Network-java .anchor} **networks/Network.java:** Clase base de red social
...
#### []{#example-0--networks-Facebook-java .anchor} **networks/Facebook.java:** Red social concreta
...
#### []{#example-0--networks-Twitter-java .anchor} **networks/Twitter.java:** Otra red social
