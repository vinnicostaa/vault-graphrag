...
# **Visitor** en C++ {#visitor-en-c .pattern-example-title-block-title}
::::
...
Este ejemplo ilustra la estructura del patrón de diseño **Visitor**. Se
...
[Patrones de diseño en Go []{.fa .fa-arrow-right}](../../go.html){.btn
