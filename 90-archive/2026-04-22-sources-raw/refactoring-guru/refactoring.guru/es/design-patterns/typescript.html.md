...
# [PATRONES]{.dp1-h-1} [de]{.dp-h-article} [DISEÑO]{.dp1-h-2} [en]{.dp-lang-in} [TypeScript]{.dp-lang} {#patrones-de-diseño-en-typescript .dp1-h .dp-abs .dp-c .dp-h1}
::::

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## El catálogo de ejemplos en **TypeScript** {#el-catálogo-de-ejemplos-en-typescript .dp-h2}
...
[ Ejemplo de
código](abstract-factory/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](builder/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](factory-method/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](prototype/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](singleton/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](adapter/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](bridge/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](composite/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](decorator/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](facade/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](flyweight/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](proxy/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](chain-of-responsibility/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](command/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](iterator/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](mediator/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](memento/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](observer/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](state/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](strategy/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](template-method/typescript/example.html#example-0){.dp-pattern-link}
...
[ Ejemplo de
código](visitor/typescript/example.html#example-0){.dp-pattern-link}
