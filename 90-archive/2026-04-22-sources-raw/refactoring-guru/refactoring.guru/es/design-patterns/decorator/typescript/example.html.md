...
# **Decorator** en TypeScript {#decorator-en-typescript .pattern-example-title-block-title}
::::
...
TypeScript, especialmente en el código relacionado con los flujos
(streams).
