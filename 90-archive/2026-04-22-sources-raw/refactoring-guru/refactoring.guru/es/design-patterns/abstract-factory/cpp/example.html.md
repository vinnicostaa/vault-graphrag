...
# **Abstract Factory** en C++ {#abstract-factory-en-c .pattern-example-title-block-title}
::::
...
código C++. Muchos *frameworks* y bibliotecas lo utilizan para
...
[[]{.fa .fa-arrow-left} Patrones de diseño en C++](../../cpp.html){.btn
