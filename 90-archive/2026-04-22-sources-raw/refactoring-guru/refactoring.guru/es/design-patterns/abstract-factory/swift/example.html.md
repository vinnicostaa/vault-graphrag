...
# **Abstract Factory** en Swift {#abstract-factory-en-swift .pattern-example-title-block-title}
::::
...
código Swift. Muchos *frameworks* y bibliotecas lo utilizan para
...
Factory**, centrándose en responder las siguientes preguntas:
