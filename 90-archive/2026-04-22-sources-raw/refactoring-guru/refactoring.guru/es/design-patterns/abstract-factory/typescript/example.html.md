...
# **Abstract Factory** en TypeScript {#abstract-factory-en-typescript .pattern-example-title-block-title}
::::
...
código TypeScript. Muchos *frameworks* y bibliotecas lo utilizan para
