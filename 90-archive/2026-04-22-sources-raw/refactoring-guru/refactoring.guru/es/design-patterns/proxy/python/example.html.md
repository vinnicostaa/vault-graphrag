...
# **Proxy** en Python {#proxy-en-python .pattern-example-title-block-title}
::::
...
en la mayoría de aplicaciones Python, resulta de mucha utilidad en
...
[Chain of Responsibility en Python []{.fa
