...
# **Proxy** en TypeScript {#proxy-en-typescript .pattern-example-title-block-title}
::::
...
en la mayoría de aplicaciones TypeScript, resulta de mucha utilidad en
...
[Chain of Responsibility en TypeScript []{.fa
