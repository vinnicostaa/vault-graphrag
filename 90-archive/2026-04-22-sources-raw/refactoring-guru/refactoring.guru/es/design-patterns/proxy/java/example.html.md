...
# **Proxy** en Java {#proxy-en-java .pattern-example-title-block-title}
::::
...
en la mayoría de aplicaciones Java, resulta de mucha utilidad en algunos
...
-   [`javax.ejb.EJB`](http://docs.oracle.com/javaee/7/api/javax/ejb/EJB.html)
    ([véanse los
    comentarios](http://stackoverflow.com/questions/25514361/when-using-ejb-does-each-managed-bean-get-its-own-ejb-instance))
-   [`javax.inject.Inject`](http://docs.oracle.com/javaee/7/api/javax/inject/Inject.html)
    ([véanse los
    comentarios](http://stackoverflow.com/questions/29651008/field-getobj-returns-all-nulls-on-injected-cdi-managed-beans-while-manually-i/29672591#29672591))
...
## Proxy de caché {#example-0-title}

En este ejemplo, el patrón Proxy ayuda a implementar la inicialización
diferida y el almacenamiento en caché a una ineficiente biblioteca de
integración de YouTube de un tercero.

Proxy es muy valioso cuando tienes que añadir comportamientos a una
clase cuyo código no puedes cambiar.

### []{#example-0--some_cool_media_library .anchor} **some_cool_media_library** {#some_cool_media_library .example-title}

#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeLib-java .anchor} **some_cool_media_library/ThirdPartyYouTubeLib.java:** Interfaz de servicio remoto
...
#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeClass-java .anchor} **some_cool_media_library/ThirdPartyYouTubeClass.java:** Implementación de servicio remoto
...
#### []{#example-0--some_cool_media_library-Video-java .anchor} **some_cool_media_library/Video.java:** Archivo de video
...
#### []{#example-0--proxy-YouTubeCacheProxy-java .anchor} **proxy/YouTubeCacheProxy.java:** Proxy de caché
...
#### []{#example-0--downloader-YouTubeDownloader-java .anchor} **downloader/YouTubeDownloader.java:** Aplicación de descarga de medios
...
[Chain of Responsibility en Java []{.fa
