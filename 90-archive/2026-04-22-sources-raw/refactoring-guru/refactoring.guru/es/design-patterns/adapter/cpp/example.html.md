...
aria-selected="true"} [Herencia múltiple](#example-1){#example-1-tab
...
## Herencia múltiple {#example-1-title}

En C++, el patrón **Adapter** puede implementarse utilizando la herencia
múltiple.

#### []{#example-1--main-cc .anchor} **main.cc:** Herencia múltiple
...
aria-selected="true"} [Herencia
múltiple](#example-1){#example-1-tab-bottom .nav-item .nav-link
