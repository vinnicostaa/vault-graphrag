...
# **Iterator** en TypeScript {#iterator-en-typescript .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** El patrón es muy común en el código TypeScript.
Muchos *frameworks* y bibliotecas lo utilizan para proporcionar una
forma estandarizada de recorrer sus colecciones.
