...
# **Command** en C# {#command-en-c .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** El patrón Command es muy común en el código C#. La
mayoría de las veces se utiliza como alternativa a las retrollamadas
