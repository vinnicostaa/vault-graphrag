...
# **Observer** en TypeScript {#observer-en-typescript .pattern-example-title-block-title}
::::
...
código TypeScript, sobre todo en los componentes GUI. Proporciona una
forma de reaccionar a los eventos que suceden en otros objetos, sin
