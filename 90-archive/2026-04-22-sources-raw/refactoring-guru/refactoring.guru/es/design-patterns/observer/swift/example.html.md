...
# **Observer** en Swift {#observer-en-swift .pattern-example-title-block-title}
::::
...
código Swift, sobre todo en los componentes GUI. Proporciona una forma
de reaccionar a los eventos que suceden en otros objetos, sin acoplarse
a sus clases.
