...
# **Chain of Responsibility** en Swift {#chain-of-responsibility-en-swift .pattern-example-title-block-title}
::::
...
habitual en el programa Swift, ya que tan solo es relevante cuando el
