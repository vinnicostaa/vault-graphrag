...
[Mediator](../../mediator.html){.type} / [Java](../../java.html){.type}
:::
...
# **Mediator** en Java {#mediator-en-java .pattern-example-title-block-title}
::::
...
Java es para facilitar las comunicaciones entre los componentes GUI de
...
## Aplicación de notas {#example-0-title}

Este ejemplo muestra cómo organizar varios elementos GUI para que
cooperen con la ayuda de un mediador sin que dependan los unos de los
otros.

### []{#example-0--components .anchor} **components:** Clases colega {#components-clases-colega .example-title}
...
#### []{#example-0--mediator-Mediator-java .anchor} **mediator/Mediator.java:** Define la interfaz mediadora común
...
#### []{#example-0--mediator-Editor-java .anchor} **mediator/Editor.java:** Mediadora concreta
...
#### []{#example-0--mediator-Note-java .anchor} **mediator/Note.java:** Una clase de nota
