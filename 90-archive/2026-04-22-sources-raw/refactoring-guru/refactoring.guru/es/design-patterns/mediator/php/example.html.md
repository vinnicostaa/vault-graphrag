...
# **Mediator** en PHP {#mediator-en-php .pattern-example-title-block-title}
::::
...
**Ejemplos de uso:** La implementación pura del patrón Mediator no es
tan común en PHP como en otros lenguajes, sobre todo aquellos enfocados
en la GUI, como Java o C#. Una aplicación PHP puede contener decenas de
componentes, pero raramente se comunican directamente en una única
sesión.

Sin embargo, sigue habiendo usos para el patrón Mediator, como los
despachadores de eventos de muchos *frameworks* PHP, o algunas
implementaciones de controladores MVC.
::::::::::::::
...
En este ejemplo, el patrón **Mediator** amplía la idea del patrón
Observer proporcionando un despachador de eventos centralizado. Permite
a cualquier objeto rastrear y disparar eventos en otros objetos sin
