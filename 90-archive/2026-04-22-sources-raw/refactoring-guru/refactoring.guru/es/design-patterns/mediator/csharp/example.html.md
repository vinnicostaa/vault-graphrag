...
**Ejemplos de uso:** El uso más popular del patrón Mediator en código C#
es para facilitar las comunicaciones entre los componentes GUI de una
aplicación. El sinónimo del patrón Mediator es la parte del Controlador
del patrón MVC.
:::::::::::
