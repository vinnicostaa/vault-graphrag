...
Refactoring.Guru ("us", "we", or "our") operates the
https://refactoring.guru website (the "Service").
...
our Terms and Conditions, accessible from https://refactoring.guru

## Definitions

-   **Service**

Service is the https://refactoring.guru website operated by
Refactoring.Guru
...
Refactoring.Guru uses the collected data for various purposes:
...
If you are from the European Economic Area (EEA), Refactoring.Guru legal
...
Refactoring.Guru will retain your Personal Data only for as long as is
...
Refactoring.Guru will also retain Usage Data for internal analysis
...
If you are located outside Ukraine and choose to provide information to
us, please note that we transfer the data, including Personal Data, to
Ukraine and process it there.

Your consent to this Privacy Policy followed by your submission of such
information represents your agreement to that transfer.

Refactoring.Guru will take all steps reasonably necessary to ensure that
...
Under certain circumstances, Refactoring.Guru may be required to
...
Refactoring.Guru may disclose your Personal Data in the good faith
belief that such action is necessary to:

-   To comply with a legal obligation
-   To protect and defend the rights or property of Refactoring.Guru
...
certain data protection rights. Refactoring.Guru aims to take reasonable
...
-   **The right to access, update or to delete the information we
    ...
    yourself, please contact us to assist you via email
...
-   **The right to withdraw consent.** You also have the right to
    withdraw your consent at any time where Refactoring.Guru relied on
...
Refactoring.Guru uses remarketing services to advertise on third party
...
Settings page:
[http://www.google.com/settings/ads](https://www.google.com/settings/ads)
...
Their Privacy Policy can be viewed at
[https://fondy.io/gb/privacy-policy/](#)

-   **WayForPay**

Their Privacy Policy can be viewed at [https://wayforpay.cz/en/gdpr](#)

-   **Cryptomus**

Their Privacy Policy can be viewed at
\[[https://cryptomus.com/privacy](#)

### Customer support

We may use third-party Service Providers to provide customer support.

-   **UserEcho**

UserEcho is a customer support platform that provides Helpdesk,
Knowledge Base and Online Chat software to our Service located at
https://feedback.refactoring.guru/.

For more information on the privacy practices of UserEcho, please visit
the UserEcho Privacy Policy web page:
<https://userecho.com/privacy-policy/>
...
-   By email: <support@refactoring.guru>
