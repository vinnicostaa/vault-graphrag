...
3.  Create a domain class and copy necessary fields from the *GUI
    class* to it. Create getters and seters for all these fields.
...
:::: dl
::: dt
[Obserwator](design-patterns/observer.html)
:::
::::
:::::
