...
-   *Delegate* is the end object that contains the functionality
...
structure. Any changes in these interrelationships will require
...
1.  For each method of the *delegate-class* called by the client,
    create a method in the *server-class* that delegates the call to the
    *delegate-class*.
