...
You have a coded type that affects behavior but you can't use
...
-   If you need to add a new value of a coded type, all you need to
    do is to add a new state subclass without altering the existing code
...
design patterns: **State** or **Strategy**. Implementation is the
same no matter which pattern you choose. So which pattern should you
pick in a particular situation?
...
6.  Now you can start to move the fields and methods from the
    superclass to the corresponding state subclasses (using [Push Down
...
:::: dl
::: dt
[Stan](design-patterns/state.html)
:::
::::

:::: dl
::: dt
[Strategia](design-patterns/strategy.html)
:::
::::
:::::::
