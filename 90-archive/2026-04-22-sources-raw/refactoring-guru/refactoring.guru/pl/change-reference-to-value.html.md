...
1.  Make the object unchangeable. The object shouldn't have any
    setters or other methods that change its state and data ([Remove
    Setting Method](remove-setting-method.html) may help here). The only
    place where data should be assigned to the fields of a value
