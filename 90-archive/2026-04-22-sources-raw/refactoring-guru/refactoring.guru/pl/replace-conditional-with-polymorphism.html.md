...
-   This technique adheres to the *Tell-Don't-Ask* principle: instead of
    asking an object about its state and then performing actions
...
-   [Replace Type Code with
    Subclasses](replace-type-code-with-subclasses.html). Subclasses
    will be created for all values of a particular object property. This
