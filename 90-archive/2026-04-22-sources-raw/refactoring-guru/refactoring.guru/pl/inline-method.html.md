...
A method simply delegates to another method. In itself, this
delegation is no problem. But when there are many such methods, they
become a confusing tangle that's hard to sort through.
...
2.  Find all calls to the method. Replace these calls with the
