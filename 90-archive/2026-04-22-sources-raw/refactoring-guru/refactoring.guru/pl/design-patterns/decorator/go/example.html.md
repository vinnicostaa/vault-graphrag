...
[Dekorator](../../decorator.html){.type} / [Go](../../go.html){.type}
:::
...
# **Dekorator** w języku Go {#dekorator-w-języku-go .pattern-example-title-block-title}
::::
...
#### []{#example-0--pizza-go .anchor} **pizza.go:** Interfejs komponentu
...
#### []{#example-0--veggieMania-go .anchor} **veggieMania.go:** Konkretny komponent
...
#### []{#example-0--tomatoTopping-go .anchor} **tomatoTopping.go:** Konkretny dekorator
...
#### []{#example-0--cheeseTopping-go .anchor} **cheeseTopping.go:** Konkretny dekorator
