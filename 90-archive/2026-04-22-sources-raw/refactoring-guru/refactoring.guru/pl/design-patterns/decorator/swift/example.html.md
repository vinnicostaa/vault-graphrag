...
# **Dekorator** w języku Swift {#dekorator-w-języku-swift .pattern-example-title-block-title}
::::
...
**Przykłady użycia:** Dekorator jest dość typowy w kodzie Swift,
