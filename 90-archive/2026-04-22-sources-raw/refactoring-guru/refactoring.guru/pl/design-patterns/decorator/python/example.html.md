...
# **Dekorator** w języku Python {#dekorator-w-języku-python .pattern-example-title-block-title}
::::
...
**Przykłady użycia:** Dekorator jest dość typowy w kodzie Python,
