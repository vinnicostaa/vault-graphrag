...
[Stan](../../state.html){.type} / [C#](../../csharp.html){.type}
:::
...
# **Stan** w języku C# {#stan-w-języku-c .pattern-example-title-block-title}
::::
...
C# w celu konwersji obszernych maszyn stanów opartych na instrukcji
`switch` w obiekty.
