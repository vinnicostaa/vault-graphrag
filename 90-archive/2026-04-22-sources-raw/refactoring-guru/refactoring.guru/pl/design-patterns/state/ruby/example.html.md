...
[Stan](../../state.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Stan** w języku Ruby {#stan-w-języku-ruby .pattern-example-title-block-title}
::::
...
Ruby w celu konwersji obszernych maszyn stanów opartych na instrukcji
`switch` w obiekty.
