...
# **Strategia** w języku TypeScript {#strategia-w-języku-typescript .pattern-example-title-block-title}
::::
...
TypeScript. Często stosuje się go w różnych frameworkach by umożliwić
...
[Metoda szablonowa w języku TypeScript []{.fa
