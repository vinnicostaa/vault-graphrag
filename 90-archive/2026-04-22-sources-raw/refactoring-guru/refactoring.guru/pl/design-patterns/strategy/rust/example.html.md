...
[Strategia](../../strategy.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Strategia** w języku Rust {#strategia-w-języku-rust .pattern-example-title-block-title}
::::
...
[Metoda szablonowa w języku Rust []{.fa
