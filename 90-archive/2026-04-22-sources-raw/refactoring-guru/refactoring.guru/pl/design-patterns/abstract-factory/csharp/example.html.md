...
# **Fabryka abstrakcyjna** w języku C# {#fabryka-abstrakcyjna-w-języku-c .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Wzorce projektowe w C#](../../csharp.html){.btn
