...
[Budowniczy](../../builder.html){.type} / [Java](../../java.html){.type}
:::
...
# **Budowniczy** w języku Java {#budowniczy-w-języku-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Produkcja samochodu krok po kroku](#example-0)
:::
...
Javy. Przydaje się szczególnie gdy istnieje potrzeba tworzenia
...
**Identyfikacja:** Wzorzec Budowniczy można poznać po klasie w której
znajduje się jedna metoda kreacyjna oraz wiele metod służących
konfiguracji tworzonego obiektu. Metody Budowniczego często obsługują
łańcuchowanie, na przykład:
`someBuilder.setValueA(1).setValueB(2).create()`.
:::::::::::::::::::::::::::::::::::::

[]{#example-0}

## Produkcja samochodu krok po kroku {#example-0-title}

W poniższym przykładzie wzorzec Budowniczy pozwala konstruować różne
modele aut krok po kroku.

Przykład pokazuje też w jaki sposób Budowniczy wytwarza różne rodzaje
produktów (instrukcje obsługi aut) stosując te same etapy.

Kierownik kontroluje kolejność następujących po sobie etapów
konstrukcji. Wie które etapy należy uruchomić aby wyprodukować taki czy
inny model samochodu. Z budowniczymi współpracuje wyłącznie za pomocą
ich wspólnego interfejsu, co pozwala przekazywać mu różne typy
budowniczych.

Wynik odbiera się od obiektu budowniczego, ponieważ kierownik nie zna
typu wytworzonego produktu. Tylko obiekt budowniczego wie co buduje.

### []{#example-0--builders .anchor} **builders** {#builders .example-title}

#### []{#example-0--builders-Builder-java .anchor} **builders/Builder.java:** Wspólny interfejs budowniczego
...
#### []{#example-0--builders-CarBuilder-java .anchor} **builders/CarBuilder.java:** Budowniczy samochodu
...
#### []{#example-0--builders-CarManualBuilder-java .anchor} **builders/CarManualBuilder.java:** Budowniczy instrukcji obsługi samochodu
...
#### []{#example-0--cars-Car-java .anchor} **cars/Car.java:** Produkt typu samochód
...
#### []{#example-0--cars-Manual-java .anchor} **cars/Manual.java:** Produkt typu instrukcja obsługi samochodu
...
#### []{#example-0--components-Engine-java .anchor} **components/Engine.java:** Cecha produktu 1
...
#### []{#example-0--components-GPSNavigator-java .anchor} **components/GPSNavigator.java:** Cecha produktu 2
...
#### []{#example-0--components-Transmission-java .anchor} **components/Transmission.java:** Cecha produktu 3
...
#### []{#example-0--components-TripComputer-java .anchor} **components/TripComputer.java:** Cecha produktu 4
...
#### []{#example-0--director-Director-java .anchor} **director/Director.java:** Kierownik kontroluje budowniczych
...
[Metoda wytwórcza w języku Java []{.fa
