...
[Budowniczy](../../builder.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Budowniczy** w języku Ruby {#budowniczy-w-języku-ruby .pattern-example-title-block-title}
::::
...
Ruby. Przydaje się szczególnie gdy istnieje potrzeba tworzenia
