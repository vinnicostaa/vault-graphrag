...
[Pełnomocnik](../../proxy.html){.type} / [C#](../../csharp.html){.type}
:::
...
# **Pełnomocnik** w języku C# {#pełnomocnik-w-języku-c .pattern-example-title-block-title}
::::
...
napisanych w C#, ale w niektórych wyjątkowych sytuacjach bardzo się
...
[Łańcuch zobowiązań w języku C# []{.fa
