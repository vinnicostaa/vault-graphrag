...
# **Pełnomocnik** w języku Python {#pełnomocnik-w-języku-python .pattern-example-title-block-title}
::::
...
napisanych w Pythonie, ale w niektórych wyjątkowych sytuacjach bardzo
...
[Łańcuch zobowiązań w języku Python []{.fa
