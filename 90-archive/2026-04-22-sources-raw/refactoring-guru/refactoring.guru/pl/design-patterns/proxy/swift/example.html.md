...
# **Pełnomocnik** w języku Swift {#pełnomocnik-w-języku-swift .pattern-example-title-block-title}
::::
...
napisanych w Swift, ale w niektórych wyjątkowych sytuacjach bardzo się
...
[Łańcuch zobowiązań w języku Swift []{.fa
