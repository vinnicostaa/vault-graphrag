...
[Pełnomocnik](../../proxy.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Pełnomocnik** w języku Ruby {#pełnomocnik-w-języku-ruby .pattern-example-title-block-title}
::::
...
napisanych w Ruby, ale w niektórych wyjątkowych sytuacjach bardzo się
