...
[Pełnomocnik](../../proxy.html){.type} / [Java](../../java.html){.type}
:::
...
# **Pełnomocnik** w języku Java {#pełnomocnik-w-języku-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Pełnomocnik z pamięcią podręczną](#example-0)
:::
...
napisanych w Javie, ale w niektórych wyjątkowych sytuacjach bardzo się
przydaje. Jest niezastąpiony wszędzie tam, gdzie trzeba dodać jakąś
...
-   [`javax.ejb.EJB`](http://docs.oracle.com/javaee/7/api/javax/ejb/EJB.html)
    ([patrz
    komentarze](http://stackoverflow.com/questions/25514361/when-using-ejb-does-each-managed-bean-get-its-own-ejb-instance))
-   [`javax.inject.Inject`](http://docs.oracle.com/javaee/7/api/javax/inject/Inject.html)
    ([patrz
    komentarze](http://stackoverflow.com/questions/29651008/field-getobj-returns-all-nulls-on-injected-cdi-managed-beans-while-manually-i/29672591#29672591))
...
## Pełnomocnik z pamięcią podręczną {#example-0-title}

W poniższym przykładzie wzorzec Pełnomocnik pozwala zaimplementować
leniwą inicjalizację oraz pamięć podręczną zewnętrznej, niewydolnej
bibliotece integrującej z YouTube.

Pełnomocnik jest bezcenny gdy trzeba nadać dodatkowe obowiązki klasie
której kodu nie możesz zmienić.

### []{#example-0--some_cool_media_library .anchor} **some_cool_media_library** {#some_cool_media_library .example-title}

#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeLib-java .anchor} **some_cool_media_library/ThirdPartyYouTubeLib.java:** Interfejs zdalnej usługi
...
#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeClass-java .anchor} **some_cool_media_library/ThirdPartyYouTubeClass.java:** Implementacja zdalnej usługi
...
#### []{#example-0--some_cool_media_library-Video-java .anchor} **some_cool_media_library/Video.java:** Plik wideo
...
#### []{#example-0--proxy-YouTubeCacheProxy-java .anchor} **proxy/YouTubeCacheProxy.java:** Pełnomocnik z pamięcią podręczną
...
#### []{#example-0--downloader-YouTubeDownloader-java .anchor} **downloader/YouTubeDownloader.java:** Aplikacja pobierająca multimedia
...
#### []{#example-0--Demo-java .anchor} **Demo.java:** Kod inicjalizujący
...
[Łańcuch zobowiązań w języku Java []{.fa
