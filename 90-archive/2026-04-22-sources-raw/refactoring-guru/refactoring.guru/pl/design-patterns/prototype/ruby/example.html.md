...
[Prototyp](../../prototype.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Prototyp** w języku Ruby {#prototyp-w-języku-ruby .pattern-example-title-block-title}
::::
...
**Przykłady użycia:** Wzorzec Prototyp jest dostępny w Ruby od razu ---
dzięki metodom `dup` lub `clone`.
