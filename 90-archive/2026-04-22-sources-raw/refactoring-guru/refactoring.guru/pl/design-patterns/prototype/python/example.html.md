...
# **Prototyp** w języku Python {#prototyp-w-języku-python .pattern-example-title-block-title}
::::
...
**Przykłady użycia:** Wzorzec Prototyp jest dostępny w Pythonie od
razu --- dzięki modułowi `copy`.
