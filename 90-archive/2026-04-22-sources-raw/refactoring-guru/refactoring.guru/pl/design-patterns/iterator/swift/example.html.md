...
# **Iterator** w języku Swift {#iterator-w-języku-swift .pattern-example-title-block-title}
::::
...
kodzie Swift. Wiele frameworków i bibliotek pozwala za jego pomocą
