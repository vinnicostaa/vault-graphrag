...
# **Iterator** w języku Java {#iterator-w-języku-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Przechodzenie po kolejnych profilach użytkowników platformy
społecznościowej](#example-0)
:::
...
kodzie Java. Wiele frameworków i bibliotek pozwala za jego pomocą
poruszać się po elementach ich kolekcji.

Oto kilka przykładów użycia wzorca w głównych bibliotekach Java:
...
## Przechodzenie po kolejnych profilach użytkowników platformy społecznościowej {#example-0-title}

W poniższym przykładzie wzorzec Iterator wykorzystano do
przechodzenia po kolejnych profilach użytkowników zdalnej platformy
społecznościowej bez ujawniania szczegółów komunikacji kodowi klienta.

### []{#example-0--iterators .anchor} **iterators** {#iterators .example-title}

#### []{#example-0--iterators-ProfileIterator-java .anchor} **iterators/ProfileIterator.java:** Definiuje interfejs profilu użytkownika
...
#### []{#example-0--iterators-FacebookIterator-java .anchor} **iterators/FacebookIterator.java:** Implementuje przeglądanie profili Facebook
...
#### []{#example-0--iterators-LinkedInIterator-java .anchor} **iterators/LinkedInIterator.java:** Implementuje przeglądanie profili LinkedIn
...
#### []{#example-0--social_networks-SocialNetwork-java .anchor} **social_networks/SocialNetwork.java:** Definiuje wspólny interfejs platform społecznościowych
...
#### []{#example-0--profile-Profile-java .anchor} **profile/Profile.java:** Profile użytkowników
...
#### []{#example-0--spammer-SocialSpammer-java .anchor} **spammer/SocialSpammer.java:** Aplikacja wysyłająca wiadomości
