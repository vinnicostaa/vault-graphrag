...
# **Iterator** w języku C# {#iterator-w-języku-c .pattern-example-title-block-title}
::::
...
kodzie C#. Wiele frameworków i bibliotek pozwala za jego pomocą poruszać
się po elementach ich kolekcji.
