...
# **Iterator** w języku Go {#iterator-w-języku-go .pattern-example-title-block-title}
::::
...
Główną ideą kryjącą się za wzorcem Iterator jest ekstrakcja logiki
przechodzenia przez kolejne elementy jakiejś kolekcji do osobnego
obiektu zwanego iteratorem. Iterator udostępnia generyczną metodę
służącą przechodzeniu przez elementy kolekcji obiektów niezależnie od
ich typu.

#### []{#example-0--collection-go .anchor} **collection.go:** Kolekcja
...
#### []{#example-0--userCollection-go .anchor} **userCollection.go:** Konkretna kolekcja
...
#### []{#example-0--iterator-go .anchor} **iterator.go:** Iterator
...
#### []{#example-0--userIterator-go .anchor} **userIterator.go:** Konkretny iterator
...
#### []{#example-0--user-go .anchor} **user.go:** Kod klienta
