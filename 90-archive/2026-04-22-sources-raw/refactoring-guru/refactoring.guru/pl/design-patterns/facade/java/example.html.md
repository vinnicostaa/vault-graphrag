...
[Fasada](../../facade.html){.type} / [Java](../../java.html){.type}
:::
...
# **Fasada** w języku Java {#fasada-w-języku-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Prosty interfejs skomplikowanej klasy do konwersji wideo](#example-0)
:::
...
napisanych w Javie, szczególnie w celu współpracy ze złożonymi
bibliotekami i interfejsami programowania aplikacji.
...
-   [`javax.faces.context.FacesContext`](http://docs.oracle.com/javaee/7/api/javax/faces/context/FacesContext.html)
    ...
    [`NavigationHandler`](http://docs.oracle.com/javaee/7/api/javax/faces/application/NavigationHandler.html) za
    kulisami, ale większość klientów nie jest tego świadoma.
...
## Prosty interfejs skomplikowanej klasy do konwersji wideo {#example-0-title}

W poniższym przykładzie Fasada upraszcza komunikację ze złożonym
frameworkiem służącym konwersji filmików.

Fasada udostępnia pojedynczą klasę z jedną metodą której zadaniem jest
konfiguracja odpowiednich klas frameworku oraz pobieranie wyników ich
działania w odpowiednim formacie.

### []{#example-0--some_complex_media_library .anchor} **some_complex_media_library:** Złożona biblioteka konwersji wideo {#some_complex_media_library-złożona-biblioteka-konwersji-wideo .example-title}
...
#### []{#example-0--facade-VideoConversionFacade-java .anchor} **facade/VideoConversionFacade.java:** Fasada udostępnia prosty interfejs służący konwersji filmików
