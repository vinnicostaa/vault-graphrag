...
[Fasada](../../facade.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **Fasada** w języku Swift {#fasada-w-języku-swift .pattern-example-title-block-title}
::::
...
pisanych w Swift, gdzie przydaje się w pracy ze złożonymi bibliotekami i
API.
