...
::: en-intro
 [Dziedziczenie wielokrotne](#example-1)
:::
...
aria-selected="true"} [Dziedziczenie
wielokrotne](#example-1){#example-1-tab .nav-item .nav-link toggle="tab"
...
## Dziedziczenie wielokrotne {#example-1-title}

W C++ wzorzec **Adapter** można zaimplementować za pomocą dziedziczenia
wielokrotnego.

#### []{#example-1--main-cc .anchor} **main.cc:** Dziedziczenie wielokrotne
...
aria-selected="true"} [Dziedziczenie
wielokrotne](#example-1){#example-1-tab-bottom .nav-item .nav-link
