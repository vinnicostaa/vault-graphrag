...
# **Adapter** w języku Python {#adapter-w-języku-python .pattern-example-title-block-title}
::::
...
Python. Często stosuje się go w systemach bazujących na przestarzałym
