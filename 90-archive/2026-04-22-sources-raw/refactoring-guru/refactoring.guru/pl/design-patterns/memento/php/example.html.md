...
[Pamiątka](../../memento.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Pamiątka** w języku PHP {#pamiątka-w-języku-php .pattern-example-title-block-title}
::::
...
**Przykłady użycia:** Faktyczne stosowanie wzorca Pamiątka w PHP jest
kwestią sporną. W większości przypadków można bowiem skopiować stan
obiektu w prostszy sposób za pomocą serializacji.
::::::::::::::
...
W tym przykładzie wzorzec **Pamiątka** służy do obsługi przepływu
zarządzania konfiguracją aplikacji webowej w PHP. Wiele aplikacji
pozwala użytkownikom personalizować ustawienia i czasem chcą oni cofnąć
wprowadzone modyfikacje, aby przywrócić poprzednią konfigurację. Wzorzec
Pamiątka można wykorzystać do takiej funkcji, przechwytując i zapisując
stan obiektu konfiguracji, zanim zostaną wprowadzone jakiekolwiek
zmiany.
