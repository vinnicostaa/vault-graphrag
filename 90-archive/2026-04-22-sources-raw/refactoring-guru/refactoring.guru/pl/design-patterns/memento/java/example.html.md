...
[Pamiątka](../../memento.html){.type} / [Java](../../java.html){.type}
:::
...
# **Pamiątka** w języku Java {#pamiątka-w-języku-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Edytor figur geometrycznych i złożone cofnij/ponów](#example-0)
:::
...
serializacji, która jest dość powszechnie stosowana w Javie. Nie jest to
...
## Edytor figur geometrycznych i złożone cofnij/ponów {#example-0-title}

Poniższy edytor graficzny pozwala zmieniać kolor i pozycję kształtów na
ekranie. Każdą modyfikację można wycofać lub powtórzyć.

Funkcjonalność "cofnij" oparto na współpracy wzorców Pamiątka i
Polecenie. Edytor śledzi historię wykonanych działań. Zanim wykona jakąś
czynność, tworzy kopię zapasową i łączy ją z obiektem typu polecenie. Po
wykonaniu polecenia trafia ono do historii.

Gdy użytkownik chce cofnąć operację, edytor pobiera ostatnio wykonane
polecenie z historii i przywraca stan edytora na podstawie kopii
zapasowej przechowywanej w tym poleceniu. Kolejne wywołania "cofnij"
spowodują powtórzenie powyższego zachowania z wykorzystaniem kolejnego
("starszego") polecenia z historii.

Cofnięte polecenia są przechowywane w historii do momentu gdy użytkownik
dokona modyfikacji figur na ekranie. Jest to kluczowa część
funkcjonalności ponawiania cofniętych poleceń.

### []{#example-0--editor .anchor} **editor** {#editor .example-title}

#### []{#example-0--editor-Editor-java .anchor} **editor/Editor.java:** Kod edytora
...
#### []{#example-0--editor-Canvas-java .anchor} **editor/Canvas.java:** Kod kanwy
...
#### []{#example-0--history-History-java .anchor} **history/History.java:** Historia przechowuje polecenia i pamiątki
...
#### []{#example-0--history-Memento-java .anchor} **history/Memento.java:** Klasa pamiątka
...
#### []{#example-0--commands-Command-java .anchor} **commands/Command.java:** Klasa bazowa polecenia
...
#### []{#example-0--commands-ColorCommand-java .anchor} **commands/ColorCommand.java:** Zmienia barwę wybranej figury
...
#### []{#example-0--commands-MoveCommand-java .anchor} **commands/MoveCommand.java:** Przesuwa wybraną figurę
...
### []{#example-0--shapes .anchor} **shapes:** Różne figury {#shapes-różne-figury .example-title}
