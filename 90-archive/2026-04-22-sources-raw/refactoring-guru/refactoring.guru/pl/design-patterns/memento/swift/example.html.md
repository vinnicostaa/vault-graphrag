...
[Pamiątka](../../memento.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **Pamiątka** w języku Swift {#pamiątka-w-języku-swift .pattern-example-title-block-title}
::::
...
serializacji, która jest dość powszechnie stosowana w Swift. Nie jest to
