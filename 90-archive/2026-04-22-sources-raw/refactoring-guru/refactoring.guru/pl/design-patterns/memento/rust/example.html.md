...
[Pamiątka](../../memento.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Pamiątka** w języku Rust {#pamiątka-w-języku-rust .pattern-example-title-block-title}
::::
