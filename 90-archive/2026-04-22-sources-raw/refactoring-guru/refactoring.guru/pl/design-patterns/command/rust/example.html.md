...
[Polecenie](../../command.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Polecenie** w języku Rust {#polecenie-w-języku-rust .pattern-example-title-block-title}
::::
...
global context*, instead the latter should be passed *from top to
down as a mutable parameter* of the "`execute`" method:
