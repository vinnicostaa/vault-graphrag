...
[Polecenie](../../command.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Polecenie** w języku Ruby {#polecenie-w-języku-ruby .pattern-example-title-block-title}
::::
...
napisanym w Ruby jako alternatywa dla wywołania zwrotnego (ang.
