...
# **Polecenie** w języku TypeScript {#polecenie-w-języku-typescript .pattern-example-title-block-title}
::::
...
napisanym w TypeScript jako alternatywa dla wywołania zwrotnego (ang.
...
[Iterator w języku TypeScript []{.fa
