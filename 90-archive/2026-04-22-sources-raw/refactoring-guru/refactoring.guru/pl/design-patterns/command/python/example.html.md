...
# **Polecenie** w języku Python {#polecenie-w-języku-python .pattern-example-title-block-title}
::::
...
napisanym w Pythonie jako alternatywa dla wywołania zwrotnego (ang.
