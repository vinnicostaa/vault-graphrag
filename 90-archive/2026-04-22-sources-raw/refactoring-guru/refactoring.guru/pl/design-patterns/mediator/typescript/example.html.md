...
# **Mediator** w języku TypeScript {#mediator-w-języku-typescript .pattern-example-title-block-title}
::::
...
kodzie TypeScript to umożliwienie komunikacji pomiędzy komponentami
...
[Pamiątka w języku TypeScript []{.fa
