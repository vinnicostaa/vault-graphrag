...
# **Mediator** w języku Swift {#mediator-w-języku-swift .pattern-example-title-block-title}
::::
...
kodzie Swift to umożliwienie komunikacji pomiędzy komponentami
