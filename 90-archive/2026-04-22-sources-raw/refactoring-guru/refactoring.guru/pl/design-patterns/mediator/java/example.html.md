...
# **Mediator** w języku Java {#mediator-w-języku-java .pattern-example-title-block-title}
::::
...
kodzie Java to umożliwienie komunikacji pomiędzy komponentami
...
## Aplikacja: notatnik {#example-0-title}

Poniższy przykład przedstawia sposób na organizację wielkiej ilości
elementów GUI z pomocą mediatora, dzięki czemu nie są one od siebie
zależne.

### []{#example-0--components .anchor} **components:** Klasy-koledzy {#components-klasy-koledzy .example-title}
...
#### []{#example-0--mediator-Mediator-java .anchor} **mediator/Mediator.java:** Definiuje wspólny interfejs mediatora
...
#### []{#example-0--mediator-Editor-java .anchor} **mediator/Editor.java:** Konkretny mediator
...
#### []{#example-0--mediator-Note-java .anchor} **mediator/Note.java:** Klasa notatki
