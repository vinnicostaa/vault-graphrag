...
# **Metoda szablonowa** w języku Swift {#metoda-szablonowa-w-języku-swift .pattern-example-title-block-title}
::::
...
stosowana we frameworkach Swift. Twórcy oprogramowania często za jej
...
[Odwiedzający w języku Swift []{.fa
