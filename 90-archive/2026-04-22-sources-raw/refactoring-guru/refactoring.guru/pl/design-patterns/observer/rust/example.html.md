...
# **Obserwator** w języku Rust {#obserwator-w-języku-rust .pattern-example-title-block-title}
::::
...
In Rust, a convenient way to define a subscriber is to have a
function as a callable object with complex logic passing it to a event
publisher.
