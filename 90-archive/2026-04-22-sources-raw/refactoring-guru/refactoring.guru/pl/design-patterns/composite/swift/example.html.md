...
# **Kompozyt** w języku Swift {#kompozyt-w-języku-swift .pattern-example-title-block-title}
::::
...
Swift. Często stosuje się go do modelowania hierarchii komponentów
