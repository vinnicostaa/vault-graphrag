...
[Kompozyt](../../composite.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Kompozyt** w języku Rust {#kompozyt-w-języku-rust .pattern-example-title-block-title}
::::
...
operating system's file system. In the file system, there are two
types of objects: files and folders. There are cases when files and
folders should be treated to be the same way. This is where the
Composite pattern comes in handy.
