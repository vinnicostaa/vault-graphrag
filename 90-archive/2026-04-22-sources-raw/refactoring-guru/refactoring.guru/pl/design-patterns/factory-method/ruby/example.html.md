...
# **Metoda wytwórcza** w języku Ruby {#metoda-wytwórcza-w-języku-ruby .pattern-example-title-block-title}
::::
...
kodzie Ruby. Przydaje się gdy chcesz nadać swojemu kodowi wysoki poziom
elastyczności.
