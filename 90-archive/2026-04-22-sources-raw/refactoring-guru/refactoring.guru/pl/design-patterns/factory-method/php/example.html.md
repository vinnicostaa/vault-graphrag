...
# **Metoda wytwórcza** w języku PHP {#metoda-wytwórcza-w-języku-php .pattern-example-title-block-title}
::::
...
rozpowszechniony w kodzie PHP. Przydaje się gdy chcesz nadać swojemu
kodowi wysoki poziom elastyczności.
...
W tym przykładzie wzorzec **Metoda wytwórcza** udostępnia interfejs
służący tworzeniu łącza z portalem społecznościowym za pomocą którego
można się zalogować, tworzyć posty i wykonywać inne działania.
Wszystko to możliwe bez sprzęgania kodu klienta z konkretnymi klasami
