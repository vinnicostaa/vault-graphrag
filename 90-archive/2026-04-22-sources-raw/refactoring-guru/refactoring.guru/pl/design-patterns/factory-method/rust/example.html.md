...
# **Metoda wytwórcza** w języku Rust {#metoda-wytwórcza-w-języku-rust .pattern-example-title-block-title}
::::
...
depend on specific types of GUI elements. All client code works with GUI
elements through abstract interfaces defined by the `gui` module.
