...
# **Metoda wytwórcza** w języku TypeScript {#metoda-wytwórcza-w-języku-typescript .pattern-example-title-block-title}
::::
...
kodzie TypeScript. Przydaje się gdy chcesz nadać swojemu kodowi wysoki
...
[Prototyp w języku TypeScript []{.fa
