...
# **Будівельник** на TypeScript {#будівельник-на-typescript .pattern-example-title-block-title}
::::
...
особливо там, де необхідним є покрокове створення продуктів або
конфігурація складних об'єктів.
...
[Фабричний метод на TypeScript []{.fa
