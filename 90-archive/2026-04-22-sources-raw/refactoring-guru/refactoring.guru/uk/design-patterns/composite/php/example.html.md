...
# **Компонувальник** на PHP {#компонувальник-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Компонувальник зустрічається при вирішенні
будь-яких завданнь, пов'язаних з побудовою дерева об'єктів. Найпростіший
приклад --- складові елементи DOM-дерева, які в свою чергу теж можна
розглядати як піддерева.
...
[[]{.fa .fa-arrow-left} Міст на PHP](../../bridge/php/example.html){.btn
