...
# **Компонувальник** на Java {#компонувальник-на-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Прості та складені графічні фігури](#example-0)
:::
...
-   [`java.awt.Container#add(Component)`](http://docs.oracle.com/javase/8/docs/api/java/awt/Container.html#add-java.awt.Component-)
    (зазвичай застосовується для компонентів Swing)
...
-   [`javax.faces.component.UIComponent#getChildren()`](http://docs.oracle.com/javaee/7/api/javax/faces/component/UIComponent.html#getChildren--)
    (зазвичай застосовується для JSF UI)
...
## Прості та складені графічні фігури {#example-0-title}

Цей приклад показує, як можна працювати зі складними геометричними
фігурами, складеними з простих так, ніби-то вони самі є простими.
...
#### []{#example-0--shapes-BaseShape-java .anchor} **shapes/BaseShape.java:** Абстрактна фігура з базовим функціоналом
...
#### []{#example-0--editor-ImageEditor-java .anchor} **editor/ImageEditor.java:** Редактор фігур
