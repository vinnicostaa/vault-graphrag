...
# [Патерни]{.dp1-h-1} [проектування]{.dp1-h-2} [на]{.dp-lang-in} [C++]{.dp-lang} {#патерни-проектування-на-c .dp1-h .dp-abs .dp-c .dp-h1}
::::
...
[ Приклад
коду](abstract-factory/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](builder/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](factory-method/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](prototype/cpp/example.html#example-0){.dp-pattern-link}
...
[ Наївний
Одинак](singleton/cpp/example.html#example-0){.dp-pattern-link}
...
[ Багатопоточний
Одинак](singleton/cpp/example.html#example-1){.dp-pattern-link}
...
[ Приклад коду](adapter/cpp/example.html#example-0){.dp-pattern-link}
...
[ Множинне
успадкування](adapter/cpp/example.html#example-1){.dp-pattern-link}
...
[ Приклад коду](bridge/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](composite/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](decorator/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](facade/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](flyweight/cpp/example.html#example-0){.dp-pattern-link}
...
[ Патерн на C++](proxy/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ Приклад коду](proxy/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](chain-of-responsibility/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](command/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](iterator/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](mediator/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](memento/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](observer/cpp/example.html#example-0){.dp-pattern-link}
...
[ Патерн на C++](state/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ Приклад коду](state/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](strategy/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](template-method/cpp/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](visitor/cpp/example.html#example-0){.dp-pattern-link}
