...
# **Ланцюжок обов\'язків** на TypeScript {#ланцюжок-обовязків-на-typescript .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн зустрічається в TypeScript не так вже й часто,
