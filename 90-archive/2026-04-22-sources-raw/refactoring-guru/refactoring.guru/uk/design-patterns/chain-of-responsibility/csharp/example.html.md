...
# **Ланцюжок обов\'язків** на C# {#ланцюжок-обовязків-на-c .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн зустрічається в C# не так вже й часто, оскільки
для його застосування потрібен ланцюг об'єктів, наприклад, зв'язаний
список.
