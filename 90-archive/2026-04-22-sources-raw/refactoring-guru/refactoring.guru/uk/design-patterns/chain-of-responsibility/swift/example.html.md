...
# **Ланцюжок обов\'язків** на Swift {#ланцюжок-обовязків-на-swift .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн зустрічається в Swift не так вже й часто,
