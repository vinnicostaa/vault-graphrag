...
[Прототип](../../prototype.html){.type} / [Java](../../java.html){.type}
:::
...
# **Прототип** на Java {#прототип-на-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Копіювання графічних фігур](#example-0)
:::
...
**Застосування:** Патерн Прототип реалізовано в базовій бібліотеці Java
за допомогою інтерфейсу `Cloneable`.

Будь-який клас може реалізувати цей інтерфейс, щоб дозволити власне
клонування.

-   [`java.lang.Object#clone()`](http://docs.oracle.com/javase/8/docs/api/java/lang/Object.html#clone--)
    (клас повинен реалізувати інтерфейс
...
## Копіювання графічних фігур {#example-0-title}

Розглянемо приклад реалізації Прототипу без використання інтерфейсу
`Cloneable`.

### []{#example-0--shapes .anchor} **shapes:** Список фігур {#shapes-список-фігур .example-title}
...
#### []{#example-0--shapes-Circle-java .anchor} **shapes/Circle.java:** Проста фігура
...
#### []{#example-0--shapes-Rectangle-java .anchor} **shapes/Rectangle.java:** Трохи складніша фігура
...
#### []{#example-0--Demo-java .anchor} **Demo.java:** Приклад клонування
...
Ви можете додати у програму фабрику прототипів, яка буде зберігати
каталог прототипів. Таким чином, ви зможете запитувати у фабрики нові
об'єкти, описуючи потрібні вам властивості. Фабрика буде шукати
відповідний прототип в кеші та повертатиме вам копію.

### []{#example-0--cache .anchor} **cache** {#cache .example-title}

#### []{#example-0--cache-BundledShapeCache-java .anchor} **cache/BundledShapeCache.java:** Фабрика прототипів
