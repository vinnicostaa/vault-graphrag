...
# **Прототип** на Python {#прототип-на-python .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Прототип реалізовано в базовій бібліотеці
Python за допомогою модуля `copy`.
