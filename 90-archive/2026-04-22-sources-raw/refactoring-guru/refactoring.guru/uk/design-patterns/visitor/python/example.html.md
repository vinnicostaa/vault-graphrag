...
# **Відвідувач** на Python {#відвідувач-на-python .pattern-example-title-block-title}
::::
...
**Застосування:** Відвідувач нечасто зустрічається в Python-коді
...
[Патерни проектування на Ruby []{.fa
