...
[Відвідувач](../../visitor.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Відвідувач** на Rust {#відвідувач-на-rust .pattern-example-title-block-title}
::::
...
[Патерни проектування на Swift []{.fa
