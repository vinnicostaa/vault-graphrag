...
# **Відвідувач** на Swift {#відвідувач-на-swift .pattern-example-title-block-title}
::::
...
**Застосування:** Відвідувач нечасто зустрічається в Swift-коді
...
[Патерни проектування на TypeScript []{.fa
