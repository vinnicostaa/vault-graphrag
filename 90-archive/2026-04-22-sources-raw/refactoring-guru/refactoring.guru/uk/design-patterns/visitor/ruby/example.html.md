...
[Відвідувач](../../visitor.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Відвідувач** на Ruby {#відвідувач-на-ruby .pattern-example-title-block-title}
::::
...
**Застосування:** Відвідувач нечасто зустрічається в Ruby-коді внаслідок
