...
[Відвідувач](../../visitor.html){.type} / [C++](../../cpp.html){.type}
:::
...
# **Відвідувач** на C++ {#відвідувач-на-c .pattern-example-title-block-title}
::::
...
**Застосування:** Відвідувач нечасто зустрічається в C++ коді внаслідок
...
[Патерни проектування на Go []{.fa .fa-arrow-right}](../../go.html){.btn
