...
# **Фабричний метод** на Python {#фабричний-метод-на-python .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн можна часто зустріти в будь-якому Python-коді,
