...
# **Шаблонний метод** на TypeScript {#шаблонний-метод-на-typescript .pattern-example-title-block-title}
::::
...
класах TypeScript. Розробники створюють їх, щоб дозволити клієнтам легко
та швидко розширювати стандартний код за допомогою спадкування.
