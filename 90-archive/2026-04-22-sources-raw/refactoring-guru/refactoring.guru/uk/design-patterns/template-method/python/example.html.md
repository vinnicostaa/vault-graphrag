...
# **Шаблонний метод** на Python {#шаблонний-метод-на-python .pattern-example-title-block-title}
::::
...
класах Python. Розробники створюють їх, щоб дозволити клієнтам легко та
