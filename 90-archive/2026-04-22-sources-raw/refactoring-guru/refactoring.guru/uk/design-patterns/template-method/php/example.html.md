...
# **Шаблонний метод** на PHP {#шаблонний-метод-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Шаблонні методи можна зустріти в багатьох
PHP-фреймворках. Розробники створюють такі методи, щоб дозволити
клієнтам легко і швидко розширювати стандартний код за допомогою
наслідування.
