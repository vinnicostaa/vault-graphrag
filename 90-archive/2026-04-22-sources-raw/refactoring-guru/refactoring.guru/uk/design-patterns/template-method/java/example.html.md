...
# **Шаблонний метод** на Java {#шаблонний-метод-на-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Перевизначення кроків алгоритму](#example-0)
:::
...
-   [`javax.servlet.http.HttpServlet`](http://docs.oracle.com/javaee/7/api/javax/servlet/http/HttpServlet.html)всі
    методи `doXXX()` типово (by default) повертають HTTP-код 405
    \"Method Not Allowed\". Проте ви можете перевизначити їх за
    бажанням.
...
## Перевизначення кроків алгоритму {#example-0-title}

Соціальні мережі надають власні методи API для авторизації, постінга та
виходу, але загальний процес для всіх мереж збігається.

### []{#example-0--networks .anchor} **networks** {#networks .example-title}

#### []{#example-0--networks-Network-java .anchor} **networks/Network.java:** Базовий клас соціальної мережі
...
#### []{#example-0--networks-Facebook-java .anchor} **networks/Facebook.java:** Конкретна соціальна мережа
...
#### []{#example-0--networks-Twitter-java .anchor} **networks/Twitter.java:** Ще одна конкретна соціальна мережа
