...
# **Адаптер** на Python {#адаптер-на-python .pattern-example-title-block-title}
::::
...
там, де потрібна конвертація різних типів даних або спільна робота
класів з різними інтерфейсами.
