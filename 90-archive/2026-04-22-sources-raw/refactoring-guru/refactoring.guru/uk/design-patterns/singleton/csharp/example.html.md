...
[Одинак](../../singleton.html){.type} / [C#](../../csharp.html){.type}
:::
...
# **Одинак** на C# {#одинак-на-c .pattern-example-title-block-title}
::::
...
тому його все рідше і рідше можна зустріти в C#-коді.
...
[Бажаєте ще?](#example-2){#example-2-tab .nav-item .nav-link
...
#### []{#example-1--Program-cs .anchor} **Program.cs:** Приклад структури патерна
...
## Бажаєте ще? {#example-2-title}

Існує ще з півдюжини способів реалізації Одинака в C#. Якщо цікаво,
...
toggle="tab" role="tab" aria-controls="example-1" aria-selected="true"}
[Бажаєте ще?](#example-2){#example-2-tab-bottom .nav-item .nav-link
toggle="tab" role="tab" aria-controls="example-2" aria-selected="true"}
:::
