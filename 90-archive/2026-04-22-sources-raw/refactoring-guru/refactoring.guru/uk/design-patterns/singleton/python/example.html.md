...
# **Одинак** на Python {#одинак-на-python .pattern-example-title-block-title}
::::
...
#### []{#example-1--main-py .anchor} **main.py:** Приклад структури патерна
