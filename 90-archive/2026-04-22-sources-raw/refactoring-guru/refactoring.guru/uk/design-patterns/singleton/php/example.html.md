...
[Одинак](../../singleton.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Одинак** на PHP {#одинак-на-php .pattern-example-title-block-title}
::::
...
тому його все рідше і рідше можна зустріти в PHP-коді.
...
Цей приклад показує структуру патерна **Одинак**, а саме --- з яких
