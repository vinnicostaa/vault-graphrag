...
[Декоратор](../../decorator.html){.type} / [C++](../../cpp.html){.type}
:::
...
# **Декоратор** на C++ {#декоратор-на-c .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн можна часто зустріти в C++ коді, особливо якщо
