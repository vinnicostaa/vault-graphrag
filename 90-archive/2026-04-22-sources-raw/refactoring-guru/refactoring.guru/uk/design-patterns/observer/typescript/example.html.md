...
# **Спостерігач** на TypeScript {#спостерігач-на-typescript .pattern-example-title-block-title}
::::
...
**Застосування:** Спостерігач часто зустрічається в коді TypeScript,
