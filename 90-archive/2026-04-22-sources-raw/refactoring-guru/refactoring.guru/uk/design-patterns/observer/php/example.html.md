...
[Спостерігач](../../observer.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Спостерігач** на PHP {#спостерігач-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Спостерігач часто зустрічається в коді PHP, особливо
...
PHP має декілька вбудованих інтерфейсів (\[SplSubject\]
(http://php.net/manual/ru/class.splsubject.php), \[SplObserver\]
(http://php.net/manual/ru/class.splobserver.php )), на яких можна
побудувати свої реалізації Спостерігача, сумісні з іншим PHP-кодом.
...
[Стан на PHP []{.fa .fa-arrow-right}](../../state/php/example.html){.btn
