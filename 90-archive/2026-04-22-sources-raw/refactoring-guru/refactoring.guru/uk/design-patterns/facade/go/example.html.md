...
[Фасад](../../facade.html){.type} / [Go](../../go.html){.type}
:::
...
# **Фасад** на Go {#фасад-на-go .pattern-example-title-block-title}
::::
...
Можна легко недооцінити складність того, що відбувається за лаштунками,
коли ви замовляєте піцу за допомогою кредитної картки. У цьому процесі
беруть участь десятки підсистем. Ось їх мала частина:

-   Перевірка аккаунта
-   Перевірка PIN-коду
-   Баланс дебет / кредит
-   Запис у бухгалтерській книзі
-   Надсилання сповіщення

У такій складній системі легко загубитися або щось зламати, якщо
поводитися з нею неправильно. Для таких випадків і є патерн
Фасад --- він дає змогу клієнту працювати з десятками компонентів,
використовуючи для цього простий інтерфейс. Клієнту необхідно лише
ввести реквізити картки, код безпеки, вартість оплати і тип операції.
Фасад керує подальшою комунікацією між різними компонентами без контакту
клієнта зі складними внутрішніми механізмами.

#### []{#example-0--walletFacade-go .anchor} **walletFacade.go:** Фасад
...
#### []{#example-0--account-go .anchor} **account.go:** Частина складної підсистеми
...
#### []{#example-0--securityCode-go .anchor} **securityCode.go:** Частина складної підсистеми
...
#### []{#example-0--wallet-go .anchor} **wallet.go:** Частина складної підсистеми
...
#### []{#example-0--ledger-go .anchor} **ledger.go:** Частина складної підсистеми
...
#### []{#example-0--notification-go .anchor} **notification.go:** Частина складної підсистеми
