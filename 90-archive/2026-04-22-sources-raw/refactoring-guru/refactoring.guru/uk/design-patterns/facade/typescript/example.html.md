...
# **Фасад** на TypeScript {#фасад-на-typescript .pattern-example-title-block-title}
::::
...
написаних на TypeScript, які використовують складні бібліотеки або API.
