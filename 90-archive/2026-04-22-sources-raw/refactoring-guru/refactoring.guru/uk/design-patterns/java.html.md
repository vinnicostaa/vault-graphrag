...
# [ПАТЕРНИ]{.dp1-h-1} [ПРОЕКТУВАННЯ]{.dp1-h-2} [на]{.dp-lang-in} [Java]{.dp-lang} {#патерни-проектування-на-java .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## Каталог **Java**-прикладів {#каталог-java-прикладів .dp-h2}
...
[ Приклад
коду](abstract-factory/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](builder/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](factory-method/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](prototype/java/example.html#example-0){.dp-pattern-link}
...
[ Наївний
Одинак](singleton/java/example.html#example-0){.dp-pattern-link}
...
[ Багатопоточний
Одинак](singleton/java/example.html#example-2){.dp-pattern-link}
...
[ Приклад коду](adapter/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](bridge/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](composite/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](decorator/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](facade/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](flyweight/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](proxy/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](chain-of-responsibility/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](command/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](iterator/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](mediator/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](memento/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](observer/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](state/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](strategy/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](template-method/java/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](visitor/java/example.html#example-0){.dp-pattern-link}
