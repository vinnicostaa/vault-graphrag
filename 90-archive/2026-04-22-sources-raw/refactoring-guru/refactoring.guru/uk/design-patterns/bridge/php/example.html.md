...
[Міст](../../bridge.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Міст** на PHP {#міст-на-php .pattern-example-title-block-title}
::::
...
підтримувати кілька типів баз даних або працювати з різними
постачальниками схожого API (наприклад, cloud-сервіси, соціальні мережі
і т. д.)
