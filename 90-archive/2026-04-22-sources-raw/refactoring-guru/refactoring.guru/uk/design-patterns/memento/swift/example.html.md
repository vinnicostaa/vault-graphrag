...
[Знімок](../../memento.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **Знімок** на Swift {#знімок-на-swift .pattern-example-title-block-title}
::::
...
**Застосування:** Знімок на Swift найчастіше за все реалізовують за
