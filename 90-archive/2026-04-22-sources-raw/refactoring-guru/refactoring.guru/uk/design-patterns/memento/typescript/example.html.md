...
# **Знімок** на TypeScript {#знімок-на-typescript .pattern-example-title-block-title}
::::
...
**Застосування:** Знімок на TypeScript найчастіше за все реалізовують за
