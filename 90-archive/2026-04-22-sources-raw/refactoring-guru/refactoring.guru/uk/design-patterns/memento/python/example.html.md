...
[Знімок](../../memento.html){.type} / [Python](../../python.html){.type}
:::
...
# **Знімок** на Python {#знімок-на-python .pattern-example-title-block-title}
::::
...
**Застосування:** Знімок на Python найчастіше за все реалізовують за
