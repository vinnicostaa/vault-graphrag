...
[Знімок](../../memento.html){.type} / [Java](../../java.html){.type}
:::
...
# **Знімок** на Java {#знімок-на-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Скасування в редакторі фігур](#example-0)
:::
...
## Скасування в редакторі фігур {#example-0-title}

В даному графічному редакторі ми можемо змінювати колір і позицію фігур.
Користувач може скасовувати або повторювати дії, використовуючи гарячі
клавіші.

Механізм скасування побудований за допомогою патерна Знімок і Команди.
Перед виконанням команди, редактор зберігає в історії знімок свого
стану. Якщо потрібно скасувати команду, редактор бере останній запис з
історії та відновлює стан знімка. Для подальшої відміни береться
попередня команда з історії.

Скасовані команди зберігаються в історії поки користувач не зробить
яку-небудь дію. Це потрібно для того, щоби мати можливість повторювати
скасовані команди.

### []{#example-0--editor .anchor} **editor** {#editor .example-title}

#### []{#example-0--editor-Editor-java .anchor} **editor/Editor.java:** Редактор
...
#### []{#example-0--editor-Canvas-java .anchor} **editor/Canvas.java:** Полотно
...
#### []{#example-0--history-History-java .anchor} **history/History.java:** Історія використовує знімки і команди
...
#### []{#example-0--history-Memento-java .anchor} **history/Memento.java:** Знімок
...
#### []{#example-0--commands-Command-java .anchor} **commands/Command.java:** Інтерфейс команд
...
#### []{#example-0--commands-ColorCommand-java .anchor} **commands/ColorCommand.java:** Команда зміни кольору
...
#### []{#example-0--commands-MoveCommand-java .anchor} **commands/MoveCommand.java:** Команда переміщення
...
### []{#example-0--shapes .anchor} **shapes:** Різноманітні фігури {#shapes-різноманітні-фігури .example-title}
