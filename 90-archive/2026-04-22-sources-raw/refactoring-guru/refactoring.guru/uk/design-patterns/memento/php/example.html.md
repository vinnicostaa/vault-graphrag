...
[Знімок](../../memento.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Знімок** на PHP {#знімок-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Реальна можливість застосування патерна Знімок у світі
PHP під великим питанням. У багатьох випадках проблему зберігання копії
стану об'єктів можна вирішити куди простіше за допомогою серіалізації.
::::::::::::::
...
У цьому прикладі патерн **Знімок** використовується для реалізації
процесу керування конфігурацією PHP‑застосунку. Багато вебзастосунків
дозволяють користувачам налаштовувати свої параметри, і час від часу їм
потрібно скасувати зміни та повернути попередню конфігурацію. Патерн
Знімок можна застосувати для такої можливості, якщо фіксувати й
зберігати стан об'єкта конфігурації до внесення будь-яких змін.

#### []{#example-1--index-php .anchor} **index.php:** Життєвий приклад
