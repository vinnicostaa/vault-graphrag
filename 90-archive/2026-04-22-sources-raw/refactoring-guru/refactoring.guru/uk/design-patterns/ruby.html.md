...
# [ПАТЕРНИ]{.dp1-h-1} [ПРОЕКТУВАННЯ]{.dp1-h-2} [на]{.dp-lang-in} [Ruby]{.dp-lang} {#патерни-проектування-на-ruby .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## Каталог **Ruby**-прикладів {#каталог-ruby-прикладів .dp-h2}
...
[ Приклад
коду](abstract-factory/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](builder/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](factory-method/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](prototype/ruby/example.html#example-0){.dp-pattern-link}
...
[ Наївний
Одинак](singleton/ruby/example.html#example-0){.dp-pattern-link}
...
[ Багатопоточний
Одинак](singleton/ruby/example.html#example-1){.dp-pattern-link}
...
[ Приклад коду](adapter/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](bridge/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](composite/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](decorator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](facade/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](flyweight/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](proxy/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](chain-of-responsibility/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](command/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](iterator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](mediator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](memento/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](observer/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](state/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](strategy/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад
коду](template-method/ruby/example.html#example-0){.dp-pattern-link}
...
[ Приклад коду](visitor/ruby/example.html#example-0){.dp-pattern-link}
