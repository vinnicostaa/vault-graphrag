...
[Стан](../../state.html){.type} / [Python](../../python.html){.type}
:::
...
# **Стан** на Python {#стан-на-python .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Стан часто використовують в Python для
