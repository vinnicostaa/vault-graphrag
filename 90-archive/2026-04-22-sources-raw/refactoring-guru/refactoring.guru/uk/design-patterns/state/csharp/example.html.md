...
[Стан](../../state.html){.type} / [C#](../../csharp.html){.type}
:::
...
# **Стан** на C# {#стан-на-c .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Стан часто використовують в C# для перетворення
в об'єкти величезних стейт-машин, побудованих на операторах `switch`.
