...
[Стан](../../state.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **Стан** на Swift {#стан-на-swift .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Стан часто використовують в Swift для
