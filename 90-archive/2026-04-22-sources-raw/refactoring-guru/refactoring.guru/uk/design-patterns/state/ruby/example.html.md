...
[Стан](../../state.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Стан** на Ruby {#стан-на-ruby .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Стан часто використовують в Ruby для
