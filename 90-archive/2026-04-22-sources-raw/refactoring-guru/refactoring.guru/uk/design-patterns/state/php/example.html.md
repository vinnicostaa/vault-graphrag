...
[Стан](../../state.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Стан** на PHP {#стан-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Стан здебільшого використовують для
перетвореннягроміздких стейт-машин, побудованих на операторах `switch`,
в об'єкти.
...
У цьому прикладі патерн **Стан** використовується для представлення
різних станів Рахунку. Цей підхід дозволяє реалізувати різні перевірки
умов при переході рахунку з одного стану в інший, а також інкапсулювати
логіку кожного стану в окремому класі.

#### []{#example-1--index-php .anchor} **index.php:** Приклад структури патерна
