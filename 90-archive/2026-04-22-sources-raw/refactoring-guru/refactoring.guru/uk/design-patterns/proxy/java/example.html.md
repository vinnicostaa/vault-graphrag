...
[Замісник](../../proxy.html){.type} / [Java](../../java.html){.type}
:::
...
# **Замісник** на Java {#замісник-на-java .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Замісник застосовується в коді на Java тоді,
...
-   [`javax.ejb.EJB`](http://docs.oracle.com/javaee/7/api/javax/ejb/EJB.html)
    ([див.
    коментарі](http://stackoverflow.com/questions/25514361/when-using-ejb-does-each-managed-bean-get-its-own-ejb-instance))
-   [`javax.inject.Inject`](http://docs.oracle.com/javaee/7/api/javax/inject/Inject.html)
    ([див.
    коментарі](http://stackoverflow.com/questions/29651008/field-getobj-returns-all-nulls-on-injected-cdi-managed-beans-while-manually-i/29672591#29672591))
...
## Кешуючий замісник {#example-0-title}

Цей приклад показує, як з допомогою Замісника можна зробити ефективнішою
комунікацію по мережі з зовнішнім відеосервісом, кешуючи запити, що
повторюються.

Замісник особливо корисний, якщо у вас немає доступу до коду службових
класів, поведінку яких хочеться покращити. Він дозволяє змінити
поведінку реального об'єкта прозоро для клієнтського коду. У цьому
прикладі замісник і сам реальний об'єкт взаємозамінні.

### []{#example-0--some_cool_media_library .anchor} **some_cool_media_library** {#some_cool_media_library .example-title}

#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeLib-java .anchor} **some_cool_media_library/ThirdPartyYouTubeLib.java:** Інтерфейс віддаленого сервісу
...
#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeClass-java .anchor} **some_cool_media_library/ThirdPartyYouTubeClass.java:** Реалізація віддаленого сервісу
...
#### []{#example-0--some_cool_media_library-Video-java .anchor} **some_cool_media_library/Video.java:** Відеофайл
...
#### []{#example-0--proxy-YouTubeCacheProxy-java .anchor} **proxy/YouTubeCacheProxy.java:** Сервісний клас для роботи з кешем
...
#### []{#example-0--downloader-YouTubeDownloader-java .anchor} **downloader/YouTubeDownloader.java:** Завантажувач файлів
...
[Ланцюжок обов\'язків на Java []{.fa
