...
[Замісник](../../proxy.html){.type} / [C#](../../csharp.html){.type}
:::
...
# **Замісник** на C# {#замісник-на-c .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Замісник застосовується в коді на C# тоді, коли
потрібно замінити дійсний об'єкт його сурогатом, причому, непомітно для
клієнтів цього об'єкта. Це дозволить виконати додаткові поведінки до або
після основної поведінки дійсного об'єкта.
