...
[Замісник](../../proxy.html){.type} / [Python](../../python.html){.type}
:::
...
# **Замісник** на Python {#замісник-на-python .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Замісник застосовується в коді на Python тоді,
...
[Ланцюжок обов\'язків на Python []{.fa
