...
[Замісник](../../proxy.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Замісник** на PHP {#замісник-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Замісник застосовується в коді на PHP тоді,
