...
[Замісник](../../proxy.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Замісник** на Ruby {#замісник-на-ruby .pattern-example-title-block-title}
::::
...
**Застосування:** Патерн Замісник застосовується в коді на Ruby тоді,
