...
# **Стратегія** на Swift {#стратегія-на-swift .pattern-example-title-block-title}
::::
...
**Застосування:** Стратегія часто використовується в Swift-коді,
