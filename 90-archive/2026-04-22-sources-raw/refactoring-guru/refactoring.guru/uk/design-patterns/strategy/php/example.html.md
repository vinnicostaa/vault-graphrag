...
[Стратегія](../../strategy.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Стратегія** на PHP {#стратегія-на-php .pattern-example-title-block-title}
::::
...
**Застосування:** Стратегію часто використовують в PHP-коді, особливо
там, де потрібно підміняти алгоритми під час виконання програми.
Зверніть увагу, що для цього патерна в PHP є дуже потужний конкурент у
вигляді анонімних функцій, які PHP вже дуже давно підтримує.
...
[[]{.fa .fa-arrow-left} Стан на PHP](../../state/php/example.html){.btn
