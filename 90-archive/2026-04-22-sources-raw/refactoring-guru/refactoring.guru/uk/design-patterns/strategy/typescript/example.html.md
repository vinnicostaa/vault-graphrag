...
# **Стратегія** на TypeScript {#стратегія-на-typescript .pattern-example-title-block-title}
::::
...
**Застосування:** Стратегія часто використовується в TypeScript-коді,
особливо там, де потрібно підміняти алгоритм під час виконання програми.
Багато прикладів стратегії можна замінити простими анонімними функціями.
...
[Шаблонний метод на TypeScript []{.fa
