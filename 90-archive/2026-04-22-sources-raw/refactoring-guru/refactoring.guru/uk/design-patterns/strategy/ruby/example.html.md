...
[Стратегія](../../strategy.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Стратегія** на Ruby {#стратегія-на-ruby .pattern-example-title-block-title}
::::
...
**Застосування:** Стратегія часто використовується в Ruby-коді, особливо
