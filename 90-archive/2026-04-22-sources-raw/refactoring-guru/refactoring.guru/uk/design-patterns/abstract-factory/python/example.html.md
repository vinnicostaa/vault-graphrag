...
# **Абстрактна фабрика** на Python {#абстрактна-фабрика-на-python .pattern-example-title-block-title}
::::
...
там, де потрібно породжувати сімейства класів, не прив'язуючи до них
свій код (наприклад, у фреймворках).
