...
# **Абстрактна фабрика** на TypeScript {#абстрактна-фабрика-на-typescript .pattern-example-title-block-title}
::::
...
особливо там, де потрібно породжувати сімейства класів, не прив'язуючи
до них свій код (наприклад, у фреймворках).
...
Цей приклад показує структуру патерна **Абстрактна фабрика**, а саме ---
з яких класів він складається, які ролі ці класи виконують і як вони
