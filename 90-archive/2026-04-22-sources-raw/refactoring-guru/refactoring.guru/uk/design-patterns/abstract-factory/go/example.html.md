...
# **Абстрактна фабрика** на Go {#абстрактна-фабрика-на-go .pattern-example-title-block-title}
::::
...
Уявімо, що вам потрібно купити спортивну форму, яка складається з двох
різних речей: пара взуття і футболка. Ви хочете придбати повний комплект
від одного бренду, щоб речі поєднувалися між собою.

Перекладаючи вищевказане у код, Абстрактна фабрика допоможе нам
створювати набори продуктів, які завжди будуть підходити один до одного.

#### []{#example-0--iSportsFactory-go .anchor} **iSportsFactory.go:** Інтерфейс абстрактної фабрики
...
#### []{#example-0--adidas-go .anchor} **adidas.go:** Конкретна фабрика
...
#### []{#example-0--nike-go .anchor} **nike.go:** Конкретна фабрика
...
#### []{#example-0--iShoe-go .anchor} **iShoe.go:** Абстрактний продукт
...
#### []{#example-0--adidasShoe-go .anchor} **adidasShoe.go:** Конкретний продукт
...
#### []{#example-0--nikeShoe-go .anchor} **nikeShoe.go:** Конкретний продукт
...
#### []{#example-0--iShirt-go .anchor} **iShirt.go:** Абстрактний продукт
...
#### []{#example-0--adidasShirt-go .anchor} **adidasShirt.go:** Конкретний продукт
...
#### []{#example-0--nikeShirt-go .anchor} **nikeShirt.go:** Конкретний продукт
...
[[]{.fa .fa-arrow-left} Патерни проектування на Go](../../go.html){.btn
...
height="53"
loading="lazy"}](../java/example.html "Абстрактна фабрика на Java"){.prog-lang-link}
[![Абстрактна фабрика на
