...
[Строитель](../../builder.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Строитель** на Ruby {#строитель-на-ruby .pattern-example-title-block-title}
::::
...
<figure class="code">
<pre class="code" lang="ruby"><code># Интерфейс Строителя объявляет создающие методы для различных частей объектов
# Продуктов.
#
# @abstract
class Builder
