...
# **Состояние** на Python {#состояние-на-python .pattern-example-title-block-title}
::::
...
**Применимость:** Паттерн Состояние часто используют в Python для
