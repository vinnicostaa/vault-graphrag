...
# **Компоновщик** на Ruby {#компоновщик-на-ruby .pattern-example-title-block-title}
::::
...
<figure class="code">
<pre class="code" lang="ruby"><code># Базовый класс Компонент объявляет общие операции как для простых, так и для
