...
# **Шаблонный метод** на TypeScript {#шаблонный-метод-на-typescript .pattern-example-title-block-title}
::::
...
библиотечных классах TypeScript. Разработчики создают их, чтобы
