...
[Заместитель](../../proxy.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Заместитель** на Rust {#заместитель-на-rust .pattern-example-title-block-title}
::::
...
[Цепочка обязанностей на Rust []{.fa
