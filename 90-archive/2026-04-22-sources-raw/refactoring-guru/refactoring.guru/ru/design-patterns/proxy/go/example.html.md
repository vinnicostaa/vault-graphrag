...
[Заместитель](../../proxy.html){.type} / [Go](../../go.html){.type}
:::
...
# **Заместитель** на Go {#заместитель-на-go .pattern-example-title-block-title}
::::
...
Такой веб-сервер, как Nginx, может выполнять функции Заместителя для
сервера вашего приложения:
...
#### []{#example-0--server-go .anchor} **server.go:** Сервис
...
#### []{#example-0--nginx-go .anchor} **nginx.go:** Заместитель
...
#### []{#example-0--application-go .anchor} **application.go:** реальный сервис
