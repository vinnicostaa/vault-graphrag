...
[Посетитель](../../visitor.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Посетитель** на Ruby {#посетитель-на-ruby .pattern-example-title-block-title}
::::
...
**Применимость:** Посетитель нечасто встречается в Ruby-коде из-за своей
...
<figure class="code">
<pre class="code" lang="ruby"><code># Интерфейс Компонента объявляет метод accept, который в качестве аргумента
