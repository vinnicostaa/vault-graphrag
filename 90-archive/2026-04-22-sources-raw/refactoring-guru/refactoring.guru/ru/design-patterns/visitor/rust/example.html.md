...
[Посетитель](../../visitor.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Посетитель** на Rust {#посетитель-на-rust .pattern-example-title-block-title}
::::
...
[Паттерны проектирования на Swift []{.fa
