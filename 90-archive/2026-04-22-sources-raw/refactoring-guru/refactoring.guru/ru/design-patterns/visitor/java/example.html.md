...
[Посетитель](../../visitor.html){.type} / [Java](../../java.html){.type}
:::
...
# **Посетитель** на Java {#посетитель-на-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Сериализация объектов в XML](#example-0)
:::
...
**Применимость:** Посетитель нечасто встречается в Java-коде из-за своей
...
## Сериализация объектов в XML {#example-0-title}

В нашем примере классы геометрических фигур не могут сами экспортировать
своё состояние в XML. Представьте, что у вас нет доступа к их коду.
...
#### []{#example-0--shapes-Dot-java .anchor} **shapes/Dot.java:** Точка
...
#### []{#example-0--shapes-Rectangle-java .anchor} **shapes/Rectangle.java:** Четырёхугольник
...
#### []{#example-0--shapes-CompoundShape-java .anchor} **shapes/CompoundShape.java:** Составная фигура
...
#### []{#example-0--visitor-Visitor-java .anchor} **visitor/Visitor.java:** Интерфейс посетителя
...
#### []{#example-0--visitor-XMLExportVisitor-java .anchor} **visitor/XMLExportVisitor.java:** Конкретный посетитель
...
[Паттерны проектирования на PHP []{.fa
