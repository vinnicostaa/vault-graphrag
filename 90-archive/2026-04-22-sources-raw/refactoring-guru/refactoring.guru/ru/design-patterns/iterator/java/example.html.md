...
[Итератор](../../iterator.html){.type} / [Java](../../java.html){.type}
:::
...
# **Итератор** на Java {#итератор-на-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Перебор профилей социальной сети](#example-0)
:::
...
## Перебор профилей социальной сети {#example-0-title}

В этом примере итератор помогает перебирать профили пользователей
социальной сети, не раскрывая клиентскому коду подробности коммуникации
с самой сетью.

### []{#example-0--iterators .anchor} **iterators** {#iterators .example-title}

#### []{#example-0--iterators-ProfileIterator-java .anchor} **iterators/ProfileIterator.java:** Интерфейс итератора
...
#### []{#example-0--iterators-FacebookIterator-java .anchor} **iterators/FacebookIterator.java:** Итератор пользователей сети Facebook
...
#### []{#example-0--iterators-LinkedInIterator-java .anchor} **iterators/LinkedInIterator.java:** Итератор пользователей сети LinkedIn
...
#### []{#example-0--social_networks-SocialNetwork-java .anchor} **social_networks/SocialNetwork.java:** Интерфейс социальной сети
...
#### []{#example-0--profile-Profile-java .anchor} **profile/Profile.java:** Профиль пользователя
...
#### []{#example-0--spammer-SocialSpammer-java .anchor} **spammer/SocialSpammer.java:** Приложение рассылки сообщений
