...
[Посредник](../../mediator.html){.type} / [Java](../../java.html){.type}
:::
...
# **Посредник** на Java {#посредник-на-java .pattern-example-title-block-title}
::::
...
Java-коде --- это связь нескольких компонентов GUI одной программы.
...
## Редактор заметок {#example-0-title}

Этот пример показывает как организовать множество элементов интерфейса
при помощи посредника так, чтобы они не знали и не зависели друг от
друга.

### []{#example-0--components .anchor} **components:** Классы-коллеги {#components-классы-коллеги .example-title}
...
#### []{#example-0--mediator-Mediator-java .anchor} **mediator/Mediator.java:** Общий интерфейс посредника
...
#### []{#example-0--mediator-Editor-java .anchor} **mediator/Editor.java:** Конкретный посредник
...
#### []{#example-0--mediator-Note-java .anchor} **mediator/Note.java:** Класс заметок
...
#### []{#example-0--Demo-java .anchor} **Demo.java:** Код инициализации
...
#### []{#example-0--OutputDemo-png .anchor} **OutputDemo.png:** Результат выполнения
