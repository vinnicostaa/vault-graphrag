...
[Посредник](../../mediator.html){.type} / [C++](../../cpp.html){.type}
:::
...
**Применимость:** Пожалуй, самое популярное применение Посредника в C++
коде --- это связь нескольких компонентов GUI одной программы.
:::::::::::
