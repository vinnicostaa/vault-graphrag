...
# **Стратегия** на Python {#стратегия-на-python .pattern-example-title-block-title}
::::
...
**Применимость:** Стратегия часто используется в Python-коде, особенно
