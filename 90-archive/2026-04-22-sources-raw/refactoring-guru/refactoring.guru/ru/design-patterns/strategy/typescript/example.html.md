...
# **Стратегия** на TypeScript {#стратегия-на-typescript .pattern-example-title-block-title}
::::
...
**Применимость:** Стратегия часто используется в TypeScript-коде,
особенно там, где нужно подменять алгоритм во время выполнения
программы. Многие примеры стратегии можно заменить простыми анонимными
функциями.
...
[Шаблонный метод на TypeScript []{.fa
