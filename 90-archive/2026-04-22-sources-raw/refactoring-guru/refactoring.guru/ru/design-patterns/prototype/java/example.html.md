...
::: en-intro
 [Копирование графических фигур](#example-0)
:::
...
Любой класс может реализовать этот интерфейс, чтобы позволить
собственное клонирование.
...
## Копирование графических фигур {#example-0-title}

Рассмотрим пример реализации Прототипа без использования интерфейса
`Cloneable`.

### []{#example-0--shapes .anchor} **shapes:** Список фигур {#shapes-список-фигур .example-title}

#### []{#example-0--shapes-Shape-java .anchor} **shapes/Shape.java:** Общий интерфейс фигур
...
#### []{#example-0--shapes-Circle-java .anchor} **shapes/Circle.java:** Простая фигура
...
#### []{#example-0--shapes-Rectangle-java .anchor} **shapes/Rectangle.java:** Фигура чуть сложнее
...
#### []{#example-0--Demo-java .anchor} **Demo.java:** Пример клонирования
...
Вы можете добавить в программу фабрику прототипов, которая будет хранить
каталог прототипов. Таким образом, вы сможете запрашивать у фабрики
новые объекты, описывая нужные вам свойства. Фабрика будет искать
соответствующий прототип в кеше и возвращать вам копию.

### []{#example-0--cache .anchor} **cache** {#cache .example-title}

#### []{#example-0--cache-BundledShapeCache-java .anchor} **cache/BundledShapeCache.java:** Фабрика прототипов
