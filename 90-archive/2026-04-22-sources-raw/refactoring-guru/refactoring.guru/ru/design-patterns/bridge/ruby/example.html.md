...
[Мост](../../bridge.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Мост** на Ruby {#мост-на-ruby .pattern-example-title-block-title}
::::
...
<figure class="code">
<pre class="code" lang="ruby"><code># Абстракция устанавливает интерфейс для «управляющей» части двух иерархий
