...
# **Décorateur** en Java {#décorateur-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Décorateurs d'encodage et de compression](#example-0)
:::
...
**Exemples d'utilisation :** Le décorateur est assez standard en Java,
...
-   Toutes les sous-classes de
    ...
    ont des constructeurs qui acceptent des objets de leur propre type.
...
## Décorateurs d'encodage et de compression {#example-0-title}

Dans cet exemple, vous allez voir comment ajuster le comportement d'un
objet sans toucher à son code.

À la base, la classe contenant la logique métier ne pouvait que lire et
écrire des données en texte brut. Nous avons par la suite créé plusieurs
petites classes d'emballeurs qui ont ajouté de nouveaux comportements en
appelant des traitements standards dans un objet emballé.

Le premier emballeur chiffre et déchiffre les données, le second
compresse et extrait les données.

Vous pouvez même combiner ces emballeurs en emballant un décorateur dans
l'autre.

### []{#example-0--decorators .anchor} **decorators** {#decorators .example-title}

#### []{#example-0--decorators-DataSource-java .anchor} **decorators/DataSource.java:** Une interface commune qui définit les traitements de lecture et d'écriture
...
#### []{#example-0--decorators-FileDataSource-java .anchor} **decorators/FileDataSource.java:** Lecture et écriture simple des données
...
#### []{#example-0--decorators-DataSourceDecorator-java .anchor} **decorators/DataSourceDecorator.java:** Décorateur de base abstrait
...
#### []{#example-0--decorators-EncryptionDecorator-java .anchor} **decorators/EncryptionDecorator.java:** Décorateur de chiffrage
...
#### []{#example-0--decorators-CompressionDecorator-java .anchor} **decorators/CompressionDecorator.java:** Décorateur de compression
