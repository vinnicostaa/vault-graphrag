...
[Décorateur](../../decorator.html){.type} / [Go](../../go.html){.type}
:::
...
# **Décorateur** en Go {#décorateur-en-go .pattern-example-title-block-title}
::::
...
#### []{#example-0--pizza-go .anchor} **pizza.go:** Interface du composant
...
#### []{#example-0--veggieMania-go .anchor} **veggieMania.go:** Composant concret
...
#### []{#example-0--tomatoTopping-go .anchor} **tomatoTopping.go:** Décorateur concret
...
#### []{#example-0--cheeseTopping-go .anchor} **cheeseTopping.go:** Décorateur concret
