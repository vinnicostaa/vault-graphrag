...
# **Décorateur** en TypeScript {#décorateur-en-typescript .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** Le décorateur est assez standard en
TypeScript, surtout dans le code qui utilise les flux (stream).
