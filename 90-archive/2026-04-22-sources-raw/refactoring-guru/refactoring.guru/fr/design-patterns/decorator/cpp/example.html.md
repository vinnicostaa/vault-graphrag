...
[Décorateur](../../decorator.html){.type} / [C++](../../cpp.html){.type}
:::
...
# **Décorateur** en C++ {#décorateur-en-c .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** Le décorateur est assez standard en C++,
