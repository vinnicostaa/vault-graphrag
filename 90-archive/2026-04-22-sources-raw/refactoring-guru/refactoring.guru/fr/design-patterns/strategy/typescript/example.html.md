...
# **Stratégie** en TypeScript {#stratégie-en-typescript .pattern-example-title-block-title}
::::
...
répandu en TypeScript. Il est souvent utilisé dans divers frameworks
pour fournir aux utilisateurs la possibilité de modifier le comportement
...
[Patron de méthode en TypeScript []{.fa
.fa-arrow-right}](../../template-method/typescript/example.html){.btn
...
TypeScript](../../state/typescript/example.html){.btn .btn-default
rel="prev"}
:::
