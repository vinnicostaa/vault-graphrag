...
# **Stratégie** en Swift {#stratégie-en-swift .pattern-example-title-block-title}
::::
...
répandu en Swift. Il est souvent utilisé dans divers frameworks pour
