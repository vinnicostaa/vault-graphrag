...
# **Prototype** en Ruby {#prototype-en-ruby .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** Le prototype est prêt à l'emploi dans Ruby
avec une interface méthode `dup` ou `clone`.
