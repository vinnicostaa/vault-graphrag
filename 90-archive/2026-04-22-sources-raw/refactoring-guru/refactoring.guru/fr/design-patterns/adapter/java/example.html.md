...
[Adaptateur](../../adapter.html){.type} / [Java](../../java.html){.type}
:::
...
# **Adaptateur** en Java {#adaptateur-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Adapter des pièces carrées avec des trous ronds](#example-0)
:::
...
**Exemples d'utilisation :** L'adaptateur est très répandu en Java. On
...
Certains adaptateurs standards peuvent être retrouvés dans les
...
## Adapter des pièces carrées avec des trous ronds {#example-0-title}

Dans cet exemple simple, nous allons voir comment l'adaptateur peut
faire collaborer deux objets incompatibles.

### []{#example-0--round .anchor} **round** {#round .example-title}

#### []{#example-0--round-RoundHole-java .anchor} **round/RoundHole.java:** Trous ronds
...
#### []{#example-0--round-RoundPeg-java .anchor} **round/RoundPeg.java:** Pièces rondes
...
#### []{#example-0--square-SquarePeg-java .anchor} **square/SquarePeg.java:** Pièces carrées
...
#### []{#example-0--adapters-SquarePegAdapter-java .anchor} **adapters/SquarePegAdapter.java:** Adaptateur de pièces carrées avec des trous ronds
