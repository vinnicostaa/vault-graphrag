...
# **Composite** en TypeScript {#composite-en-typescript .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** Le composite est très répandu en
TypeScript. Il est souvent utilisé pour modéliser les hiérarchies des
composants d'une interface utilisateur ou pour du code qui manipule des
graphes.
