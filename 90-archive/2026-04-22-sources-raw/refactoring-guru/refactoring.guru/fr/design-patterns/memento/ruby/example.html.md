...
[Mémento](../../memento.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Mémento** en Ruby {#mémento-en-ruby .pattern-example-title-block-title}
::::
...
utilisant la sérialisation, ce qui est assez commun en Ruby. Ce n'est
