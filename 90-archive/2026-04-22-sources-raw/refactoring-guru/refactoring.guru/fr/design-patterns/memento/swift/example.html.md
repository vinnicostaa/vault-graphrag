...
[Mémento](../../memento.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **Mémento** en Swift {#mémento-en-swift .pattern-example-title-block-title}
::::
...
utilisant la sérialisation, ce qui est assez commun en Swift. Ce n'est
