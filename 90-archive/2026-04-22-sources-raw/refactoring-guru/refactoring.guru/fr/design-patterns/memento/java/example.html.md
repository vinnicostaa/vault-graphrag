...
[Mémento](../../memento.html){.type} / [Java](../../java.html){.type}
:::
...
# **Mémento** en Java {#mémento-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Éditeur de formes et annuler/rétablir complexe](#example-0)
:::
...
utilisant la sérialisation, ce qui est assez commun en Java. Ce n'est
pas forcément la seule manière de prendre des instantanés de l'état d'un
objet (ni la plus efficace), mais le mémento permet de stocker des
...
## Éditeur de formes et annuler/rétablir complexe {#example-0-title}

Cet éditeur graphique permet de modifier la couleur et la position des
formes à l'écran. Toute modification peut être annulée et rétablie.

L'action « annuler » est basée sur la collaboration entre les patrons de
conception mémento et commande. L'éditeur tient l'historique des
commandes effectuées. Avant d'exécuter une commande, il fait une
sauvegarde et la relie avec l'objet commande. Après l'exécution, il
pousse la commande concernée dans l'historique.

Lorsqu'un utilisateur demande une annulation, l'éditeur récupère une
commande récente de l'historique et restaure l'état de la sauvegarde
stockée dans cette commande. Si l'utilisateur demande une autre
annulation, l'éditeur prend la commande suivante de l'historique et
ainsi de suite.

Les commandes annulées sont gardées dans l'historique jusqu'à ce que
l'utilisateur fasse de nouvelles modifications sur les formes à l'écran.
Ce point est crucial pour rétablir les commandes annulées.

### []{#example-0--editor .anchor} **editor** {#editor .example-title}

#### []{#example-0--editor-Editor-java .anchor} **editor/Editor.java:** Code de l'éditeur
...
#### []{#example-0--editor-Canvas-java .anchor} **editor/Canvas.java:** Code du canevas
...
#### []{#example-0--history-History-java .anchor} **history/History.java:** L'historique stocke des commandes et des mémentos
...
#### []{#example-0--history-Memento-java .anchor} **history/Memento.java:** Classe Mémento
...
#### []{#example-0--commands-Command-java .anchor} **commands/Command.java:** Classe de base Commande
...
#### []{#example-0--commands-ColorCommand-java .anchor} **commands/ColorCommand.java:** Modifie la couleur de la forme sélectionnée
...
#### []{#example-0--commands-MoveCommand-java .anchor} **commands/MoveCommand.java:** Déplace la forme sélectionnée
...
### []{#example-0--shapes .anchor} **shapes:** Différentes formes {#shapes-différentes-formes .example-title}
...
#### []{#example-0--Demo-java .anchor} **Demo.java:** Code d'initialisation
