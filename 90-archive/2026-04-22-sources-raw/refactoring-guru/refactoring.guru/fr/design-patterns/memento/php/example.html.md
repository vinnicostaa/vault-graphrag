...
[Mémento](../../memento.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Mémento** en PHP {#mémento-en-php .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** L'utilisation du mémento en PHP peut
sembler douteuse. Dans la majorité des cas, vous pouvez faire la copie
de l'état d'un objet plus facilement en utilisant la sérialisation.
::::::::::::::
...
Dans cet exemple, le patron **Mémento** est utilisé pour mettre en place
un flux de gestion de configuration dans une application web PHP. De
nombreuses applications web permettent aux utilisateurs de personnaliser
leurs paramètres et, parfois, ceux-ci souhaitent annuler leurs
modifications pour retrouver la configuration précédente. Le patron
Mémento permet de fournir cette fonctionnalité en capturant et en
stockant l'état de l'objet de configuration avant toute modification.
