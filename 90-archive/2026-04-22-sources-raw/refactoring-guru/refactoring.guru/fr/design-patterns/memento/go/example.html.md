...
[Mémento](../../memento.html){.type} / [Go](../../go.html){.type}
:::
...
# **Mémento** en Go {#mémento-en-go .pattern-example-title-block-title}
::::
...
Le patron de conception mémento permet de sauvegarder les instantanés de
l'état d'un objet. Vous pouvez les utiliser pour rétablir un objet dans
un état passé. Ce système se montre très pratique pour implémenter des
opérations annuler-rétablir sur un objet.

#### []{#example-0--originator-go .anchor} **originator.go:** Créateur
...
#### []{#example-0--memento-go .anchor} **memento.go:** Mémento
...
#### []{#example-0--caretaker-go .anchor} **caretaker.go:** Gardien
