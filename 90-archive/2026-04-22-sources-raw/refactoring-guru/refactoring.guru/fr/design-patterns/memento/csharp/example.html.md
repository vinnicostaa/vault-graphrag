...
[Mémento](../../memento.html){.type} / [C#](../../csharp.html){.type}
:::
...
# **Mémento** en C# {#mémento-en-c .pattern-example-title-block-title}
::::
...
utilisant la sérialisation, ce qui est assez commun en C#. Ce n'est pas
forcément la manière la plus efficace de prendre des instantanés de
