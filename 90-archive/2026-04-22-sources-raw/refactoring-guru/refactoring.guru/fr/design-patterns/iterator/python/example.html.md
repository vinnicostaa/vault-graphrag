...
# **Itérateur** en Python {#itérateur-en-python .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** L'itérateur est très répandu en Python. Il
