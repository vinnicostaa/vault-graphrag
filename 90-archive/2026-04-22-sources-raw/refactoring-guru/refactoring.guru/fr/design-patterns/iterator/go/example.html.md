...
[Itérateur](../../iterator.html){.type} / [Go](../../go.html){.type}
:::
...
# **Itérateur** en Go {#itérateur-en-go .pattern-example-title-block-title}
::::
...
Le but du patron de conception itérateur est d'extraire la logique
d'itération d'une collection et de la mettre dans un autre objet que
l'on appelle un itérateur. Cet itérateur fournit une méthode générique
pour parcourir une collection indépendamment de son type.

#### []{#example-0--collection-go .anchor} **collection.go:** Collection
...
#### []{#example-0--userCollection-go .anchor} **userCollection.go:** Collection concrète
...
#### []{#example-0--iterator-go .anchor} **iterator.go:** Itérateur
...
#### []{#example-0--userIterator-go .anchor} **userIterator.go:** Itérateur concret
...
#### []{#example-0--user-go .anchor} **user.go:** Code client
