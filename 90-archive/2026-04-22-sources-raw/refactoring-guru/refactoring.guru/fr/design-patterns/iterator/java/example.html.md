...
[Itérateur](../../iterator.html){.type} / [Java](../../java.html){.type}
:::
...
# **Itérateur** en Java {#itérateur-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Itérer sur des profils de réseaux sociaux](#example-0)
:::
...
**Exemples d'utilisation :** L'itérateur est très répandu en Java. Il
est utilisé dans de nombreux frameworks et bibliothèques pour fournir
...
## Itérer sur des profils de réseaux sociaux {#example-0-title}

Dans cet exemple, l'itérateur est utilisé pour parcourir une collection
de profils issus d'un réseau social distant, sans exposer les détails de
la communication au code client.

### []{#example-0--iterators .anchor} **iterators** {#iterators .example-title}

#### []{#example-0--iterators-ProfileIterator-java .anchor} **iterators/ProfileIterator.java:** Définit l'interface des profils
...
#### []{#example-0--iterators-FacebookIterator-java .anchor} **iterators/FacebookIterator.java:** Implémente l'itération sur des profils Facebook
...
#### []{#example-0--iterators-LinkedInIterator-java .anchor} **iterators/LinkedInIterator.java:** Implémente l'itération sur des profils LinkedIn
...
#### []{#example-0--social_networks-SocialNetwork-java .anchor} **social_networks/SocialNetwork.java:** Définit une interface commune pour les réseaux sociaux
...
#### []{#example-0--profile-Profile-java .anchor} **profile/Profile.java:** Profils de réseaux sociaux
...
#### []{#example-0--spammer-SocialSpammer-java .anchor} **spammer/SocialSpammer.java:** Application d'envoi de messages
