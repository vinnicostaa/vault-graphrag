...
# **Itérateur** en Swift {#itérateur-en-swift .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** L'itérateur est très répandu en Swift. Il
