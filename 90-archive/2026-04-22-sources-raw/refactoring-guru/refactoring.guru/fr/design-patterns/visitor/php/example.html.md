...
[Visiteur](../../visitor.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Visiteur** en PHP {#visiteur-en-php .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** Le visiteur n'est pas très répandu en PHP à
cause de sa complexité et de la rareté de ses cas d'utilisation.
::::::::::::::
...
Dans cet exemple, le **Visiteur** aide à implanter une fonctionnalité de
création de rapports dans une hiérarchie de classes existante :
`Société > Département > Employé`.

Une fois que l'infrastructure du visiteur a été ajoutée à l'application,
vous pouvez facilement y ajouter d'autres comportements similaires sans
toucher aux classes existantes.
...
[Les patrons de conception en Python []{.fa
