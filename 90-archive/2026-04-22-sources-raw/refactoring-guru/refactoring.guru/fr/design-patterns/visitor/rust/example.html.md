...
[Visiteur](../../visitor.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Visiteur** en Rust {#visiteur-en-rust .pattern-example-title-block-title}
::::
...
[Les patrons de conception en Swift []{.fa
