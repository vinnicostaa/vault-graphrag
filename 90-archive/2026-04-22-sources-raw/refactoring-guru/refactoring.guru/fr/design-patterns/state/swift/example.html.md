...
[État](../../state.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **État** en Swift {#état-en-swift .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** L'état est souvent utilisé en Swift pour
