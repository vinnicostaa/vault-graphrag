...
[État](../../state.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **État** en Ruby {#état-en-ruby .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** L'état est souvent utilisé en Ruby pour
