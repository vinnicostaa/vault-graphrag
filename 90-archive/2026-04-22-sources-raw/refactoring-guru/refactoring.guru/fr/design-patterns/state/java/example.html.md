...
[État](../../state.html){.type} / [Java](../../java.html){.type}
:::
...
# **État** en Java {#état-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Interface d'un lecteur média](#example-0)
:::
...
**Exemples d'utilisation :** L'état est souvent utilisé en Java pour
...
-   [`javax.faces.lifecycle.LifeCycle#execute()`](http://docs.oracle.com/javaee/7/api/javax/faces/lifecycle/Lifecycle.html#execute-javax.faces.context.FacesContext-)
    ...
    le comportement dépend de l'étape actuelle (état) du cycle de vie de
    JSF)
...
## Interface d'un lecteur média {#example-0-title}
...
lecture. La classe principale du lecteur garde une référence vers un
objet état qui effectue la majeure partie du travail pour le lecteur.
Certaines actions finiront par remplacer l'état actuel par un autre,
modifiant les réactions du lecteur face aux interactions de
l'utilisateur.

### []{#example-0--states .anchor} **states** {#states .example-title}

#### []{#example-0--states-State-java .anchor} **states/State.java:** Interface État commune
...
#### []{#example-0--ui-Player-java .anchor} **ui/Player.java:** Code principal du lecteur
...
#### []{#example-0--ui-UI-java .anchor} **ui/UI.java:** GUI du lecteur
