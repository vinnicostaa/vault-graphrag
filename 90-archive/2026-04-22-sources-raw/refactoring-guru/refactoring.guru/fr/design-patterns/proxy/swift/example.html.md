...
# **Procuration** en Swift {#procuration-en-swift .pattern-example-title-block-title}
::::
...
Swift, mais elle se montre très pratique dans certains cas. Elle est
...
[Chaîne de responsabilité en Swift []{.fa
