...
[Procuration](../../proxy.html){.type} / [Java](../../java.html){.type}
:::
...
# **Procuration** en Java {#procuration-en-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Procuration de mise en cache](#example-0)
:::
...
**Exemples d'utilisation :** La procuration n'est pas souvent invitée
dans les programmes Java, mais elle se montre très pratique dans
certains cas. Elle est incontournable lorsque vous voulez ajouter de
nouveaux comportements à un objet d'une classe existante sans toucher au
code client.

Voici quelques exemples tirés des bibliothèques standards Java :
...
-   [`javax.ejb.EJB`](http://docs.oracle.com/javaee/7/api/javax/ejb/EJB.html)
    ([voir
    commentaires](http://stackoverflow.com/questions/25514361/when-using-ejb-does-each-managed-bean-get-its-own-ejb-instance))
-   [`javax.inject.Inject`](http://docs.oracle.com/javaee/7/api/javax/inject/Inject.html)
    ([voir
    commentaires](http://stackoverflow.com/questions/29651008/field-getobj-returns-all-nulls-on-injected-cdi-managed-beans-while-manually-i/29672591#29672591))
...
## Procuration de mise en cache {#example-0-title}

Dans cet exemple, la procuration aide à implémenter l'instanciation
paresseuse et la mise en cache d'une bibliothèque d'intégration YouTube
externe peu efficace.

La procuration est indispensable lorsque vous voulez ajouter des
comportements à une classe dont vous ne pouvez pas modifier le code.

### []{#example-0--some_cool_media_library .anchor} **some_cool_media_library** {#some_cool_media_library .example-title}

#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeLib-java .anchor} **some_cool_media_library/ThirdPartyYouTubeLib.java:** Interface du service distant
...
#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeClass-java .anchor} **some_cool_media_library/ThirdPartyYouTubeClass.java:** Implémentation du service distant
...
#### []{#example-0--some_cool_media_library-Video-java .anchor} **some_cool_media_library/Video.java:** Fichier vidéo
...
#### []{#example-0--proxy-YouTubeCacheProxy-java .anchor} **proxy/YouTubeCacheProxy.java:** Procuration de mise en cache
...
#### []{#example-0--downloader-YouTubeDownloader-java .anchor} **downloader/YouTubeDownloader.java:** Application de téléchargement de médias
...
[Chaîne de responsabilité en Java []{.fa
