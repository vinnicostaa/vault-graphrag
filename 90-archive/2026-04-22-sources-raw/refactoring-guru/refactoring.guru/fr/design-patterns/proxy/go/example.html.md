...
[Procuration](../../proxy.html){.type} / [Go](../../go.html){.type}
:::
...
# **Procuration** en Go {#procuration-en-go .pattern-example-title-block-title}
::::
...
Un serveur Web tel que Nginx peut servir de procuration pour votre
...
#### []{#example-0--server-go .anchor} **server.go:** Sujet
...
#### []{#example-0--nginx-go .anchor} **nginx.go:** Procuration
...
#### []{#example-0--application-go .anchor} **application.go:** Sujet réel
...
[Chaîne de responsabilité en Go []{.fa
