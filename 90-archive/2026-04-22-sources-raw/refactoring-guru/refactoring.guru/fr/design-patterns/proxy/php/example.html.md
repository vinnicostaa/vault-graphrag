...
[Procuration](../../proxy.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Procuration** en PHP {#procuration-en-php .pattern-example-title-block-title}
::::
...
dans les programmes PHP, mais elle se montre très pratique dans certains
cas. Elle est incontournable lorsque vous voulez ajouter de nouveaux
comportements à un objet d'une classe existante sans modifier le code
client.
...
Dans cet exemple, nous allons voir la structure de la **Procuration** et
...
Il y a de nombreuses manières d'utiliser les **Procurations** (mise en
cache, historisation des logs, vérification des droits, instanciation
paresseuse, etc.). Cet exemple montre comment elle peut améliorer la
performance d'un objet de téléchargement en mettant en cache ses
résultats.
...
[Chaîne de responsabilité en PHP []{.fa
