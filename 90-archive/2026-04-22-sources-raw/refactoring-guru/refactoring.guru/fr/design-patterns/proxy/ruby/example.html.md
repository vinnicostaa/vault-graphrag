...
[Procuration](../../proxy.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Procuration** en Ruby {#procuration-en-ruby .pattern-example-title-block-title}
::::
...
Ruby, mais elle se montre très pratique dans certains cas. Elle est
