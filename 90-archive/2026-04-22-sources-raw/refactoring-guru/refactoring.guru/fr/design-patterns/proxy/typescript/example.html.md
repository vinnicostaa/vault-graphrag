...
# **Procuration** en TypeScript {#procuration-en-typescript .pattern-example-title-block-title}
::::
...
TypeScript, mais elle se montre très pratique dans certains cas. Elle
est incontournable lorsque vous voulez ajouter de nouveaux comportements
à un objet d'une classe existante sans modifier le code client.
...
[Chaîne de responsabilité en TypeScript []{.fa
