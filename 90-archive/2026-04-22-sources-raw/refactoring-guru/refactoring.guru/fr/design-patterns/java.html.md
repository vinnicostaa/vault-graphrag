...
# [Les patrons]{.dp1-h-1} [de]{.dp-h-article} [conception]{.dp1-h-2} [en]{.dp-lang-in} [Java]{.dp-lang} {#les-patrons-de-conception-en-java .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## Le catalogue des exemples en **Java** {#le-catalogue-des-exemples-en-java .dp-h2}
...
[ Exemple de
code](abstract-factory/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](builder/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](factory-method/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](prototype/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](adapter/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](bridge/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](composite/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](decorator/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](facade/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](flyweight/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](proxy/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](chain-of-responsibility/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](command/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](iterator/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](mediator/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](memento/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](observer/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](state/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](strategy/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](template-method/java/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](visitor/java/example.html#example-0){.dp-pattern-link}
