...
# **Chaîne de responsabilité** en Python {#chaîne-de-responsabilité-en-python .pattern-example-title-block-title}
::::
...
souvent invitée dans les programmes Python, car son intérêt réside dans
