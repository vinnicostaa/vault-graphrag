...
# **Chaîne de responsabilité** en Ruby {#chaîne-de-responsabilité-en-ruby .pattern-example-title-block-title}
::::
...
souvent invitée dans les programmes Ruby, car son intérêt réside dans la
gestion du chaînage.
