...
# [Les patrons]{.dp1-h-1} [de]{.dp-h-article} [conception]{.dp1-h-2} [en]{.dp-lang-in} [Python]{.dp-lang} {#les-patrons-de-conception-en-python .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## Le catalogue des exemples en **Python** {#le-catalogue-des-exemples-en-python .dp-h2}
...
[ Exemple de
code](abstract-factory/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](builder/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](factory-method/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](prototype/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](adapter/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](bridge/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](composite/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](decorator/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](facade/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](flyweight/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](proxy/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](chain-of-responsibility/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](command/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](iterator/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](mediator/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](memento/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](observer/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](state/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](strategy/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](template-method/python/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](visitor/python/example.html#example-0){.dp-pattern-link}
