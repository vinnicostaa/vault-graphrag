...
[Médiateur](../../mediator.html){.type} / [C#](../../csharp.html){.type}
:::
...
C# pour faciliter les communications entre les composants de l'interface
graphique d'une application. Le contrôleur du modèle MVC est le synonyme
du médiateur.
:::::::::::
