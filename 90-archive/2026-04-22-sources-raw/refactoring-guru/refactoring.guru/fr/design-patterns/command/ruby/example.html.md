...
[Commande](../../command.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Commande** en Ruby {#commande-en-ruby .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** La commande est très répandue en Ruby. Elle
