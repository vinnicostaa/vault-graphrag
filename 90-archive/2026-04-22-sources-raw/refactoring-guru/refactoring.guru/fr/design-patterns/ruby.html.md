...
# [Les patrons]{.dp1-h-1} [de]{.dp-h-article} [conception]{.dp1-h-2} [en]{.dp-lang-in} [Ruby]{.dp-lang} {#les-patrons-de-conception-en-ruby .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## Le catalogue des exemples en **Ruby** {#le-catalogue-des-exemples-en-ruby .dp-h2}
...
[ Exemple de
code](abstract-factory/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](builder/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](factory-method/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](prototype/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](adapter/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](bridge/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](composite/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](decorator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](facade/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](flyweight/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](proxy/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](chain-of-responsibility/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](command/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](iterator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](mediator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](memento/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](observer/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de code](state/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](strategy/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](template-method/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemple de
code](visitor/ruby/example.html#example-0){.dp-pattern-link}
