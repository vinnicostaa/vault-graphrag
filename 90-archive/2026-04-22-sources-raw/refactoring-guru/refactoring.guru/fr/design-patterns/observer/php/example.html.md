...
[Observateur](../../observer.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Observateur** en PHP {#observateur-en-php .pattern-example-title-block-title}
::::
...
**Exemples d'utilisation :** PHP possède des interfaces natives
([SplSubject](http://php.net/manual/en/class.splsubject.php),
[SplObserver](http://php.net/manual/en/class.splobserver.php)) qui
peuvent être utilisées pour rendre vos implémentations de l'observateur
compatibles avec le reste de votre code.
...
Dans cet exemple, l'**Observateur** permet à plusieurs objets de
surveiller les événements qui se produisent à l'intérieur du référentiel
utilisateur d'une application.

Ce référentiel émet différents types d'événements et permet aux
observateurs de rester à l'écoute d'un ou plusieurs événements.
...
[État en PHP []{.fa .fa-arrow-right}](../../state/php/example.html){.btn
