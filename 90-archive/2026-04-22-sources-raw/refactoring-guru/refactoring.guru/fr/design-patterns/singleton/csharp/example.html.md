...
[Vous en voulez plus ?](#example-2){#example-2-tab .nav-item .nav-link
...
#### []{#example-1--Program-cs .anchor} **Program.cs:** Exemple conceptuel
...
## Vous en voulez plus ? {#example-2-title}

Il y a plein d'autres variétés spéciales du singleton en C#. Jetez un
œil à cette article (en anglais) pour en découvrir d'autres :
...
toggle="tab" role="tab" aria-controls="example-1" aria-selected="true"}
[Vous en voulez plus ?](#example-2){#example-2-tab-bottom .nav-item
