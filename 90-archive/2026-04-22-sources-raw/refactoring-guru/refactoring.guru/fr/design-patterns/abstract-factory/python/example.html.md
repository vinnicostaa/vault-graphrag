...
# **Fabrique abstraite** en Python {#fabrique-abstraite-en-python .pattern-example-title-block-title}
::::
...
répandu en Python. Il est utilisé par de nombreux frameworks et
