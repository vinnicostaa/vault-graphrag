...
[Façade](../../facade.html){.type} / [PHP](../../php.html){.type}
:::
...
# **Façade** en PHP {#façade-en-php .pattern-example-title-block-title}
::::
...
les applications PHP. Ses classes simplifient l'utilisation de
bibliothèques complexes ou d'API.
...
Il faut voir la **Façade** comme un facilitateur pour les sous-systèmes
complexes. Elle isole la complexité dans une seule classe et permet au
code de l'application d'utiliser cette interface bien plus directe.

Dans cet exemple, la façade cache la complexité de l'API YouTube et de
la bibliothèque FFmpeg au code client. Plutôt que de travailler avec des
dizaines de classes, le client utilise une méthode simple de la façade.
