...
# **Patron de méthode** en TypeScript {#patron-de-méthode-en-typescript .pattern-example-title-block-title}
::::
...
TypeScript. Les développeurs l'emploient souvent pour fournir un
framework qui permet aux utilisateurs d'étendre des fonctionnalités
