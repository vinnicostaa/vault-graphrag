...
# **Patron de méthode** en Swift {#patron-de-méthode-en-swift .pattern-example-title-block-title}
::::
...
Swift. Les développeurs l'emploient souvent pour fournir un framework
