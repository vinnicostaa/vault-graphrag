...
[Monteur](../../builder.html){.type} / [Ruby](../../ruby.html){.type}
:::
...
# **Monteur** en Ruby {#monteur-en-ruby .pattern-example-title-block-title}
::::
...
Ruby. Il se montre très utile lorsque vous devez créer un objet
