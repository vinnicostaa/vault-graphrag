...
# **Monteur** en Python {#monteur-en-python .pattern-example-title-block-title}
::::
...
Python. Il se montre très utile lorsque vous devez créer un objet
