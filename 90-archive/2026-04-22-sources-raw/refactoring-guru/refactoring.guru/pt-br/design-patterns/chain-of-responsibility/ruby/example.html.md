...
# **Chain of Responsibility** em Ruby {#chain-of-responsibility-em-ruby .pattern-example-title-block-title}
::::
...
frequente em um programa Ruby, pois é relevante apenas quando o código
