...
# **Chain of Responsibility** em Python {#chain-of-responsibility-em-python .pattern-example-title-block-title}
::::
...
frequente em um programa Python, pois é relevante apenas quando o código
