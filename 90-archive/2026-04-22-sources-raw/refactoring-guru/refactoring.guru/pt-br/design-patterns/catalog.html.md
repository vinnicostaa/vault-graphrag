...
Estes padrões fornecem vários mecanismos de criação de objetos, que
aumentam a flexibilidade e reutilização de código já existente.
:::

::: creational-patterns
[[![Factory
Method](../../images/patterns/cards/factory-method-minid7f6.png?id=72619e9527893374b98a5913779ac167){srcset="/images/patterns/cards/factory-method-mini-2x.png?id=fa9d4a8d61a67cc3822e52b9daf69dad 2x,/images/patterns/cards/factory-method-mini-3x.png 3x"}]{.pattern-image}
[Factory Method]{.pattern-name}](factory-method.html){.pattern-card
.factory-method} [[![Abstract
Factory](../../images/patterns/cards/abstract-factory-minid1c5.png?id=4c3927c446313a38ce77dfee38111e27){srcset="/images/patterns/cards/abstract-factory-mini-2x.png?id=22236aaa65ff52cbde1c713216d52c1f 2x,/images/patterns/cards/abstract-factory-mini-3x.png 3x"}]{.pattern-image}
[Abstract Factory]{.pattern-name}](abstract-factory.html){.pattern-card
.abstract-factory}
[[![Builder](../../images/patterns/cards/builder-mini6d24.png?id=19b95fd05e6469679752c0554b116815){srcset="/images/patterns/cards/builder-mini-2x.png?id=de6d0938678b86903a1426dddfdd13bf 2x,/images/patterns/cards/builder-mini-3x.png 3x"}]{.pattern-image}
[Builder]{.pattern-name}](builder.html){.pattern-card .builder}
[[![Prototype](../../images/patterns/cards/prototype-mini6540.png?id=bc3046bb39ff36574c08d49839fd1c8e){srcset="/images/patterns/cards/prototype-mini-2x.png?id=b871f789a736e7efbb1cd082d2de6398 2x,/images/patterns/cards/prototype-mini-3x.png 3x"}]{.pattern-image}
[Prototype]{.pattern-name}](prototype.html){.pattern-card .prototype}
[[![Singleton](../../images/patterns/cards/singleton-minif559.png?id=914e1565dfdf15f240e766163bd303ec){srcset="/images/patterns/cards/singleton-mini-2x.png?id=4a7348083d7719d02709a5c9ff878b9f 2x,/images/patterns/cards/singleton-mini-3x.png 3x"}]{.pattern-image}
[Singleton]{.pattern-name}](singleton.html){.pattern-card .singleton}
:::

::: structural-patterns-header
### Padrões estruturais

Estes padrões explicam como montar objetos e classes em estruturas
maiores mas ainda mantendo essas estruturas flexíveis e eficientes.
:::
...
[Adapter]{.pattern-name}](adapter.html){.pattern-card .adapter}
...
[Bridge]{.pattern-name}](bridge.html){.pattern-card .bridge}
...
[Composite]{.pattern-name}](composite.html){.pattern-card .composite}
...
[Decorator]{.pattern-name}](decorator.html){.pattern-card .decorator}
...
[Facade]{.pattern-name}](facade.html){.pattern-card .facade}
...
[Flyweight]{.pattern-name}](flyweight.html){.pattern-card .flyweight}
...
[Proxy]{.pattern-name}](proxy.html){.pattern-card .proxy}
:::

::: behavioral-patterns-header
### Padrões comportamentais

Estes padrões são voltados aos algoritmos e a designação de
...
[Chain of
Responsibility]{.pattern-name}](chain-of-responsibility.html){.pattern-card
...
[Command]{.pattern-name}](command.html){.pattern-card .command}
...
[Iterator]{.pattern-name}](iterator.html){.pattern-card .iterator}
...
[Mediator]{.pattern-name}](mediator.html){.pattern-card .mediator}
...
[Memento]{.pattern-name}](memento.html){.pattern-card .memento}
...
[Observer]{.pattern-name}](observer.html){.pattern-card .observer}
...
[State]{.pattern-name}](state.html){.pattern-card .state}
...
[Strategy]{.pattern-name}](strategy.html){.pattern-card .strategy}
[[![Template
...
[Template Method]{.pattern-name}](template-method.html){.pattern-card
.template-method}
...
[Visitor]{.pattern-name}](visitor.html){.pattern-card .visitor}
:::
:::::::::
::::::::::
:::::::::::
