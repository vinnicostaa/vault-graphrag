...
# **Visitor** em Java {#visitor-em-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Exportando formas para XML](#example-0)
:::
...
## Exportando formas para XML {#example-0-title}

Neste exemplo, gostaríamos de exportar um conjunto de formas geométricas
para XML. O problema é que não queremos alterar o código de formas,
diretamente ou, pelo menos, manter as alterações ao mínimo.

No final, o padrão Visitor estabelece uma infraestrutura que nos permite
adicionar comportamentos à hierarquia de formas sem alterar o código
existente dessas classes.
...
#### []{#example-0--shapes-Dot-java .anchor} **shapes/Dot.java:** Um ponto
...
#### []{#example-0--shapes-Circle-java .anchor} **shapes/Circle.java:** Um círculo
...
#### []{#example-0--shapes-Rectangle-java .anchor} **shapes/Rectangle.java:** Um retângulo
...
#### []{#example-0--shapes-CompoundShape-java .anchor} **shapes/CompoundShape.java:** Uma forma composta
...
#### []{#example-0--visitor-Visitor-java .anchor} **visitor/Visitor.java:** Interface comum visitante
...
#### []{#example-0--visitor-XMLExportVisitor-java .anchor} **visitor/XMLExportVisitor.java:** Visitante concreto, exporta todas as formas em XML
...
[Padrões de Projeto em PHP []{.fa .fa-arrow-right}](../../php.html){.btn
