...
# **Composite** em Swift {#composite-em-swift .pattern-example-title-block-title}
::::
...
Swift. É frequentemente usado para representar hierarquias de
