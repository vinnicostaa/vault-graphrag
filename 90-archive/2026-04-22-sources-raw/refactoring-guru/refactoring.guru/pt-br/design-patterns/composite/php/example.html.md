...
# **Composite** em PHP {#composite-em-php .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Composite é comumente usado ao trabalhar
com árvores de objetos. O exemplo mais simples seria aplicar o padrão
aos elementos da árvore DOM, trabalhando com os elementos simples e
compostos da árvore da mesma maneira.
...
O padrão **Composite** pode otimizar o trabalho com qualquer estrutura
recursiva semelhante a uma árvore. A árvore DOM HTML é um exemplo dessa
estrutura. Por exemplo, enquanto os vários elementos de entrada podem
atuar como folhas, os elementos complexos, como formas e conjuntos de
campos, desempenham o papel de composites.

Tendo isso em mente, é possível usar o padrão Composite para aplicar
vários comportamentos a toda a árvore HTML da mesma maneira que a seus
elementos internos, sem acoplar seu código a classes concretas da árvore
DOM. Exemplos de tais comportamentos podem ser renderizar os elementos
DOM, exportá-los para vários formatos, validar suas partes etc.

Com o padrão Composite você não precisa verificar se o tipo de elemento
é simples ou complexo antes de executar o comportamento. Dependendo do
tipo do elemento, ele é executado imediatamente ou passado para todos os
filhos do elemento.
