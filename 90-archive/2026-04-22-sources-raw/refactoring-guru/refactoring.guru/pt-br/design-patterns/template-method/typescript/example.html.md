...
# **Template Method** em TypeScript {#template-method-em-typescript .pattern-example-title-block-title}
::::
...
frameworks TypeScript. Os desenvolvedores costumam usá-lo para fornecer
aos usuários do framework um meio simples de estender a funcionalidade
