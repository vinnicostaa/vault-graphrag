...
# **Facade** em PHP {#facade-em-php .pattern-example-title-block-title}
::::
...
PHP, onde as classes facade simplificam o trabalho com bibliotecas ou
APIs complexas.
...
Pense no **Facade** como um adaptador de simplicidade para algum
subsistema complexo. O Facade isola a complexidade em uma única classe e
permite que outro código da aplicação use a interface direta.

Neste exemplo, o Facade oculta a complexidade da API do YouTube e da
biblioteca FFmpeg do código cliente. Em vez de trabalhar com dezenas de
classes, o cliente usa um método simples na fachada.
