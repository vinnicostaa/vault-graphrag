...
# **Facade** em TypeScript {#facade-em-typescript .pattern-example-title-block-title}
::::
...
escritas em TypeScript. É especialmente útil ao trabalhar com
bibliotecas e APIs complexas.
