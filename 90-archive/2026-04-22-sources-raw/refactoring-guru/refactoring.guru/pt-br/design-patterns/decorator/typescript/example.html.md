...
# **Decorator** em TypeScript {#decorator-em-typescript .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O Decorator é bastante padrão no código TypeScript,
