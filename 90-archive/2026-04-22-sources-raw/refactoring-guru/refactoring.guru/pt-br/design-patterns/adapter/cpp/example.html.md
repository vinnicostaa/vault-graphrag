...
aria-selected="true"} [Herança múltipla](#example-1){#example-1-tab
...
## Herança múltipla {#example-1-title}

Em C ++, o padrão **Adapter** pode ser implementado usando herança
múltipla.

#### []{#example-1--main-cc .anchor} **main.cc:** Herança múltipla
...
aria-selected="true"} [Herança
múltipla](#example-1){#example-1-tab-bottom .nav-item .nav-link
