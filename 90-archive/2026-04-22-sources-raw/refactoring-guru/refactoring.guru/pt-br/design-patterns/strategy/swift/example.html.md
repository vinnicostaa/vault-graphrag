...
# **Strategy** em Swift {#strategy-em-swift .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Strategy é muito comum no código Swift. É
