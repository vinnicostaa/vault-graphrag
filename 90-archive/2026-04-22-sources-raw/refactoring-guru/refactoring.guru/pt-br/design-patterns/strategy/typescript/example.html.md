...
# **Strategy** em TypeScript {#strategy-em-typescript .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Strategy é muito comum no código
TypeScript. É frequentemente usado em várias estruturas para fornecer
aos usuários uma maneira de alterar o comportamento de uma classe sem
estendê-la.
...
[Template Method em TypeScript []{.fa
