...
# **Strategy** em PHP {#strategy-em-php .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Strategy é frequentemente usado no código
PHP, especialmente quando é necessário alternar algoritmos em tempo de
execução. No entanto, o padrão possui um forte concorrente representado
por funções anônimas, suportado no PHP desde 2009.
...
Neste exemplo, o padrão **Strategy** é usado para representar os vários
métodos de pagamento em uma aplicação de e-commerce.

Cada forma de pagamento pode exibir um formulário de pagamento para
coletar detalhes de pagamento de um usuário e enviá-lo à empresa de
processamento de pagamentos. Após a empresa de processamento de
pagamentos redirecionar o usuário ao nosso site, o método de pagamento
valida os parâmetros retornados e ajuda a decidir se o pedido foi
concluído.
...
[[]{.fa .fa-arrow-left} State em PHP](../../state/php/example.html){.btn
