...
# [Padrões]{.dp1-h-1} [de]{.dp-h-article} [Projeto]{.dp1-h-2} [em]{.dp-lang-in} [C[\#]{.dp-lang2}]{.dp-lang} {#padrões-de-projeto-em-c .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## O catálogo dos exemplos **C#** {#o-catálogo-dos-exemplos-c .dp-h2}
...
[ Exemplo de
código](abstract-factory/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](builder/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](factory-method/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](prototype/csharp/example.html#example-0){.dp-pattern-link}
...
[ Singleton
ingênuo](singleton/csharp/example.html#example-0){.dp-pattern-link}
...
threads](singleton/csharp/example.html#example-1){.dp-pattern-link}
...
[ Exemplo de
código](adapter/csharp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C#](bridge/csharp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](bridge/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](composite/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](decorator/csharp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C#](facade/csharp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](facade/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](flyweight/csharp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C#](proxy/csharp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](proxy/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](chain-of-responsibility/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](command/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](iterator/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](mediator/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](memento/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](observer/csharp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C#](state/csharp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](state/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](strategy/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](template-method/csharp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](visitor/csharp/example.html#example-0){.dp-pattern-link}
