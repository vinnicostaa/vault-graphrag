...
# **Observer** em PHP {#observer-em-php .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O PHP possui várias interfaces internas
([SplSubject](http://php.net/manual/en/class.splsubject.php),
[SplObserver](http://php.net/manual/en/class.splobserver.php)) que podem
ser usadas para tornar suas implementações do padrão Observer
compatíveis com o restante do código PHP.
...
Neste exemplo, o padrão **Observer** permite que vários objetos observem
eventos que estão acontecendo dentro de um repositório do usuário de uma
aplicação.

O repositório emite vários tipos de eventos e permite que os
observadores escutem todos eles, bem como apenas os individuais.
