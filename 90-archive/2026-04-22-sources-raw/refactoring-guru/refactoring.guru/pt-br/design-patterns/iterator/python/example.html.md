...
# **Iterator** em Python {#iterator-em-python .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão é muito comum no código Python. Muitos
