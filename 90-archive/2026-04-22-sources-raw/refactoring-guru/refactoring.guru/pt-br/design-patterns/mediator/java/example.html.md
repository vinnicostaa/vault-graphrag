...
# **Mediator** em Java {#mediator-em-java .pattern-example-title-block-title}
::::
...
Java é facilitar a comunicação entre os componentes interface do usuário
...
## Aplicação de notas {#example-0-title}

Este exemplo mostra como organizar muitos elementos da interface de
usuário para que eles cooperem com a ajuda de um mediador, mas não
dependam um do outro.

### []{#example-0--components .anchor} **components:** Classes Colegas {#components-classes-colegas .example-title}
...
#### []{#example-0--mediator-Mediator-java .anchor} **mediator/Mediator.java:** Define a interface comum do mediador
...
#### []{#example-0--mediator-Editor-java .anchor} **mediator/Editor.java:** Mediador concreto
...
#### []{#example-0--mediator-Note-java .anchor} **mediator/Note.java:** Uma anotação de classe
