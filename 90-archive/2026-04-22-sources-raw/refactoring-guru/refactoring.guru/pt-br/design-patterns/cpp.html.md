...
# [Padrões]{.dp1-h-1} [de]{.dp-h-article} [Projeto]{.dp1-h-2} [em]{.dp-lang-in} [C++]{.dp-lang} {#padrões-de-projeto-em-c .dp1-h .dp-abs .dp-c .dp-h1}
::::
...
[ Exemplo de
código](abstract-factory/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](builder/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](builder/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](factory-method/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](prototype/cpp/example.html#example-0){.dp-pattern-link}
...
[ Singleton
ingênuo](singleton/cpp/example.html#example-0){.dp-pattern-link}
...
threads](singleton/cpp/example.html#example-1){.dp-pattern-link}
...
[ Uso em C++](adapter/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo
conceitual](adapter/cpp/example.html#example-0){.dp-pattern-link}
...
[ Herança
múltipla](adapter/cpp/example.html#example-1){.dp-pattern-link}
...
[ Uso em C++](bridge/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](bridge/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](composite/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](decorator/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](facade/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](facade/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](flyweight/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](proxy/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ Exemplo de código](proxy/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](chain-of-responsibility/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](command/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](command/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](iterator/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](iterator/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](mediator/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](mediator/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](memento/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](memento/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](observer/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](observer/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](state/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ Exemplo de código](state/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](strategy/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](strategy/cpp/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](template-method/cpp/example.html#example-0){.dp-pattern-link}
...
[ Uso em C++](visitor/cpp/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](visitor/cpp/example.html#example-0){.dp-pattern-link}
