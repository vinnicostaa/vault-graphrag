...
# **Proxy** em Python {#proxy-em-python .pattern-example-title-block-title}
::::
...
frequente na maioria das aplicações Python, ele ainda é muito útil em
...
[Chain of Responsibility em Python []{.fa
