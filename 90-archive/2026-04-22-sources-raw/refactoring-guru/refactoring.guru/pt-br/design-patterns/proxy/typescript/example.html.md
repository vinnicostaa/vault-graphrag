...
# **Proxy** em TypeScript {#proxy-em-typescript .pattern-example-title-block-title}
::::
...
frequente na maioria das aplicações TypeScript, ele ainda é muito útil
em alguns casos especiais. É insubstituível quando você deseja adicionar
...
[Chain of Responsibility em TypeScript []{.fa
