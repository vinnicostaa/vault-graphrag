...
# **Factory Method** em TypeScript {#factory-method-em-typescript .pattern-example-title-block-title}
::::
...
código TypeScript. É muito útil quando você precisa fornecer um alto
nível de flexibilidade para seu código.
