...
# **Factory Method** em Python {#factory-method-em-python .pattern-example-title-block-title}
::::
...
código Python. É muito útil quando você precisa fornecer um alto nível
de flexibilidade para seu código.
