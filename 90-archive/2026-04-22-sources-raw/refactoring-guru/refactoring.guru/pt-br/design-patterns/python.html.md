...
# [Padrões]{.dp1-h-1} [de]{.dp-h-article} [Projeto]{.dp1-h-2} [em]{.dp-lang-in} [Python]{.dp-lang} {#padrões-de-projeto-em-python .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## O catálogo dos exemplos **Python** {#o-catálogo-dos-exemplos-python .dp-h2}
...
[ Exemplo de
código](abstract-factory/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](builder/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](factory-method/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](prototype/python/example.html#example-0){.dp-pattern-link}
...
[ Singleton
ingênuo](singleton/python/example.html#example-0){.dp-pattern-link}
...
threads](singleton/python/example.html#example-1){.dp-pattern-link}
...
[ Exemplo de
código](adapter/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](bridge/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](composite/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](decorator/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](facade/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](flyweight/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](proxy/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](chain-of-responsibility/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](command/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](iterator/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](mediator/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](memento/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](observer/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](state/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](strategy/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](template-method/python/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](visitor/python/example.html#example-0){.dp-pattern-link}
