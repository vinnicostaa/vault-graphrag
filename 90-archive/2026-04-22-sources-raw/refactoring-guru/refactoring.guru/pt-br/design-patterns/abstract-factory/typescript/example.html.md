...
# **Abstract Factory** em TypeScript {#abstract-factory-em-typescript .pattern-example-title-block-title}
::::
...
código TypeScript. Muitas frameworks e bibliotecas o utilizam para
fornecer uma maneira de estender e personalizar seus componentes padrão.
