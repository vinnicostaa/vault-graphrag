...
# **Command** em Swift {#command-em-swift .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Command é bastante comum no código Swift.
