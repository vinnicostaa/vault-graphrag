...
# **Command** em TypeScript {#command-em-typescript .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Command é bastante comum no código
TypeScript. Na maioria das vezes, é usado como uma alternativa para
retornos de chamada para parametrizar elementos da interface do usuário
com ações. Também é usado para tarefas de enfileiramento, rastreamento
de histórico de operações, etc.
