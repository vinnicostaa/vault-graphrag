...
# **Command** em PHP {#command-em-php .pattern-example-title-block-title}
::::
...
**Exemplos de uso:** O padrão Command é bastante comum no código PHP. É
usado para enfileirar tarefas, rastrear o histórico de tarefas
executadas e executar o "desfazer".
...
Neste exemplo, o padrão **Command** é usado para enfileirar chamadas de
web scraping no site do IMDB e executá-las uma a uma. A fila em si é
mantida em um banco de dados que ajuda a preservar comandos entre
ativações de script.
