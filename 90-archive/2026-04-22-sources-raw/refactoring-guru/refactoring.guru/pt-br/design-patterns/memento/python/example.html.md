...
# **Memento** em Python {#memento-em-python .pattern-example-title-block-title}
::::
...
serialização, o que é bastante comum em Python. Embora não seja a única
e a maneira mais eficiente de tirar retratos do estado de um objeto,
ainda permite armazenar backups de estado, protegendo a estrutura do
