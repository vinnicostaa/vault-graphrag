...
# **Memento** em Swift {#memento-em-swift .pattern-example-title-block-title}
::::
...
serialização, o que é bastante comum em Swift. Embora não seja a única e
