...
# [Padrões]{.dp1-h-1} [de]{.dp-h-article} [Projeto]{.dp1-h-2} [em]{.dp-lang-in} [Java]{.dp-lang} {#padrões-de-projeto-em-java .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## O catálogo dos exemplos **Java** {#o-catálogo-dos-exemplos-java .dp-h2}
...
[ Exemplo de
código](abstract-factory/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](builder/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](factory-method/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](prototype/java/example.html#example-0){.dp-pattern-link}
...
[ Singleton
ingênuo](singleton/java/example.html#example-0){.dp-pattern-link}
...
threads](singleton/java/example.html#example-2){.dp-pattern-link}
...
[ Exemplo de
código](adapter/java/example.html#example-0){.dp-pattern-link}
...
[ Uso em Java](bridge/java/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](bridge/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](composite/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](decorator/java/example.html#example-0){.dp-pattern-link}
...
[ Uso em Java](facade/java/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](facade/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](flyweight/java/example.html#example-0){.dp-pattern-link}
...
[ Uso em Java](proxy/java/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](proxy/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](chain-of-responsibility/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](command/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](iterator/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](mediator/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](memento/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](observer/java/example.html#example-0){.dp-pattern-link}
...
[ Uso em Java](state/java/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](state/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](strategy/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](template-method/java/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](visitor/java/example.html#example-0){.dp-pattern-link}
