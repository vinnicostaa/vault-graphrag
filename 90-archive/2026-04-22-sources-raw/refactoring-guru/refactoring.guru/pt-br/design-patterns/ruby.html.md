...
# [Padrões]{.dp1-h-1} [de]{.dp-h-article} [Projeto]{.dp1-h-2} [em]{.dp-lang-in} [Ruby]{.dp-lang} {#padrões-de-projeto-em-ruby .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## O catálogo dos exemplos **Ruby** {#o-catálogo-dos-exemplos-ruby .dp-h2}
...
[ Exemplo de
código](abstract-factory/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](builder/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](factory-method/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](prototype/ruby/example.html#example-0){.dp-pattern-link}
...
[ Singleton
ingênuo](singleton/ruby/example.html#example-0){.dp-pattern-link}
...
threads](singleton/ruby/example.html#example-1){.dp-pattern-link}
...
[ Exemplo de
código](adapter/ruby/example.html#example-0){.dp-pattern-link}
...
[ Uso em Ruby](bridge/ruby/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](bridge/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](composite/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](decorator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Uso em Ruby](facade/ruby/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](facade/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](flyweight/ruby/example.html#example-0){.dp-pattern-link}
...
[ Uso em Ruby](proxy/ruby/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](proxy/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](chain-of-responsibility/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](command/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](iterator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](mediator/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](memento/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](observer/ruby/example.html#example-0){.dp-pattern-link}
...
[ Uso em Ruby](state/ruby/example.html#lang-features){.dp-pattern-link}
...
[ Exemplo de
código](state/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](strategy/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](template-method/ruby/example.html#example-0){.dp-pattern-link}
...
[ Exemplo de
código](visitor/ruby/example.html#example-0){.dp-pattern-link}
