...
# [Padrões]{.dp1-h-1} [de]{.dp-h-article} [Projeto]{.dp1-h-2} [em]{.dp-lang-in} [Swift]{.dp-lang} {#padrões-de-projeto-em-swift .dp1-h .dp-abs .dp-c .dp-h1}
::::

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## O catálogo dos exemplos **Swift** {#o-catálogo-dos-exemplos-swift .dp-h2}

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-double-cols
#### Padrões criacionais {#padrões-criacionais .dp-h4 .dp-creational-title}
...
::: dp-pattern-intent
Permite que você produza famílias de objetos relacionados sem ter que
...
[ Artigo principal](abstract-factory.html){.dp-pattern-link}
...
[ Exemplo
conceitual](abstract-factory/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](abstract-factory/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite construir objetos complexos passo a passo. O padrão permite
...
[ Artigo principal](builder.html){.dp-pattern-link}
...
[ Exemplo
conceitual](builder/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](builder/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Fornece uma interface para criar objetos em uma superclasse, mas permite
...
[ Artigo principal](factory-method.html){.dp-pattern-link}
...
[ Exemplo
conceitual](factory-method/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](factory-method/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite que você copie objetos existentes sem fazer seu código ficar
...
[ Artigo principal](prototype.html){.dp-pattern-link}
...
[ Exemplo
conceitual](prototype/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](prototype/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite a você garantir que uma classe tem apenas uma instância,
enquanto provê um ponto de acesso global para esta instância.
:::

::::::: dp-pattern-links
<div>

[ Artigo principal](singleton.html){.dp-pattern-link}
...
[ Exemplo
conceitual](singleton/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](singleton/swift/example.html#example-1){.dp-pattern-link}

</div>
:::::::
::::::::::

#### Padrões estruturais {#padrões-estruturais .dp-h4 .dp-structural-title}
...
[ Artigo principal](adapter.html){.dp-pattern-link}
...
[ Exemplo
conceitual](adapter/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](adapter/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite que você divida uma classe grande ou um conjunto de classes
intimamente ligadas em duas hierarquias separadas---abstração e
implementação---que podem ser desenvolvidas independentemente umas das
outras.
:::
...
[ Artigo principal](bridge.html){.dp-pattern-link}
...
[ Exemplo
conceitual](bridge/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](bridge/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite que você componha objetos em estrutura de árvores e então
trabalhe com essas estruturas como se fossem objetos individuais.
:::

::::::: dp-pattern-links
<div>

[ Artigo principal](composite.html){.dp-pattern-link}
...
[ Exemplo
conceitual](composite/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](composite/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite que você adicione novos comportamentos a objetos colocando eles
dentro de um envoltório (wrapper) de objetos que contém os
comportamentos.
:::
...
[ Artigo principal](decorator.html){.dp-pattern-link}
...
[ Exemplo
conceitual](decorator/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](decorator/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Fornece uma interface simplificada para uma biblioteca, um framework, ou
qualquer outro conjunto complexo de classes.
:::

::::::: dp-pattern-links
<div>

[ Artigo principal](facade.html){.dp-pattern-link}
...
[ Exemplo
conceitual](facade/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](facade/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite que você coloque mais objetos na quantidade disponível de RAM ao
compartilhar partes do estado entre múltiplos objetos ao invés de manter
...
[ Artigo principal](flyweight.html){.dp-pattern-link}
...
[ Exemplo
conceitual](flyweight/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](flyweight/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
Permite que você forneça um substituto ou um espaço reservado para outro
objeto. Um proxy controla o acesso ao objeto original, permitindo que
você faça algo ou antes ou depois do pedido chegar ao objeto original.
:::

::::::: dp-pattern-links
<div>

[ Artigo principal](proxy.html){.dp-pattern-link}
...
[ Exemplo
conceitual](proxy/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](proxy/swift/example.html#example-1){.dp-pattern-link}
...
#### Padrões comportamentais {#padrões-comportamentais .dp-h4 .dp-behavioral-title}
...
[ Artigo principal](chain-of-responsibility.html){.dp-pattern-link}
...
[ Exemplo
conceitual](chain-of-responsibility/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](chain-of-responsibility/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](command.html){.dp-pattern-link}
...
[ Exemplo
conceitual](command/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](command/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](iterator.html){.dp-pattern-link}
...
[ Exemplo
conceitual](iterator/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](iterator/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](mediator.html){.dp-pattern-link}
...
[ Exemplo
conceitual](mediator/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](mediator/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](memento.html){.dp-pattern-link}
...
[ Exemplo
conceitual](memento/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](memento/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](observer.html){.dp-pattern-link}
...
[ Exemplo
conceitual](observer/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](observer/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](state.html){.dp-pattern-link}
...
[ Exemplo
conceitual](state/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](state/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](strategy.html){.dp-pattern-link}
...
[ Exemplo
conceitual](strategy/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](strategy/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](template-method.html){.dp-pattern-link}
...
[ Exemplo
conceitual](template-method/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](template-method/swift/example.html#example-1){.dp-pattern-link}
...
[ Artigo principal](visitor.html){.dp-pattern-link}
...
[ Exemplo
conceitual](visitor/swift/example.html#example-0){.dp-pattern-link}
...
[ Exemplo do mundo
real](visitor/swift/example.html#example-1){.dp-pattern-link}
