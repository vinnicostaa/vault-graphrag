...
# **Builder** em Python {#builder-em-python .pattern-example-title-block-title}
::::
...
Python. É especialmente útil quando você precisa criar um objeto com
