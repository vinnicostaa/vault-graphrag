...
# **Builder** em C++ {#builder-em-c .pattern-example-title-block-title}
::::
...
C++. É especialmente útil quando você precisa criar um objeto com muitas
