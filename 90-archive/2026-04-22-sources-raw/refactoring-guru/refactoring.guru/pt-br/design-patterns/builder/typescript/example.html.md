...
# **Builder** em TypeScript {#builder-em-typescript .pattern-example-title-block-title}
::::
...
TypeScript. É especialmente útil quando você precisa criar um objeto com
...
[Factory Method em TypeScript []{.fa
