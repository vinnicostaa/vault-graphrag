...
::: {.page .text}
# Terms and Conditions {#terms-and-conditions .title}

Last updated: April 19, 2019

These Terms and Conditions ("Terms", "Terms and Conditions") govern your
relationship with https://refactoring.guru website (the "Service")
operated by Refactoring.Guru ("us", "we", or "our").
...
Rights to all purchased ebooks are governed by the [eBook
license](../ebook-license.html).
...
to respond to any claim that Content posted on the Service infringes the
copyright or other intellectual property infringement ("Infringement")
of any person.
...
"Copyright Infringement" of dmca@refactoring.guru and include in your
...
are not owned or controlled by Refactoring.Guru.

Refactoring.Guru has no control over, and assumes no responsibility for,
the content, privacy policies, or practices of any third party web sites
or services. You further acknowledge and agree that Refactoring.Guru
...
In no event shall Refactoring.Guru, nor its directors, employees,
...
Refactoring.Guru, its subsidiaries, affiliates, and its licensors do not
