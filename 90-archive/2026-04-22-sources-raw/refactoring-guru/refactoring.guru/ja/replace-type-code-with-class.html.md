...
aren\'t used in operator conditions and don\'t affect the behavior of
the program.
:::
...
-   Thus we make it possible to move code to the classes of the type. If
    ...
    throughout the whole program, now this code can \"live\" inside one
    or multiple type classes.
...
3.  For each value of the coded type, create a static method in *type
    class*. It\'ll be creating a new *type class* object corresponding
    to this value of the coded type.
