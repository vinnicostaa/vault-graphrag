...
# **Prototype** を Go で {#prototype-を-go-で .pattern-example-title-block-title}
::::
...
オペレーティング・システムのファイル・システムに基づいた例を使い[、]{.chpule2}[
]{.chpuri2}Prototype パターンを調べてみましょう[。]{.chpule2}[
]{.chpuri2}OS のファイル・システムは再帰的です[：]{.chpule2}[
]{.chpuri2}フォルダーにはファイルとフォルダーが含まれており[、]{.chpule2}[
]{.chpuri2}そのフォルダーには[、]{.chpule2}[
]{.chpuri2}ファイルとフォルダーも含まれている[、]{.chpule2}[
]{.chpuri2}といった具合です[。]{.chpule2}[ ]{.chpuri2}

個々のファイルおよびフォルダーは[、]{.chpule2}[ ]{.chpuri2}`inode`
インターフェースで表現されます[。]{.chpule2}[ ]{.chpuri2}`inode`
インターフェースには[、]{.chpule2}[ ]{.chpuri2}`clone`
関数があります[。]{.chpule2}[ ]{.chpuri2}

`file` 構造体と `folder` 構造体の両方とも[、]{.chpule2}[
]{.chpuri2}`inode` 型をしているので[、]{.chpule2}[ ]{.chpuri2}`print`
関数と `clone` 関数を実装します[。]{.chpule2}[ ]{.chpuri2}`file` と
`folder` の両方に `clone`
関数があることにも注目してください[。]{.chpule2}[
]{.chpuri2}両方に含まれる `clone` 関数は[、]{.chpule2}[
]{.chpuri2}それぞれファイルかフォルダーのコピーを返します[。]{.chpule2}[
]{.chpuri2}クローン作成にあたり[[、]{.ls-1}]{.chpule2}[ ]{.chpuri2}​[
]{.chpule1}[「]{.chpuri1}name[」]{.chpule2}[
]{.chpuri2}フィールドに[[、]{.ls-1}]{.chpule2}[ ]{.chpuri2}​[
]{.chpule1}[「]{.chpuri1}\_clone[」]{.chpule2}[
]{.chpuri2}という接尾語を付け足しています[。]{.chpule2}[ ]{.chpuri2}

#### []{#example-0--inode-go .anchor} **inode.go:** プロトタイプ・インターフェース
...
#### []{#example-0--file-go .anchor} **file.go:** 具象プロトタイプ
...
#### []{#example-0--folder-go .anchor} **folder.go:** 具象プロトタイプ
...
[[]{.fa .fa-arrow-left} Factory Method を Go
で](../../factory-method/go/example.html){.btn .btn-default rel="prev"}
:::
