...
[Builder](../../builder.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Builder** を Rust で {#builder-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Abstract Factory を Rust
で](../../abstract-factory/rust/example.html){.btn .btn-default
rel="prev"}
:::
