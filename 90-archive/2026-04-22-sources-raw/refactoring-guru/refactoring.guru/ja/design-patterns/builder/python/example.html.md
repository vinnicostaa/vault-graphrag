...
# **Builder** を Python で {#builder-を-python-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Builder パターンは Python
の世界では[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Abstract Factory を Python
で](../../abstract-factory/python/example.html){.btn .btn-default
rel="prev"}
:::
