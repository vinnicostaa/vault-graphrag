...
# **Builder** を Swift で {#builder-を-swift-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Builder パターンは Swift
の世界では[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Abstract Factory を Swift
で](../../abstract-factory/swift/example.html){.btn .btn-default
rel="prev"}
:::
