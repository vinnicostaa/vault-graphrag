...
# **Builder** を PHP で {#builder-を-php-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Builder パターンは PHP
の世界では[、]{.chpule2}[
...
**Builder** パターンの最適な用途の一つとして[、]{.chpule2}[
]{.chpuri2}SQL のクエリ・ビルダーがあげられます[。]{.chpule2}[
]{.chpuri2}ビルダー・インターフェースは[、]{.chpule2}[
]{.chpuri2}一般的な SQL
クエリを作成するために必要な一般的なステップを定義します[。]{.chpule2}[
]{.chpuri2}一方[、]{.chpule2}[ ]{.chpuri2}具象ビルダーは[、]{.chpule2}[
]{.chpuri2}異なる SQL の方言に対応します[。]{.chpule2}[
]{.chpuri2}各ステップを[、]{.chpule2}[
]{.chpuri2}特定のデータベース・エンジンで実行可能な SQL
クエリの断片を返すように実装します[。]{.chpule2}[ ]{.chpuri2}
...
[[]{.fa .fa-arrow-left} Abstract Factory を PHP
で](../../abstract-factory/php/example.html){.btn .btn-default
rel="prev"}
:::
