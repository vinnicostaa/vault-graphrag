...
# **Builder** を Java で {#builder-を-java-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Builder パターンは Java
の世界では[、]{.chpule2}[
]{.chpuri2}よく知られているパターンです[。]{.chpule2}[
]{.chpuri2}多くの設定オプションを持つオブジェクトを作成する必要がある場合に特に便利です[。]{.chpule2}[
]{.chpuri2}

Builder は[、]{.chpule2}[ ]{.chpuri2}Java
のコア・ライブラリーで広く使われています[：]{.chpule2}[ ]{.chpuri2}
...
-   [`java.lang.StringBuffer#append()`](http://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#append-boolean-)[
    ]{.chpule1}[（]{.chpuri1}`同期`[）]{.chpule2}[ ]{.chpuri2}
-   [`java.nio.ByteBuffer#put()`](http://docs.oracle.com/javase/8/docs/api/java/nio/ByteBuffer.html#put-byte-)[
    ]{.chpule1}[（]{.chpuri1}以下も[：]{.chpule2}[
    ]{.chpuri2}[`Char­Buffer`](http://docs.oracle.com/javase/8/docs/api/java/nio/CharBuffer.html#put-char-)[、]{.chpule2}[
    ]{.chpuri2}[`Short­Buffer`](http://docs.oracle.com/javase/8/docs/api/java/nio/ShortBuffer.html#put-short-)[、]{.chpule2}[
    ]{.chpuri2}[`Int­Buffer`](http://docs.oracle.com/javase/8/docs/api/java/nio/IntBuffer.html#put-int-)[、]{.chpule2}[
    ]{.chpuri2}[`Long­Buffer`](http://docs.oracle.com/javase/8/docs/api/java/nio/LongBuffer.html#put-long-)[、]{.chpule2}[
    ]{.chpuri2}[`Float­Buffer`](http://docs.oracle.com/javase/8/docs/api/java/nio/FloatBuffer.html#put-float-)
    [、]{.chpule2}[ ]{.chpuri2}
    [`Double­Buffer`](http://docs.oracle.com/javase/8/docs/api/java/nio/DoubleBuffer.html#put-double-)[）]{.chpule2}[
    ]{.chpuri2}
...
## 段階的な車の生産 {#example-0-title}

この例では[、]{.chpule2}[ ]{.chpuri2}Builder
パターンを使って[、]{.chpule2}[
]{.chpuri2}異なる自動車のモデルを段階的に構築します[。]{.chpule2}[
]{.chpuri2}

この例ではまた[、]{.chpule2}[ ]{.chpuri2}Builder
が同じ構築段階を使って違う種類のプロダクト[
]{.chpule1}[（]{.chpuri1}車のマニュアル[）]{.chpule2}[
]{.chpuri2}を作る方法も紹介します[。]{.chpule2}[ ]{.chpuri2}

ディレクターは[、]{.chpule2}[
]{.chpuri2}構築の順番を管理します[。]{.chpule2}[
]{.chpuri2}特定のモデルを生産するためにはどの構築ステップを呼ぶべきかを知っています[。]{.chpule2}[
]{.chpuri2}ビルダーとは共通のインターフェースのみを介して仕事をします[。]{.chpule2}[
]{.chpuri2}このため[、]{.chpule2}[
]{.chpuri2}型の異なるビルダーをディレクターに渡すことが可能となります[。]{.chpule2}[
]{.chpuri2}

最終的な結果としてのプロダクトは[、]{.chpule2}[
]{.chpuri2}クライントがビルダー・オブジェクトから直接取得します[。]{.chpule2}[
]{.chpuri2}ディレクターは[、]{.chpule2}[
]{.chpuri2}結果物の型を知らないからです[。]{.chpule2}[
]{.chpuri2}ビルダーだけが正確に何を構築するのかを知っています[。]{.chpule2}[
]{.chpuri2}

### []{#example-0--builders .anchor} **builders** {#builders .example-title}

#### []{#example-0--builders-Builder-java .anchor} **builders/Builder.java:** 共通のビルダー・インターフェース
...
#### []{#example-0--builders-CarBuilder-java .anchor} **builders/CarBuilder.java:** 車のビルダー
...
#### []{#example-0--builders-CarManualBuilder-java .anchor} **builders/CarManualBuilder.java:** 車のマニュアルのビルダー
...
#### []{#example-0--cars-Car-java .anchor} **cars/Car.java:** 車プロダクト
...
#### []{#example-0--cars-Manual-java .anchor} **cars/Manual.java:** 車マニュアル・プロダクト
...
#### []{#example-0--components-Engine-java .anchor} **components/Engine.java:** プロダクト特性 1
...
#### []{#example-0--components-GPSNavigator-java .anchor} **components/GPSNavigator.java:** プロダクト特性 2
...
#### []{#example-0--components-Transmission-java .anchor} **components/Transmission.java:** プロダクト特性 3
...
#### []{#example-0--components-TripComputer-java .anchor} **components/TripComputer.java:** プロダクト特性 4
...
#### []{#example-0--director-Director-java .anchor} **director/Director.java:** ディレクターがビルダーを管理
...
[[]{.fa .fa-arrow-left} Abstract Factory を Java
で](../../abstract-factory/java/example.html){.btn .btn-default
rel="prev"}
:::
