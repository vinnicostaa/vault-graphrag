...
![デザインパターンを C#
で](../../images/patterns/languages/csharp322a.png?id=32ddb10fd07b29840082dc5337558053){.dp-bg
...
::: mob-image
![デザインパターンを C#
で](../../images/patterns/languages/mini/csharp61cd.png?id=1478058bfa2905cd71379e5908efd772){.dp-bg-mini
...
# [デザインパターン]{.dp1-h-1}[を C# で]{.dp1-h-2} {#デザインパターンを-c-で .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## **C#** で書かれた例題コードの[カタログ]{.dp-the-catalog} {#c-で書かれた例題コードのカタログ .dp-h2}
...
[ C#
での使用法](abstract-factory/csharp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](abstract-factory/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](builder/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](builder/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](factory-method/csharp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](factory-method/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](prototype/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](prototype/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](singleton/csharp/example.html#lang-features){.dp-pattern-link}
...
[
素朴なシングルトン](singleton/csharp/example.html#example-0){.dp-pattern-link}
...
[
スレッド・セーフなシングルトン](singleton/csharp/example.html#example-1){.dp-pattern-link}
...
[ C#
での使用法](adapter/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](adapter/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](bridge/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](bridge/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](composite/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](composite/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](decorator/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](decorator/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](facade/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](facade/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](flyweight/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](flyweight/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](proxy/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](proxy/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](chain-of-responsibility/csharp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](chain-of-responsibility/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](command/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](command/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](iterator/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](iterator/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](mediator/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](mediator/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](memento/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](memento/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](observer/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](observer/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](state/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](state/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](strategy/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](strategy/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](template-method/csharp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](template-method/csharp/example.html#example-0){.dp-pattern-link}
...
[ C#
での使用法](visitor/csharp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](visitor/csharp/example.html#example-0){.dp-pattern-link}
