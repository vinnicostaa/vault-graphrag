...
# **Visitor** を PHP で {#visitor-を-php-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Visitor パターンは[、]{.chpule2}[
]{.chpuri2}その複雑さと狭い適用範囲のため[、]{.chpule2}[ ]{.chpuri2}PHP
ではあまりよく使われません[。]{.chpule2}[ ]{.chpuri2}
::::::::::::::
...
パターンを使い[、]{.chpule2}[ ]{.chpuri2}既存のクラス階層[
]{.chpule1}[「]{.chpuri1}`Company > Department > Employee`[」]{.chpule2}[
]{.chpuri2}に新しいレポート機能を導入します[。]{.chpule2}[ ]{.chpuri2}

一旦 Visitor の仕組みがアプリに追加されれば[、]{.chpule2}[
]{.chpuri2}既存コードを変更することなく[、]{.chpule2}[
]{.chpuri2}アプリに違う類似の振る舞いを簡単に追加できます[。]{.chpule2}[
]{.chpuri2}
...
[[]{.fa .fa-arrow-left} Template Method を PHP
で](../../template-method/php/example.html){.btn .btn-default
rel="prev"}
:::
