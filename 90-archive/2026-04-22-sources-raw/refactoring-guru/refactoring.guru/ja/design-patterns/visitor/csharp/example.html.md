...
# **Visitor** を C# で {#visitor-を-c-で .pattern-example-title-block-title}
::::
...
[デザインパターンを C++ で []{.fa .fa-arrow-right}](../../cpp.html){.btn
...
[[]{.fa .fa-arrow-left} Template Method を C#
で](../../template-method/csharp/example.html){.btn .btn-default
rel="prev"}
:::
