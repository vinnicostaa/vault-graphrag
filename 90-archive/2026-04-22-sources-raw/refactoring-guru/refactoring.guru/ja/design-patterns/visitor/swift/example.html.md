...
[Visitor](../../visitor.html){.type} / [Swift](../../swift.html){.type}
:::
...
# **Visitor** を Swift で {#visitor-を-swift-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Template Method を Swift
で](../../template-method/swift/example.html){.btn .btn-default
rel="prev"}
:::
