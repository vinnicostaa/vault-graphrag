...
# **Visitor** を Python で {#visitor-を-python-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Template Method を Python
で](../../template-method/python/example.html){.btn .btn-default
rel="prev"}
:::
