...
# **Visitor** を Rust で {#visitor-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Template Method を Rust
で](../../template-method/rust/example.html){.btn .btn-default
rel="prev"}
:::
