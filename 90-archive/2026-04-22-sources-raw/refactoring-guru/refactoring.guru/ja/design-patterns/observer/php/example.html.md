...
# **Observer** を PHP で {#observer-を-php-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** PHP には[、]{.chpule2}[
]{.chpuri2}いくつかの組み込みのインターフェースがあり[
]{.chpule1}[（]{.chpuri1}[SplSubject](http://php.net/manual/en/class.splsubject.php)[、]{.chpule2}[
]{.chpuri2}[SplObserver](http://php.net/manual/en/class.splobserver.php)[）]{.ls-05}[、]{.chpule2}[
]{.chpuri2}それを使えば[、]{.chpule2}[ ]{.chpuri2}Observer
パターンを残りの PHP
コードと互換性があるように実装できます[。]{.chpule2}[ ]{.chpuri2}
...
パターンを使い[、]{.chpule2}[
]{.chpuri2}あるアプリのユーザー・リポジトリー[
]{.chpule1}[（]{.chpuri1}管理簿[）]{.chpule2}[
]{.chpuri2}内で起きるイベントを他のオブジェクトが監視できるようにします[。]{.chpule2}[
]{.chpuri2}

リポジトリーは[、]{.chpule2}[
]{.chpuri2}いろいろな種類のイベントを発生し[、]{.chpule2}[
]{.chpuri2}オブザーバーは[、]{.chpule2}[
]{.chpuri2}その全部について通知を受けることも[、]{.chpule2}[
]{.chpuri2}個別に通知を受けることもできます[。]{.chpule2}[ ]{.chpuri2}
...
[[]{.fa .fa-arrow-left} Memento を PHP
で](../../memento/php/example.html){.btn .btn-default rel="prev"}
:::
