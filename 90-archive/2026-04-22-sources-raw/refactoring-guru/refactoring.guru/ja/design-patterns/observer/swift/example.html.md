...
# **Observer** を Swift で {#observer-を-swift-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Memento を Swift
で](../../memento/swift/example.html){.btn .btn-default rel="prev"}
:::
