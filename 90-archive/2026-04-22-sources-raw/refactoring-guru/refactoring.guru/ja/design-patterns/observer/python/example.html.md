...
# **Observer** を Python で {#observer-を-python-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Memento を Python
で](../../memento/python/example.html){.btn .btn-default rel="prev"}
:::
