...
![デザインパターンを C++
で](../../images/patterns/languages/cppf7fa.png?id=57a67e9dfa3521c9dfc32d72201292cb){.dp-bg
...
::: mob-image
![デザインパターンを C++
で](../../images/patterns/languages/mini/cpp089c.png?id=9cccd56eacf8d8685cbd0ffe598a1c4c){.dp-bg-mini
...
[ C++
での使用法](abstract-factory/cpp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](abstract-factory/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](builder/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](builder/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](factory-method/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](factory-method/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](prototype/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](prototype/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](singleton/cpp/example.html#lang-features){.dp-pattern-link}
...
[
素朴なシングルトン](singleton/cpp/example.html#example-0){.dp-pattern-link}
...
[
スレッド・セーフなシングルトン](singleton/cpp/example.html#example-1){.dp-pattern-link}
...
[ C++
での使用法](adapter/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](adapter/cpp/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 多重継承](adapter/cpp/example.html#example-1){.dp-pattern-link}
...
[ C++
での使用法](bridge/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](bridge/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](composite/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](composite/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](decorator/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](decorator/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](facade/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](facade/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](flyweight/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](flyweight/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](proxy/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](proxy/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](chain-of-responsibility/cpp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](chain-of-responsibility/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](command/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](command/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](iterator/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](iterator/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](mediator/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](mediator/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](memento/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](memento/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](observer/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](observer/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](state/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](state/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](strategy/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](strategy/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](template-method/cpp/example.html#lang-features){.dp-pattern-link}
...
[
コード例](template-method/cpp/example.html#example-0){.dp-pattern-link}
...
[ C++
での使用法](visitor/cpp/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](visitor/cpp/example.html#example-0){.dp-pattern-link}
