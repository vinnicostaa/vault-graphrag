...
# **Mediator** を Java で {#mediator-を-java-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Java コードで Mediator
パターンが最もよく使われるのは[、]{.chpule2}[ ]{.chpuri2}アプリの GUI
...
-   [`java.util.Timer`](http://docs.oracle.com/javase/8/docs/api/java/util/Timer.html)[
    ]{.chpule1}[（]{.chpuri1}全 `schedule­XXX()` メソッド[）]{.chpule2}[
    ]{.chpuri2}
...
-   [`java.util.concurrent.ExecutorService`](http://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ExecutorService.html)[
    ]{.chpule1}[（]{.chpuri1}`invoke­XXX()` と `submit­()`
    メソッド[）]{.chpule2}[ ]{.chpuri2}
...
## ノート・アプリ {#example-0-title}

この例では[、]{.chpule2}[
]{.chpuri2}メディエーターを用いて[、]{.chpule2}[ ]{.chpuri2}多数の GUI
要素を[、]{.chpule2}[ ]{.chpuri2}互いに依存することなく[、]{.chpule2}[
]{.chpuri2}協力して動作できるよう[、]{.chpule2}[
]{.chpuri2}どう組織化できるかを示します[。]{.chpule2}[ ]{.chpuri2}

### []{#example-0--components .anchor} **components:** 同僚のクラス {#components-同僚のクラス .example-title}
...
#### []{#example-0--mediator-Mediator-java .anchor} **mediator/Mediator.java:** 共通メディエーター・インターフェースを定義する
...
#### []{#example-0--mediator-Editor-java .anchor} **mediator/Editor.java:** 具象メディエーター
...
#### []{#example-0--mediator-Note-java .anchor} **mediator/Note.java:** ノートのクラス
...
[[]{.fa .fa-arrow-left} Iterator を Java
で](../../iterator/java/example.html){.btn .btn-default rel="prev"}
:::
