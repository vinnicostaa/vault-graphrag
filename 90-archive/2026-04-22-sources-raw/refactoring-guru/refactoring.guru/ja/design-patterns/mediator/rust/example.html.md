...
# **Mediator** を Rust で {#mediator-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Iterator を Rust
で](../../iterator/rust/example.html){.btn .btn-default rel="prev"}
:::
