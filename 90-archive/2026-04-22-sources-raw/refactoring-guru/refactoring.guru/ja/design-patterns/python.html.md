...
![デザインパターンを Python
で](../../images/patterns/languages/pythond3fc.png?id=6f76a3e0854382007d9ee5a1b311a826){.dp-bg
...
::: mob-image
![デザインパターンを Python
で](../../images/patterns/languages/mini/python9ccc.png?id=7513863a9ad50bcc8de3b61a926bd832){.dp-bg-mini
...
# [デザインパターン]{.dp1-h-1}[を Python で]{.dp1-h-2} {#デザインパターンを-python-で .dp1-h .dp-abs .dp-c .dp-h1}
::::

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## **Python** で書かれた例題コードの[カタログ]{.dp-the-catalog} {#python-で書かれた例題コードのカタログ .dp-h2}
...
[ Python
での使用法](abstract-factory/python/example.html#lang-features){.dp-pattern-link}
...
[
コード例](abstract-factory/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](builder/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](builder/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](factory-method/python/example.html#lang-features){.dp-pattern-link}
...
[
コード例](factory-method/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](prototype/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](prototype/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](singleton/python/example.html#lang-features){.dp-pattern-link}
...
[
素朴なシングルトン](singleton/python/example.html#example-0){.dp-pattern-link}
...
[
スレッド・セーフなシングルトン](singleton/python/example.html#example-1){.dp-pattern-link}
...
[ Python
での使用法](adapter/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](adapter/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](bridge/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](bridge/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](composite/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](composite/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](decorator/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](decorator/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](facade/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](facade/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](flyweight/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](flyweight/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](proxy/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](proxy/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](chain-of-responsibility/python/example.html#lang-features){.dp-pattern-link}
...
[
コード例](chain-of-responsibility/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](command/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](command/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](iterator/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](iterator/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](mediator/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](mediator/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](memento/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](memento/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](observer/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](observer/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](state/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](state/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](strategy/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](strategy/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](template-method/python/example.html#lang-features){.dp-pattern-link}
...
[
コード例](template-method/python/example.html#example-0){.dp-pattern-link}
...
[ Python
での使用法](visitor/python/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](visitor/python/example.html#example-0){.dp-pattern-link}
