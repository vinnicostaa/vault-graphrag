...
# **Proxy** を Java で {#proxy-を-java-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}ほとんどの Java アプリケーションにおいては[、]{.chpule2}[
...
標準 Java ライブラリー内のプロキシーの例[：]{.chpule2}[ ]{.chpuri2}
...
-   [`javax.ejb.EJB`](http://docs.oracle.com/javaee/7/api/javax/ejb/EJB.html)[
    ]{.chpule1}[（]{.chpuri1}[コメント参照](http://stackoverflow.com/questions/25514361/when-using-ejb-does-each-managed-bean-get-its-own-ejb-instance)[）]{.chpule2}[
    ]{.chpuri2}
-   [`javax.inject.Inject`](http://docs.oracle.com/javaee/7/api/javax/inject/Inject.html)[
    ]{.chpule1}[（]{.chpuri1}[コメント参照](http://stackoverflow.com/questions/29651008/field-getobj-returns-all-nulls-on-injected-cdi-managed-beans-while-manually-i/29672591#29672591)[）]{.chpule2}[
    ]{.chpuri2}
...
## キャッシング・プロキシー {#example-0-title}

この例では[、]{.chpule2}[ ]{.chpuri2}遅延初期化と非効率な外部製作の
YouTube 統合ライブラリーのキャッシングの実装に[、]{.chpule2}[
]{.chpuri2}Proxy パターンが利用されています[。]{.chpule2}[ ]{.chpuri2}

変更不可能なクラスにいくつかの追加の振る舞いを加える必要がある時[、]{.chpule2}[
]{.chpuri2}Proxy は非常に貴重です[。]{.chpule2}[ ]{.chpuri2}

### []{#example-0--some_cool_media_library .anchor} **some_cool_media_library** {#some_cool_media_library .example-title}

#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeLib-java .anchor} **some_cool_media_library/ThirdPartyYouTubeLib.java:** リモート・サービス・インターフェース
...
#### []{#example-0--some_cool_media_library-ThirdPartyYouTubeClass-java .anchor} **some_cool_media_library/ThirdPartyYouTubeClass.java:** リモート・サービスの実装
...
#### []{#example-0--some_cool_media_library-Video-java .anchor} **some_cool_media_library/Video.java:** ビデオ・ファイル
...
#### []{#example-0--proxy-YouTubeCacheProxy-java .anchor} **proxy/YouTubeCacheProxy.java:** キャッシング・プロキシー
...
#### []{#example-0--downloader-YouTubeDownloader-java .anchor} **downloader/YouTubeDownloader.java:** メディア・ダウンローダー・アプリ
...
[Chain of Responsibility を Java で []{.fa
...
[[]{.fa .fa-arrow-left} Flyweight を Java
で](../../flyweight/java/example.html){.btn .btn-default rel="prev"}
:::
