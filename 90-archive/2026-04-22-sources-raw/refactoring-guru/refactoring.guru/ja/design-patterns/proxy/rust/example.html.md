...
[Proxy](../../proxy.html){.type} / [Rust](../../rust.html){.type}
:::
...
# **Proxy** を Rust で {#proxy-を-rust-で .pattern-example-title-block-title}
::::
...
[Chain of Responsibility を Rust で []{.fa
...
[[]{.fa .fa-arrow-left} Flyweight を Rust
で](../../flyweight/rust/example.html){.btn .btn-default rel="prev"}
:::
