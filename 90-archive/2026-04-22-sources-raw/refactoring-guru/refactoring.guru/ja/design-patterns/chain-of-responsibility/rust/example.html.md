...
# **Chain of Responsibility** を Rust で {#chain-of-responsibility-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Proxy を Rust
で](../../proxy/rust/example.html){.btn .btn-default rel="prev"}
:::
