...
# **Composite** を C++ で {#composite-を-c-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Bridge を C++
で](../../bridge/cpp/example.html){.btn .btn-default rel="prev"}
:::
