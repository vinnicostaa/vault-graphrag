...
# **Iterator** を Java で {#iterator-を-java-で .pattern-example-title-block-title}
::::
...
::: en-intro
 [ソーシャル・ネットワークのプロフィール上のイテレーション](#example-0)
:::
...
-   [`java.util.Iterator`](http://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html)[
    ...
    [`java.util.Scanner`](http://docs.oracle.com/javase/8/docs/api/java/util/Scanner.html)[）]{.chpule2}[
    ]{.chpuri2}の全実装
...
## ソーシャル・ネットワークのプロフィール上のイテレーション {#example-0-title}

この例では[、]{.chpule2}[ ]{.chpuri2}Iterator
パターンを使い[、]{.chpule2}[
]{.chpuri2}クライアント・コードに通信の詳細を公開することなく[、]{.chpule2}[
]{.chpuri2}リモートのソーシャル・ネットワーク上のプロフィールを探索します[。]{.chpule2}[
]{.chpuri2}

### []{#example-0--iterators .anchor} **iterators** {#iterators .example-title}

#### []{#example-0--iterators-ProfileIterator-java .anchor} **iterators/ProfileIterator.java:** プロフィール・インターフェースを定義
...
#### []{#example-0--iterators-FacebookIterator-java .anchor} **iterators/FacebookIterator.java:** Facebook プロフィール上のイテレーションを実装
...
#### []{#example-0--iterators-LinkedInIterator-java .anchor} **iterators/LinkedInIterator.java:** LinkedIn プロフィール上のイテレーションを実装
...
#### []{#example-0--social_networks-SocialNetwork-java .anchor} **social_networks/SocialNetwork.java:** 共通ソーシャル・ネットワーク・インターフェースを定義
...
#### []{#example-0--profile-Profile-java .anchor} **profile/Profile.java:** ソーシャル・プロフィール
...
#### []{#example-0--spammer-SocialSpammer-java .anchor} **spammer/SocialSpammer.java:** メッセージ送信アプリ
...
[[]{.fa .fa-arrow-left} Command を Java
で](../../command/java/example.html){.btn .btn-default rel="prev"}
:::
