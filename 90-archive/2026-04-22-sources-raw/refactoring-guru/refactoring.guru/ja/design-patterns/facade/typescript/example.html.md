...
# **Facade** を TypeScript で {#facade-を-typescript-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}TypeScript のアプリでよく見かけます[。]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Decorator を TypeScript
で](../../decorator/typescript/example.html){.btn .btn-default
rel="prev"}
:::
