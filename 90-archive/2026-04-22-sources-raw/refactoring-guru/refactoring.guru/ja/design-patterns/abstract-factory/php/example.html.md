...
# **Abstract Factory** を PHP で {#abstract-factory-を-php-で .pattern-example-title-block-title}
::::
...
この例では[、]{.chpule2}[ ]{.chpuri2} **Abstract Factory**
パターンは[、]{.chpule2}[
]{.chpuri2}ウェブ・ページの各種の要素に対してさまざまな型のテンプレートを作成するためのインフラストラクチャーを提供します[。]{.chpule2}[
]{.chpuri2}

ウェブ・アプリケーションは[、]{.chpule2}[
]{.chpuri2}異なるレンダリング・エンジンを同時にサポートできます[。]{.chpule2}[
]{.chpuri2}しかし[、]{.chpule2}[ ]{.chpuri2}そのクラスが[、]{.chpule2}[
]{.chpuri2}レンダリング・エンジンの具象クラスから独立している場合に限ります[。]{.chpule2}[
]{.chpuri2}したがって[、]{.chpule2}[
]{.chpuri2}アプリケーションのオブジェクトは[、]{.chpule2}[
]{.chpuri2}テンプレート・オブジェクトと[、]{.chpule2}[
]{.chpuri2}抽象インターフェースを介してのみ通信する必要があります[。]{.chpule2}[
]{.chpuri2}テンプレート・オブジェクトは直接作成するのではなく[、]{.chpule2}[
]{.chpuri2}特別なファクトリー・オブジェクトに委任するようにします[。]{.chpule2}[
]{.chpuri2}最後に[、]{.chpule2}[
]{.chpuri2}あなたのコードはファクトリー・オブジェクトにも依存するべきではありません[。]{.chpule2}[
]{.chpuri2}代わりに抽象的ファクトリー・インターフェースを介して作業をします[。]{.chpule2}[
]{.chpuri2}

その結果[、]{.chpule2}[
]{.chpuri2}レンダリング・エンジンのどれか一つに対応するファクトリー・オブジェクトをアプリに渡すことができます[。]{.chpule2}[
]{.chpuri2}アプリが作成するすべてのテンプレートは[、]{.chpule2}[
]{.chpuri2}そのファクトリーによって作成されたものなので[、]{.chpule2}[
]{.chpuri2}その型はファクトリーの型と一致します[。]{.chpule2}[
]{.chpuri2}レンダリング・エンジンを変更したい場合は[、]{.chpule2}[
]{.chpuri2}新しいファクトリーをクライアント・コードに渡すだけでよく[、]{.chpule2}[
]{.chpuri2}既存のコードは問題なく動作します[。]{.chpule2}[ ]{.chpuri2}
...
[[]{.fa .fa-arrow-left} デザインパターンを PHP で](../../php.html){.btn
