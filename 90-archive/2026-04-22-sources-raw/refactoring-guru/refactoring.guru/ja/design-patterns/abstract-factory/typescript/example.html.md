...
# **Abstract Factory** を TypeScript で {#abstract-factory-を-typescript-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} デザインパターンを TypeScript
で](../../typescript.html){.btn .btn-default rel="prev"}
:::
