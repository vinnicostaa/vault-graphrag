...
# **Singleton** を PHP で {#singleton-を-php-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}PHP コードでの使用が減少したのはこのためです[。]{.chpule2}[
]{.chpuri2}
...
]{.chpuri2}コードの再利用を妨げ[、]{.chpule2}[
]{.chpuri2}ユニット・テストを複雑にすることで悪い評判があります[。]{.chpule2}[
]{.chpuri2}しかし[、]{.chpule2}[
]{.chpuri2}場合によっては大変役に立ちます[。]{.chpule2}[
]{.chpuri2}特にある種の共用資源を管理する必要がある場合[、]{.chpule2}[
]{.chpuri2}便利です[。]{.chpule2}[ ]{.chpuri2}たとえば[、]{.chpule2}[
]{.chpuri2}ログ・ファイルへのアクセス制御を行う大域ロギング・オブジェクトが挙げられます[。]{.chpule2}[
]{.chpuri2}もう一つの例としては[、]{.chpule2}[
]{.chpuri2}実行時構成の共用記憶が挙げられます[。]{.chpule2}[ ]{.chpuri2}
...
[[]{.fa .fa-arrow-left} Prototype を PHP
で](../../prototype/php/example.html){.btn .btn-default rel="prev"}
:::
