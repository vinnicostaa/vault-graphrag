...
# **Adapter** を Swift で {#adapter-を-swift-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Adapter パターンは Swift
...
[[]{.fa .fa-arrow-left} Singleton を Swift
で](../../singleton/swift/example.html){.btn .btn-default rel="prev"}
:::
