...
# **Adapter** を Rust で {#adapter-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Singleton を Rust
で](../../singleton/rust/example.html){.btn .btn-default rel="prev"}
:::
