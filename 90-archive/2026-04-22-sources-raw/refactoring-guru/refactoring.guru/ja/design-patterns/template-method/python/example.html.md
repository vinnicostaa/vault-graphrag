...
# **Template Method** を Python で {#template-method-を-python-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Strategy を Python
で](../../strategy/python/example.html){.btn .btn-default rel="prev"}
:::
