...
# **Template Method** を Swift で {#template-method-を-swift-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Strategy を Swift
で](../../strategy/swift/example.html){.btn .btn-default rel="prev"}
:::
