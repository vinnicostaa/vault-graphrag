...
# **Decorator** を Swift で {#decorator-を-swift-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}Swift コードではかなり標準的で[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Composite を Swift
で](../../composite/swift/example.html){.btn .btn-default rel="prev"}
:::
