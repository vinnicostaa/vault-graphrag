...
# **Decorator** を Rust で {#decorator-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Composite を Rust
で](../../composite/rust/example.html){.btn .btn-default rel="prev"}
:::
