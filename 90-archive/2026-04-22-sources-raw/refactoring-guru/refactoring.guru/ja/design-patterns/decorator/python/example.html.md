...
# **Decorator** を Python で {#decorator-を-python-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}Python コードではかなり標準的で[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Composite を Python
で](../../composite/python/example.html){.btn .btn-default rel="prev"}
:::
