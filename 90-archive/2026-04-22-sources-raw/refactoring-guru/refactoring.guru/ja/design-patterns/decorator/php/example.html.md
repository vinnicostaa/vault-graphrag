...
# **Decorator** を PHP で {#decorator-を-php-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}PHP コードではかなり標準的で[、]{.chpule2}[
...
パターンを使用して[、]{.chpule2}[
]{.chpuri2}ウェブ・ページにテキストを描画する前に余計なものを取り除くための複雑なテキスト・フィルタリング規則を作成します[。]{.chpule2}[
]{.chpuri2}コメント[、]{.chpule2}[
]{.chpuri2}フォーラムへの投稿[、]{.chpule2}[
]{.chpuri2}私的なメッセージなど[、]{.chpule2}[
]{.chpuri2}内容の種類に応じて異なるフィルターの組み合わせを使用する必要があります[。]{.chpule2}[
]{.chpuri2}

たとえば[、]{.chpule2}[ ]{.chpuri2}コメントからすべての HTML
を取り除く場合でも[、]{.chpule2}[
]{.chpuri2}フォーラムの投稿では[、]{.chpule2}[ ]{.chpuri2}基本的な HTML
タグは残したいかもしれません[。]{.chpule2}[
]{.chpuri2}また[、]{.chpule2}[ ]{.chpuri2}Markdown
形式の投稿は許可したいかもしれませんが[、]{.chpule2}[ ]{.chpuri2}これは
HTML に対するフィルタリングの前に行われます[。]{.chpule2}[
]{.chpuri2}このようなフィルタリング規則は[、]{.chpule2}[
]{.chpuri2}個別のデコレーター・クラスとして表現されています[。]{.chpule2}[
]{.chpuri2}コンテンツの性質に応じて異なる組み合わせが可能です[。]{.chpule2}[
]{.chpuri2}
...
[[]{.fa .fa-arrow-left} Composite を PHP
で](../../composite/php/example.html){.btn .btn-default rel="prev"}
:::
