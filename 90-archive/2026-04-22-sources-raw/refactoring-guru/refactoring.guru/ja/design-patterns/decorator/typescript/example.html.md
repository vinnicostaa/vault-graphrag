...
# **Decorator** を TypeScript で {#decorator-を-typescript-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}TypeScript コードではかなり標準的で[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Composite を TypeScript
で](../../composite/typescript/example.html){.btn .btn-default
rel="prev"}
:::
