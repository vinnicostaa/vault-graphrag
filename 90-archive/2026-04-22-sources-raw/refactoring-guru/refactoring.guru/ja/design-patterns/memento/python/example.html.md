...
# **Memento** を Python で {#memento-を-python-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}Python ではよく見かけます[。]{.chpule2}[
]{.chpuri2}これは[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Mediator を Python
で](../../mediator/python/example.html){.btn .btn-default rel="prev"}
:::
