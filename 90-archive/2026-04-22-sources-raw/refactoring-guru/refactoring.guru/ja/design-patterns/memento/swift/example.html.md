...
# **Memento** を Swift で {#memento-を-swift-で .pattern-example-title-block-title}
::::
...
]{.chpuri2}Swift ではよく見かけます[。]{.chpule2}[
]{.chpuri2}これは[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Mediator を Swift
で](../../mediator/swift/example.html){.btn .btn-default rel="prev"}
:::
