...
# **Memento** を Rust で {#memento-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Mediator を Rust
で](../../mediator/rust/example.html){.btn .btn-default rel="prev"}
:::
