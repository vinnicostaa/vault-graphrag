...
# **Memento** を Java で {#memento-を-java-で .pattern-example-title-block-title}
::::
...
::: en-intro
 [図形エディターと複雑な取り消し・再実行操作](#example-0)
:::
...
]{.chpuri2}を使って達成することが可能で[、]{.chpule2}[ ]{.chpuri2}Java
ではよく見かけます[。]{.chpule2}[ ]{.chpuri2}これは[、]{.chpule2}[
...
-   [`java.io.Serializable`](http://docs.oracle.com/javase/8/docs/api/java/io/Serializable.html)
    の全実装は[、]{.chpule2}[ ]{.chpuri2}Memento をシミュレートできる
...
## 図形エディターと複雑な取り消し・再実行操作 {#example-0-title}

このグラフィカル・エディターは[、]{.chpule2}[
]{.chpuri2}画面上で図形の色と位置を変更できます[。]{.chpule2}[
]{.chpuri2}どのような変更も取り消したり繰り返したりできます[。]{.chpule2}[
]{.chpuri2}

[ ]{.chpule1}[「]{.chpuri1}取り消し[」]{.chpule2}[
]{.chpuri2}操作は[、]{.chpule2}[ ]{.chpuri2}Memento と Command
パターンの協力で行われます[。]{.chpule2}[
]{.chpuri2}エディターは[、]{.chpule2}[
]{.chpuri2}実行されたコマンドの履歴を追跡します[。]{.chpule2}[
]{.chpuri2}いかなるコマンドも[、]{.chpule2}[
]{.chpuri2}その実行前にバックアップを作り[、]{.chpule2}[
]{.chpuri2}それをコマンド・オブジェクトに接続します[。]{.chpule2}[
]{.chpuri2}実行後に[、]{.chpule2}[
]{.chpuri2}実行済みコマンドを履歴にプッシュします[。]{.chpule2}[
]{.chpuri2}

ユーザーが取り消しをリクエストした時[、]{.chpule2}[
]{.chpuri2}エディターは履歴から最近のコマンドを取得し[、]{.chpule2}[
]{.chpuri2}そのコマンドの内部に保存しておいたバックアップから状態を復元します[。]{.chpule2}[
]{.chpuri2}ユーザーが別の取り消しをリクエストした場合[、]{.chpule2}[
]{.chpuri2}エディターは履歴などから次のコマンドを取得します[。]{.chpule2}[
]{.chpuri2}

取り消されたコマンドは[、]{.chpule2}[
]{.chpuri2}ユーザーが画面上で何らかの図形の変更を行うまで[、]{.chpule2}[
]{.chpuri2}履歴に保持されます[。]{.chpule2}[
]{.chpuri2}これは[、]{.chpule2}[
]{.chpuri2}取り消されたコマンドの再実行を行う上で重要なことです[。]{.chpule2}[
]{.chpuri2}

### []{#example-0--editor .anchor} **editor** {#editor .example-title}

#### []{#example-0--editor-Editor-java .anchor} **editor/Editor.java:** エディター・コード
...
#### []{#example-0--editor-Canvas-java .anchor} **editor/Canvas.java:** キャンバス・コード
...
#### []{#example-0--history-History-java .anchor} **history/History.java:** 履歴にはコマンドとメメントが保存される
...
#### []{#example-0--history-Memento-java .anchor} **history/Memento.java:** メメント・クラス
...
#### []{#example-0--commands-Command-java .anchor} **commands/Command.java:** 基底コマンド・クラス
...
#### []{#example-0--commands-ColorCommand-java .anchor} **commands/ColorCommand.java:** 選択した図形の色を変更する
...
#### []{#example-0--commands-MoveCommand-java .anchor} **commands/MoveCommand.java:** 選択した図形を移動する
...
### []{#example-0--shapes .anchor} **shapes:** さまざまな図形 {#shapes-さまざまな図形 .example-title}
...
[[]{.fa .fa-arrow-left} Mediator を Java
で](../../mediator/java/example.html){.btn .btn-default rel="prev"}
:::
