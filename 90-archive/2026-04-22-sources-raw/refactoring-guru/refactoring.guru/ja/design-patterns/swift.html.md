...
![デザインパターンを Swift
で](../../images/patterns/languages/swift3479.png?id=c80166943c705fd91fa0008d7d5a9ca6){.dp-bg
...
::: mob-image
![デザインパターンを Swift
で](../../images/patterns/languages/mini/swiftee4d.png?id=fbce47967656c300c21842241d29b258){.dp-bg-mini
...
# [デザインパターン]{.dp1-h-1}[を Swift で]{.dp1-h-2} {#デザインパターンを-swift-で .dp1-h .dp-abs .dp-c .dp-h1}
::::

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## **Swift** で書かれた例題コードの[カタログ]{.dp-the-catalog} {#swift-で書かれた例題コードのカタログ .dp-h2}

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-double-cols
#### 生成に関するパターン {#生成に関するパターン .dp-h4 .dp-creational-title}
...
::: dp-pattern-intent
関連したオブジェクトの集りを[、]{.chpule2}[
]{.chpuri2}具象クラスを指定することなく生成することを可能にします[。]{.chpule2}[
]{.chpuri2}
:::
...
[ 主要記事](abstract-factory.html){.dp-pattern-link}
...
[ Swift
での使用法](abstract-factory/swift/example.html#lang-features){.dp-pattern-link}
...
[
概念的な例](abstract-factory/swift/example.html#example-0){.dp-pattern-link}
...
[
現実的な例](abstract-factory/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](builder.html){.dp-pattern-link}
...
[ Swift
での使用法](builder/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](builder/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](builder/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
スーパークラス内でオブジェクトを作成するためのインターフェースを提供しますが[、]{.chpule2}[
...
[ 主要記事](factory-method.html){.dp-pattern-link}
...
[ Swift
での使用法](factory-method/swift/example.html#lang-features){.dp-pattern-link}
...
[
概念的な例](factory-method/swift/example.html#example-0){.dp-pattern-link}
...
[
現実的な例](factory-method/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
既存オブジェクトのコピーをそのクラスに依存することなく可能とします[。]{.chpule2}[
]{.chpuri2}
:::
...
[ 主要記事](prototype.html){.dp-pattern-link}
...
[ Swift
での使用法](prototype/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](prototype/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](prototype/swift/example.html#example-1){.dp-pattern-link}
...
::: dp-pattern-intent
クラスが一つのインスタンスのみを持つことを保証するとともに[、]{.chpule2}[
...
[ 主要記事](singleton.html){.dp-pattern-link}
...
[ Swift
での使用法](singleton/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](singleton/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](singleton/swift/example.html#example-1){.dp-pattern-link}

</div>
:::::::
::::::::::

#### 構造に関するパターン {#構造に関するパターン .dp-h4 .dp-structural-title}
...
[ 主要記事](adapter.html){.dp-pattern-link}
...
[ Swift
での使用法](adapter/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](adapter/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](adapter/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](bridge.html){.dp-pattern-link}
...
[ Swift
での使用法](bridge/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](bridge/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](bridge/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](composite.html){.dp-pattern-link}
...
[ Swift
での使用法](composite/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](composite/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](composite/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](decorator.html){.dp-pattern-link}
...
[ Swift
での使用法](decorator/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](decorator/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](decorator/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](facade.html){.dp-pattern-link}
...
[ Swift
での使用法](facade/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](facade/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](facade/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](flyweight.html){.dp-pattern-link}
...
[ Swift
での使用法](flyweight/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](flyweight/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](flyweight/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](proxy.html){.dp-pattern-link}
...
[ Swift
での使用法](proxy/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](proxy/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](proxy/swift/example.html#example-1){.dp-pattern-link}
...
#### 振る舞いに関するパターン {#振る舞いに関するパターン .dp-h4 .dp-behavioral-title}
...
[ 主要記事](chain-of-responsibility.html){.dp-pattern-link}
...
[ Swift
での使用法](chain-of-responsibility/swift/example.html#lang-features){.dp-pattern-link}
...
[
概念的な例](chain-of-responsibility/swift/example.html#example-0){.dp-pattern-link}
...
[
現実的な例](chain-of-responsibility/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](command.html){.dp-pattern-link}
...
[ Swift
での使用法](command/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](command/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](command/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](iterator.html){.dp-pattern-link}
...
[ Swift
での使用法](iterator/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](iterator/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](iterator/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](mediator.html){.dp-pattern-link}
...
[ Swift
での使用法](mediator/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](mediator/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](mediator/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](memento.html){.dp-pattern-link}
...
[ Swift
での使用法](memento/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](memento/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](memento/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](observer.html){.dp-pattern-link}
...
[ Swift
での使用法](observer/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](observer/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](observer/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](state.html){.dp-pattern-link}
...
[ Swift
での使用法](state/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](state/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](state/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](strategy.html){.dp-pattern-link}
...
[ Swift
での使用法](strategy/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](strategy/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](strategy/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](template-method.html){.dp-pattern-link}
...
[ Swift
での使用法](template-method/swift/example.html#lang-features){.dp-pattern-link}
...
[
概念的な例](template-method/swift/example.html#example-0){.dp-pattern-link}
...
[
現実的な例](template-method/swift/example.html#example-1){.dp-pattern-link}
...
[ 主要記事](visitor.html){.dp-pattern-link}
...
[ Swift
での使用法](visitor/swift/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ 概念的な例](visitor/swift/example.html#example-0){.dp-pattern-link}

</div>

<div>

[ 現実的な例](visitor/swift/example.html#example-1){.dp-pattern-link}
