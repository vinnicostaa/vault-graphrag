...
# **Command** を TypeScript で {#command-を-typescript-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Chain of Responsibility を TypeScript
で](../../chain-of-responsibility/typescript/example.html){.btn
