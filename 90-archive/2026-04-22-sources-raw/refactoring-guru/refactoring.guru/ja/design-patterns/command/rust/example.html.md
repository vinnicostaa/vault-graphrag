...
# **Command** を Rust で {#command-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Chain of Responsibility を Rust
で](../../chain-of-responsibility/rust/example.html){.btn .btn-default
rel="prev"}
:::
