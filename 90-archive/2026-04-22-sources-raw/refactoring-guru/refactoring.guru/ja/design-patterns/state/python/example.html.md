...
# **State** を Python で {#state-を-python-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}**Python では[、]{.chpule2}[
...
[[]{.fa .fa-arrow-left} Observer を Python
で](../../observer/python/example.html){.btn .btn-default rel="prev"}
:::
