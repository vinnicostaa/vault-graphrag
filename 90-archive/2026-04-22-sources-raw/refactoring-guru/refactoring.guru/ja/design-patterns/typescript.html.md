...
![デザインパターンを TypeScript
で](../../images/patterns/languages/typescript30fb.png?id=8a56bc9bbee6cbe332781a4a2f6ef988){.dp-bg
...
::: mob-image
![デザインパターンを TypeScript
で](../../images/patterns/languages/mini/typescriptec96.png?id=2553a9060e09ea9fd354b67250af4682){.dp-bg-mini
...
# [デザインパターン]{.dp1-h-1}[を TypeScript で]{.dp1-h-2} {#デザインパターンを-typescript-で .dp1-h .dp-abs .dp-c .dp-h1}
::::

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: dp-text
## **TypeScript** で書かれた例題コードの[カタログ]{.dp-the-catalog} {#typescript-で書かれた例題コードのカタログ .dp-h2}
...
[ TypeScript
での使用法](abstract-factory/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](abstract-factory/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](builder/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](builder/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](factory-method/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](factory-method/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](prototype/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](prototype/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](singleton/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](singleton/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](adapter/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](adapter/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](bridge/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](bridge/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](composite/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](composite/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](decorator/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](decorator/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](facade/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](facade/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](flyweight/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](flyweight/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](proxy/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](proxy/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](chain-of-responsibility/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](chain-of-responsibility/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](command/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](command/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](iterator/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](iterator/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](mediator/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](mediator/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](memento/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](memento/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](observer/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](observer/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](state/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](state/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](strategy/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](strategy/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](template-method/typescript/example.html#lang-features){.dp-pattern-link}
...
[
コード例](template-method/typescript/example.html#example-0){.dp-pattern-link}
...
[ TypeScript
での使用法](visitor/typescript/example.html#lang-features){.dp-pattern-link}

</div>

<div>

[ コード例](visitor/typescript/example.html#example-0){.dp-pattern-link}
