...
# **Factory Method** を C# で {#factory-method-を-c-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Builder を C#
で](../../builder/csharp/example.html){.btn .btn-default rel="prev"}
:::
