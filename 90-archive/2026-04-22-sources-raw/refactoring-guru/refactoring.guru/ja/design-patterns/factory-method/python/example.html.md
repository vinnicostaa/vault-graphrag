...
# **Factory Method** を Python で {#factory-method-を-python-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Builder を Python
で](../../builder/python/example.html){.btn .btn-default rel="prev"}
:::
