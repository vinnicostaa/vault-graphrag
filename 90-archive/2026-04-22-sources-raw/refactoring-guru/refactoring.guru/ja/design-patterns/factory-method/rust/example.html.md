...
# **Factory Method** を Rust で {#factory-method-を-rust-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Builder を Rust
で](../../builder/rust/example.html){.btn .btn-default rel="prev"}
:::
