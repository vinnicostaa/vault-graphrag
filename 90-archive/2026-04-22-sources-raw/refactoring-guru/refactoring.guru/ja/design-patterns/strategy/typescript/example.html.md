...
# **Strategy** を TypeScript で {#strategy-を-typescript-で .pattern-example-title-block-title}
::::
...
[Template Method を TypeScript で []{.fa
...
[[]{.fa .fa-arrow-left} State を TypeScript
で](../../state/typescript/example.html){.btn .btn-default rel="prev"}
:::
