...
# **Flyweight** を PHP で {#flyweight-を-php-で .pattern-example-title-block-title}
::::
...
**使用例[：]{.chpule2}[ ]{.chpuri2}** Flyweight は[、]{.chpule2}[
]{.chpuri2}PHP アプリケーションでは特に稀です[。]{.chpule2}[
]{.chpuri2}これは[、]{.chpule2}[
]{.chpuri2}言語の性質のためと言えます[。]{.chpule2}[ ]{.chpuri2}典型的な
PHP スクリプトは[、]{.chpule2}[
]{.chpuri2}アプリケーション・データの一部だけを操作し[、]{.chpule2}[
]{.chpuri2}全データを同時にメモリーに読み込むことはありません[。]{.chpule2}[
]{.chpuri2}
...
まず初めに[、]{.chpule2}[ ]{.chpuri2}PHP での **Flyweight**
パターンの実際の適用はかなり珍しいということを念頭に置いてください[。]{.chpule2}[
]{.chpuri2}これは[、]{.chpule2}[ ]{.chpuri2}PHP
がシングル・スレッドであるということに起因します[。]{.chpule2}[
]{.chpuri2}同一スレッド内で同時にすべてのアプリケーション・オブジェクトをメモリーに置くということは[、]{.chpule2}[
]{.chpuri2}行うべきことではありません[。]{.chpule2}[
]{.chpuri2}この例は[、]{.chpule2}[
]{.chpuri2}実際のところあまり現実的ではなく[、]{.chpule2}[
]{.chpuri2}RAM
不足問題はアプリの構造の変更で解決できるかもしれません[。]{.chpule2}[
]{.chpuri2}しかしそれでも[、]{.chpule2}[
]{.chpuri2}概念的には[、]{.chpule2}[
]{.chpuri2}現実世界でのパターンの使用例として使えると思います[。]{.chpule2}[
]{.chpuri2}という断り書き付きで[、]{.chpule2}[
]{.chpuri2}では始めましょう[。]{.chpule2}[ ]{.chpuri2}

この例では[、]{.chpule2}[
]{.chpuri2}猫専門の動物病院の動物データベースで[、]{.chpule2}[
]{.chpuri2}オブジェクトによる RAM
使用量を最小限に抑えるために[、]{.chpule2}[ ]{.chpuri2}Flyweight
パターンを使用しています[。]{.chpule2}[
]{.chpuri2}データベース内の各レコードは[、]{.chpule2}[ ]{.chpuri2} `Cat`
オブジェクトで表されます[。]{.chpule2}[
]{.chpuri2}そのデータは以下の二つの部分で構成されています[：]{.chpule2}[
]{.chpuri2}

1.  ペットの名前[、]{.chpule2}[ ]{.chpuri2}年齢[、]{.chpule2}[
    ]{.chpuri2}飼い主情報などの固有[
    ]{.chpule1}[（]{.chpuri1}外因的[）]{.chpule2}[ ]{.chpuri2}データ
2.  品種名[、]{.chpule2}[ ]{.chpuri2}色[、]{.chpule2}[
    ]{.chpuri2}質感などの共有[
    ]{.chpule1}[（]{.chpuri1}内因的[）]{.chpule2}[ ]{.chpuri2}データ

最初の部分は[、]{.chpule2}[ ]{.chpuri2}`Cat`
クラス内に直接収められ[、]{.chpule2}[
]{.chpuri2}コンテキストの働きをします[。]{.chpule2}[
]{.chpuri2}二つ目の部分は[、]{.chpule2}[
]{.chpuri2}別個に蓄えられ[、]{.chpule2}[
]{.chpuri2}複数の猫が共有します[。]{.chpule2}[
]{.chpuri2}共有部分は[、]{.chpule2}[ ]{.chpuri2}`Cat­Variation`
クラスに収められます[。]{.chpule2}[
]{.chpuri2}類似の特徴のある猫は全部同じ`Cat­Variation`
オブジェクトに結合し[、]{.chpule2}[
]{.chpuri2}重複データをそれぞれのオブジェクトに格納することを避けることができます[。]{.chpule2}[
]{.chpuri2}
...
[[]{.fa .fa-arrow-left} Facade を PHP
で](../../facade/php/example.html){.btn .btn-default rel="prev"}
:::
