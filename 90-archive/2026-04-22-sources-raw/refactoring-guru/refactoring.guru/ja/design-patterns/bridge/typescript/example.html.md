...
# **Bridge** を TypeScript で {#bridge-を-typescript-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Adapter を TypeScript
で](../../adapter/typescript/example.html){.btn .btn-default rel="prev"}
:::
