...
# **Bridge** を Python で {#bridge-を-python-で .pattern-example-title-block-title}
::::
...
[[]{.fa .fa-arrow-left} Adapter を Python
で](../../adapter/python/example.html){.btn .btn-default rel="prev"}
:::
