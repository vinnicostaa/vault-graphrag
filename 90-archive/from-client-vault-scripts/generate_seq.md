---
title: generate_seq.js (script do cliente — gerador de canvas)
type: note
tags: [archive, master-sindico, scripts, javascript, canvas-generator]
source: Clients/MasterSindico/generate_seq.js (2026-03-10)
created: 2026-04-24
---

# `generate_seq.js` — script do cliente

Script Node.js do vault `Clients/MasterSindico/` que gera canvas `.canvas` programaticamente a partir de spec `{nodes, edges}`. **Arquivado** — não é conteúdo de produto, é ferramenta operacional do cliente.

- **Tamanho**: 7963 bytes / 200 linhas
- **Origem**: `~/Documentos/Obsidian Vault/Clients/MasterSindico/generate_seq.js`
- **Propósito**: gerar canvas auto a partir de spec JS — usado para produzir os 23 diagramas em [[../../50-projects/master-sindico/client-canvas/_moc]]
...
- [[_moc]]
- [[../../50-projects/master-sindico/client-canvas/_moc]] — canvas gerados
