...
Entregas Principais
Fundação, Identidade, Acesso, Onboarding, Connect Me,
Busca, Player
Motor de Gestão Condominial (Assembleias, Votação,
...
Sprint 3 semanas
Vizinhança e Promoções (Motor de Cupons), Clube de
3
Benefícios
Sprint 3 semanas
Conteúdo Educacional (LMS), Feedback Privado, Fórum, Lives,
4
Painel Admin, Currículos
