---
title: CLAUDE.md — sub-projeto mobile (Flutter)
type: agent-contract
tags: [master-sindico, mobile, flutter, dart, claude-contract]
project: master-sindico
subproject: mobile
source: _archive/2026-04-22-specs-consolidation/CLAUDE (copy 2).md
ingested: 2026-04-22
---

# CLAUDE.md — sub-projeto `app/` (Mobile/Flutter)

Guia para Claude Code operando no sub-projeto **`app/`** do Master Síndico (Flutter). Complementa [[../../CLAUDE]] (vault raiz) e [[../../CLAUDE|Master Síndico CLAUDE]]. Autoritativo sobre tudo que toca `app/`.
