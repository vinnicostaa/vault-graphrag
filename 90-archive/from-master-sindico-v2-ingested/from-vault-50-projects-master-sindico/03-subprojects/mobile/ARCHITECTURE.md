---
title: ARCHITECTURE — Mobile (Flutter)
type: note
tags: [master-sindico, mobile, flutter, architecture, clean-arch, feature-first]
project: master-sindico
subproject: mobile
source: _archive/2026-04-22-specs-consolidation/ARCHITECTURE.md
ingested: 2026-04-22
---

# 🔍 Architecture — Mobile (Flutter)

> Documento bilíngue (EN/PT) que explica **por que cada arquivo existe** na estrutura `lib/` do app Flutter — Clean Architecture + Feature First. Autoritativo para o sub-projeto `app/`. Ver também [[CLAUDE]] (contrato do agente) e [[CODING_MANUAL]] (regras de código).
