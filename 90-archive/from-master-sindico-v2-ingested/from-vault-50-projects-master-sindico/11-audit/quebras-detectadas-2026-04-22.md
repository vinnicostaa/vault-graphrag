...
- **Fix**: ver [[../06-execution/sdd-gsd-aplicado]] — recomendação de adicionar nota explicativa em `sdd-workflow.md` (1 linha) e mencionar Spec Kit como referência cognata.
