---
title: JORNADA DO MORADOR (PDF do cliente — texto extraído)
type: note
tags: [archive, master-sindico, client-pdf, extracted-text]
source: Clients/MasterSindico/contents/JORNADA DO MORADOR.pdf
created: 2026-04-24
---
...
- **PDF original**: 109595 bytes
- **Texto extraído**: 6310 caracteres
- **Origem**: `~/Documentos/Obsidian Vault/Clients/MasterSindico/contents/JORNADA DO MORADOR.pdf`
