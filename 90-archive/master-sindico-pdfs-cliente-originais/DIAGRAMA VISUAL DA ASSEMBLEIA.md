---
title: DIAGRAMA VISUAL DA ASSEMBLEIA (PDF do cliente — texto extraído)
type: note
tags: [archive, master-sindico, client-pdf, extracted-text]
source: Clients/MasterSindico/contents/DIAGRAMA VISUAL DA ASSEMBLEIA.pdf
created: 2026-04-24
---

# DIAGRAMA VISUAL DA ASSEMBLEIA
...
- **PDF original**: 75974 bytes
- **Texto extraído**: 3491 caracteres
- **Origem**: `~/Documentos/Obsidian Vault/Clients/MasterSindico/contents/DIAGRAMA VISUAL DA ASSEMBLEIA.pdf`

## Texto extraído

```text
DIAGRAMA VISUAL — MÓDULO ASSEMBLEIA MASTER SÍNDICO
...
(tipo, data, convocação, modalidade)
  │
  ▼
...
ETAPA 2 — PREPARAÇÃO DA ASSEMBLEIA

Após publicação.

PUBLICAÇÃO
 │
 ├── NOTIFICAÇÃO MORADORES
 │   │
 │   ▼
 │ REGISTRAR CIÊNCIA
 │   │
...
Executada por síndico e administradora.
