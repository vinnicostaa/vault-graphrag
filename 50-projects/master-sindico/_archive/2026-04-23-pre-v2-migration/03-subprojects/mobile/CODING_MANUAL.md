---
title: CODING_MANUAL — Mobile (Flutter/Dart)
type: note
tags: [master-sindico, mobile, flutter, dart, coding-standards, bilingual]
project: master-sindico
subproject: mobile
source: _archive/2026-04-22-specs-consolidation/CODING_MANUAL.md
ingested: 2026-04-22
---

# 📖 Coding Manual — Mobile (Flutter)

> Padrões **obrigatórios** e proibições explícitas pro código Dart/Flutter do sub-projeto `app/`. Comentários bilíngues (EN/PT). Autoritativo sobre code style mobile. Ver [[ARCHITECTURE]] pra estrutura e [[CLAUDE]] pro contrato de agente.
