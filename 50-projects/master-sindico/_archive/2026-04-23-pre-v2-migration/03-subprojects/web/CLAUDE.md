---
title: CLAUDE.md — sub-projeto web (SolidJS)
type: agent-contract
tags: [master-sindico, web, solidjs, typescript, claude-contract]
project: master-sindico
subproject: web
source: _archive/2026-04-22-specs-consolidation/CLAUDE (copy 3).md
ingested: 2026-04-22
---

# CLAUDE.md — sub-projeto `web/` (Frontend/SolidJS)

Guia para Claude Code operando no sub-projeto **`web/`** do Master Síndico. Complementa [[../../CLAUDE]] (vault raiz) e [[../../CLAUDE|Master Síndico CLAUDE]]. Autoritativo sobre tudo que toca `web/`.
