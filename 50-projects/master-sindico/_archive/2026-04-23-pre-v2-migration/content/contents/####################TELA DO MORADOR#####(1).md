---
title: "####################TELA DO MORADOR#####(1)"
type: source
tags: [ini, content, converted]
source: 50-projects/master-sindico/content/contents/####################TELA DO MORADOR#####(1).ini
...
Bloco 
Botões: Acessar
editar (Gerenciar meus acessos)
Excluir (pergunta do motivo de da exclusão, opcoes de (estou me mudando, vendi unidade, não quero mais acesso, outros)
...
Mantenha seus dados atualizados para garantir acesso legítimo.
...
Número da unidade
Bloco/Torre 
Seu vínculo: Proprietário ou Inquilino
Seu papel: Titular ou Dependente
Foto de identificacao (tirar foto no momento)
Regras exibidas:
...
TELA 8 – LINHA DO TEMPO (atividades realizadas no condomínio)
...
Lista estruturada:
Título da ação
Status (realizado, execução pendente) 
...
Cidade (auto)
UF (auto)
Bloco ou Torre (string pode ser mais de um bloco ou torre)
...
TELA 5 — IDENTIDADE DO CONDOMÍNIO (Etapa 3: ID/QR)
...
Quantidade de pessoas que votou
Score de Compliance (0–100, privado)
Taxa de adesão de moradores (titular/dependente por unidade) (quantos se cadastraram no condominio dele)
...
Connect Me
Validações Pendentes   ui  
Avaliações
Indicadores
Usuários   ui tag de empresas
Compliance
Relatório de Gestão
Modo Assembleia
...
Prazo para registro inicio e termino.  (prazo que a empresa pode registrar o servico)
...
3. Rejeitar (justificativa obrigatória)
...
Tipos (ampliado): Assembleia Ordinária; Assembleia Extraordinária; Reunião de Conselho; Prestação de Contas; Audiência Jurídica; Enquete Consultiva; Comunicado Operacional; Comunicado Emergencial; Aviso de Manutenção; Apresentação de Projeto; Reunião com Fornecedor; Treinamento; Simulado de Emergência; Interdição Temporária; Mudança de Procedimento; Campanha Institucional; Atualização Normativa; OutroCircular informativa

;Orientação ao morador;Comunicado de segurança;Comunicado de interdição temporária;Comunicado de conclusão;  esses tipos envia um aviso para o email da empresa contratada o comunicado.
...
Tipos sugeridos Aviso de início de se
...
Prazo para envio da proposta inicio e termino.
Gerar link externo para proposta
Prazo inicio e termino para preenchimento.
...
Campos obrigatórios: Categoria do serviço (opcional)
Descrição do serviço (texto) (opcional)
email (puxar automatico e pode editar)
numero (puxar automatico e pode editar)
nome  (puxar automatico e pode editar)
...
Ao enviar connect me se a empresa recusa, envia um email avisando ao sindico a recusa.
e a proposta dura 48 hrs.
---
...
enviar o link do condominio no link ou email para enviar a empresa parceiro.
...
MÓDULO COMPLIANCE dados de cada parte do complience
...
🔷 E11 — AVALIAÇÕES QUE RECEBEU
Critérios (escala 1 a 10)
Qualidade técnica (escala 1 a 10)
Cumprimento de prazo (escala 1 a 10)
Comunicação (escala 1 a 10)
Organização documental (escala 1 a 10)
Confiabilidade (escala 1 a 10)
Empresa pode
Manter privada
Resposta registrada e imutável.
🔷 E12 — INDICADORES DASHBOARD
