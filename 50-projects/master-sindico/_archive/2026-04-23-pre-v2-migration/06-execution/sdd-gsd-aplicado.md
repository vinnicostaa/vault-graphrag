...
> **Versão canônica** deste documento (2026-04-23). Há uma **versão histórica** preservada em [[../content/sdd-gsd-aplicado|content/sdd-gsd-aplicado]] (sem os links para os novos nós genéricos de 10-knowledge/methodology). Futuras edições mantidas aqui.
...
- [[../content/sdd-gsd-aplicado]] — versão histórica original (preservada)
...
- 2026-04-22 — promovido equivocadamente pra `10-knowledge/methodology/sdd-gsd.md` (reorg vault — só no clone filesystem)
- 2026-04-23 — **versão canônica** estabelecida aqui (`06-execution/sdd-gsd-aplicado.md`) via sync clone→vault real MCP; conceitos genéricos destilados em [[../../../10-knowledge/methodology/sdd-maturity-checklist]] + [[../../../10-knowledge/methodology/sdd-adoption-gaps]]. Versão histórica preservada em [[../content/sdd-gsd-aplicado]].
