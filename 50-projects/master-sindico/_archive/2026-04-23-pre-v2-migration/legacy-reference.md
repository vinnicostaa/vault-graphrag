...
|---|---|---|
| Análise técnica | `full-stack/contextos/ANALISE_COMPLETA.md` | Bugs e decisões do projeto anterior |
| Análise de modelagem | `full-stack/contextos/ANALISE_COMPLETA_MODELAGEM.md` | Schema DB, relacionamentos |
| Stripe context | `full-stack/contextos/stripe-context.md` | Fluxos de billing, webhooks, planos |
| Mux context | `full-stack/contextos/MUX_VIDEO_CONTEXT.md` | Upload, HLS, webhooks vídeo |
| Telas e fluxos | `full-stack/contextos/telas.md` | Jornadas por persona |
| Perfis/onboarding | `full-stack/contextos/ONBOARDING_CADASTRO_VS_PERFIL.md` | Regras onboarding por persona |
| Arquitetura proposta | `full-stack/docs/arquitetura-moderna-master-sindico.md` | Padrões a adotar no Go |
| Plano implementação | `full-stack/plans/master-sindico-implementation-plan.md` | Roadmap e prioridades |
