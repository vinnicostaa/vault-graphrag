...
- [Operating Behind the Power Curve](../../../2018/01/15/behindThePowerCurve.html)
  01-15-2018
- [Excuses](../../12/18/Excuses.html)
  12-18-2017
- [Dbtails](../../12/09/Dbtails.html)
  12-09-2017
- [Bobby Tables](../../12/03/BobbyTables.html)
  12-03-2017
...
- [First-Class Tests.](../../05/05/TestDefinitions.html)
  05-05-2017
- [Is Dr. Calvin in the Room?](../16/DrCalvin.html)
  03-16-2017
- [Symmetry Breaking](../07/SymmetryBreaking.html)
  03-07-2017
- [Testing Like the TSA](../06/TestingLikeTheTSA.html)
  03-06-2017
- [TDD Harms Architecture](TDD-Harms-Architecture.html)
  03-03-2017
...
The idea that TDD damages design and architecture is not new. DHH suggested as much several years ago with his notion of [Test Induced Design Damage](http://david.heinemeierhansson.com/2014/test-induced-design-damage.html); in which he compares the design he prefers to a design created by [Jim Weirich](https://en.wikipedia.org/wiki/Jim_Weirich) that is “testable”. The argument, boils down to separation and indirection. DHH’s concept of good design *minimizes* these attributes, whereas Weirich’s *maximizes* them.
...
Recently I’ve seen the argument resurface on twitter; though not in reference to DHH’s ideas; but instead in reference to a [very old interview](https://www.infoq.com/interviews/coplien-martin-tdd) between James Coplien and myself. In this case the argument is about using TDD to allow architecture to *emerge*. As you’ll discover, if you read through that interview, Cope and I agree that architecture does not emerge from TDD. The term I used, in that interview was, I believe – Horse shit.
...
![](../../../../assets/TDD_Harms_Architecture/user_service.jpg)
