...
# **Visitor** in PHP {#visitor-in-php .pattern-example-title-block-title}
::::
...
**Usage examples:** The Visitor pattern isn't very common in PHP code
...
This example illustrates the structure of the **Visitor** design pattern
...
other similar behaviors to the app, without changing the existing
classes.
