...
# **Bridge** in Java {#bridge-in-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Bridge between devices and remote controls](#example-0)
:::
...
## Bridge between devices and remote controls {#example-0-title}

This example shows separation between the classes of remotes and devices
that they control.
...
#### []{#example-0--devices-Device-java .anchor} **devices/Device.java:** Common interface of all devices
...
#### []{#example-0--remotes-Remote-java .anchor} **remotes/Remote.java:** Common interface for all remotes
...
#### []{#example-0--remotes-BasicRemote-java .anchor} **remotes/BasicRemote.java:** Basic remote control
...
#### []{#example-0--remotes-AdvancedRemote-java .anchor} **remotes/AdvancedRemote.java:** Advanced remote control
