...
# **Abstract Factory** in TypeScript {#abstract-factory-in-typescript .pattern-example-title-block-title}
::::
...
TypeScript code. Many frameworks and libraries use it to provide a way
