...
# **Command** in Swift {#command-in-swift .pattern-example-title-block-title}
::::
...
**Usage examples:** The Command pattern is pretty common in Swift code.
