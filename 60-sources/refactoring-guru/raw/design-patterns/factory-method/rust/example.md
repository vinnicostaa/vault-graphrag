...
# **Factory Method** in Rust {#factory-method-in-rust .pattern-example-title-block-title}
::::
...
The [Abstract Factory example](../../abstract-factory/rust/example.html)
