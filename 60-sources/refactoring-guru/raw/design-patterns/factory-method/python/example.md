...
# **Factory Method** in Python {#factory-method-in-python .pattern-example-title-block-title}
::::
...
**Usage examples:** The Factory Method pattern is widely used in Python
