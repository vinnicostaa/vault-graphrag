...
# **Factory Method** in Swift {#factory-method-in-swift .pattern-example-title-block-title}
::::
...
**Usage examples:** The Factory Method pattern is widely used in Swift
