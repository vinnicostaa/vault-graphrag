...
# **Factory Method** in TypeScript {#factory-method-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The Factory Method pattern is widely used in
TypeScript code. It's very useful when you need to provide a high level
