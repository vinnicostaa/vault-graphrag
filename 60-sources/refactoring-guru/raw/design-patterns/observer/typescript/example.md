...
# **Observer** in TypeScript {#observer-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The Observer pattern is pretty common in TypeScript
