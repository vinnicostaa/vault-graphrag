...
# **Mediator** in Python {#mediator-in-python .pattern-example-title-block-title}
::::
...
Python code is facilitating communications between GUI components of an
