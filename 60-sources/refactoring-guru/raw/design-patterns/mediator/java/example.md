...
# **Mediator** in Java {#mediator-in-java .pattern-example-title-block-title}
::::
...
Java code is facilitating communications between GUI components of an
...
## Notes app {#example-0-title}

This example shows how to organize lots of GUI elements so that they
cooperate with the help of a mediator but don't depend on each other.

### []{#example-0--components .anchor} **components:** Colleague classes {#components-colleague-classes .example-title}
...
#### []{#example-0--mediator-Mediator-java .anchor} **mediator/Mediator.java:** Defines common mediator interface
...
#### []{#example-0--mediator-Editor-java .anchor} **mediator/Editor.java:** Concrete mediator
...
#### []{#example-0--mediator-Note-java .anchor} **mediator/Note.java:** A note's class
