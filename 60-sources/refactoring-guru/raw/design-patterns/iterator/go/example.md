...
# **Iterator** in Go {#iterator-in-go .pattern-example-title-block-title}
::::
...
The main idea behind the Iterator pattern is to extract the iteration
logic of a collection into a different object called iterator. This
iterator provides a generic method of iterating over a collection
...
#### []{#example-0--userCollection-go .anchor} **userCollection.go:** Concrete collection
...
#### []{#example-0--userIterator-go .anchor} **userIterator.go:** Concrete iterator
...
#### []{#example-0--user-go .anchor} **user.go:** Client code
