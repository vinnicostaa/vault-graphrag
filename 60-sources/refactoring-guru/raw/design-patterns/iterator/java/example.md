...
# **Iterator** in Java {#iterator-in-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Iterating over social network profiles](#example-0)
:::
...
**Usage examples:** The pattern is very common in Java code. Many
...
## Iterating over social network profiles {#example-0-title}

In this example, the Iterator pattern is used to go over social profiles
of a remote social network collection without exposing any of the
communication details to the client code.

### []{#example-0--iterators .anchor} **iterators** {#iterators .example-title}

#### []{#example-0--iterators-ProfileIterator-java .anchor} **iterators/ProfileIterator.java:** Defines profile interface
...
#### []{#example-0--iterators-FacebookIterator-java .anchor} **iterators/FacebookIterator.java:** Implements iteration over Facebook profiles
...
#### []{#example-0--iterators-LinkedInIterator-java .anchor} **iterators/LinkedInIterator.java:** Implements iteration over LinkedIn profiles
...
#### []{#example-0--social_networks-SocialNetwork-java .anchor} **social_networks/SocialNetwork.java:** Defines common social network interface
...
#### []{#example-0--profile-Profile-java .anchor} **profile/Profile.java:** Social profiles
...
#### []{#example-0--spammer-SocialSpammer-java .anchor} **spammer/SocialSpammer.java:** Message sending app
