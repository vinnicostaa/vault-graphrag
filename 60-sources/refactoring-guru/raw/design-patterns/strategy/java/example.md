...
# **Strategy** in Java {#strategy-in-java .pattern-example-title-block-title}
::::
...
::: en-intro
 [Payment method in an e-commerce app](#example-0)
:::
...
Java 8 brought the support of lambda functions, which can serve as
simpler alternatives to the Strategy pattern.
...
## Payment method in an e-commerce app {#example-0-title}

In this example, the Strategy pattern is used to implement the various
payment methods in an e-commerce application. After selecting a product
to purchase, a customer picks a payment method: either Paypal or credit
card.

Concrete strategies not only perform the actual payment but also alter
the behavior of the checkout form, providing appropriate fields to
record payment details.

### []{#example-0--strategies .anchor} **strategies** {#strategies .example-title}

#### []{#example-0--strategies-PayStrategy-java .anchor} **strategies/PayStrategy.java:** Common interface of payment methods
...
#### []{#example-0--strategies-PayByPayPal-java .anchor} **strategies/PayByPayPal.java:** Payment via PayPal
...
#### []{#example-0--strategies-PayByCreditCard-java .anchor} **strategies/PayByCreditCard.java:** Payment via credit card
...
#### []{#example-0--strategies-CreditCard-java .anchor} **strategies/CreditCard.java:** A credit card class
...
#### []{#example-0--order-Order-java .anchor} **order/Order.java:** Order class
