...
# **Strategy** in TypeScript {#strategy-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The Strategy pattern is very common in TypeScript
code. It's often used in various frameworks to provide users a way to
...
[Template Method in TypeScript []{.fa
