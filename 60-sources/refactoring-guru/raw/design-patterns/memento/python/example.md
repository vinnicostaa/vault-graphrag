...
# **Memento** in Python {#memento-in-python .pattern-example-title-block-title}
::::
...
serialization, which is quite common in Python. While it's not the only
