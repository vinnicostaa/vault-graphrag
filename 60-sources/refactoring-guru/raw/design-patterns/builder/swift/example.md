...
# **Builder** in Swift {#builder-in-swift .pattern-example-title-block-title}
::::
...
**Usage examples:** The Builder pattern is a well-known pattern in Swift
