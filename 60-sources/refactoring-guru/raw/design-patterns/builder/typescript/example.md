...
# **Builder** in TypeScript {#builder-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The Builder pattern is a well-known pattern in
TypeScript world. It's especially useful when you need to create an
object with lots of possible configuration options.
...
[Factory Method in TypeScript []{.fa
