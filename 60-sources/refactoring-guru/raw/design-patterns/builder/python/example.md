...
# **Builder** in Python {#builder-in-python .pattern-example-title-block-title}
::::
...
Python world. It's especially useful when you need to create an object
