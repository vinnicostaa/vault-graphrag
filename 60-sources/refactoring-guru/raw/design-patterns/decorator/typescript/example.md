...
# **Decorator** in TypeScript {#decorator-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The Decorator is pretty standard in TypeScript code,
