...
# **Composite** in Swift {#composite-in-swift .pattern-example-title-block-title}
::::
...
**Usage examples:** The Composite pattern is pretty common in Swift
code. It's often used to represent hierarchies of user interface
