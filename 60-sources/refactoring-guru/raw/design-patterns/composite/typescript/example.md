...
# **Composite** in TypeScript {#composite-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The Composite pattern is pretty common in TypeScript
