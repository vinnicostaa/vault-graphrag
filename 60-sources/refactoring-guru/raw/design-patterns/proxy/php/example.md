...
# **Proxy** in PHP {#proxy-in-php .pattern-example-title-block-title}
::::
...
most PHP applications, it's still very handy in some special cases. It's
...
There are countless ways **proxies** can be used: caching, logging,
access control, delayed initialization, etc. This example demonstrates
how the Proxy pattern can improve the performance of a downloader object
by caching its results.
...
[Chain of Responsibility in PHP []{.fa
