...
# **Proxy** in TypeScript {#proxy-in-typescript .pattern-example-title-block-title}
::::
...
most TypeScript applications, it's still very handy in some special
cases. It's irreplaceable when you want to add some additional behaviors
...
[Chain of Responsibility in TypeScript []{.fa
