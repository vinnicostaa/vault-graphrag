...
# **Proxy** in Swift {#proxy-in-swift .pattern-example-title-block-title}
::::
...
most Swift applications, it's still very handy in some special cases.
...
[Chain of Responsibility in Swift []{.fa
