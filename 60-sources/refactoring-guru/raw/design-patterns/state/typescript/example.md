...
# **State** in TypeScript {#state-in-typescript .pattern-example-title-block-title}
::::
...
**Usage examples:** The State pattern is commonly used in TypeScript to
