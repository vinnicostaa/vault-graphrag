...
# **Chain of Responsibility** in Python {#chain-of-responsibility-in-python .pattern-example-title-block-title}
::::
...
Python. It's mostly relevant when your code operates with chains of
