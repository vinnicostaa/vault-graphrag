...
# **Chain of Responsibility** in Ruby {#chain-of-responsibility-in-ruby .pattern-example-title-block-title}
::::
...
Ruby. It's mostly relevant when your code operates with chains of
