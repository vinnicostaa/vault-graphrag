...
# **Template Method** in PHP {#template-method-in-php .pattern-example-title-block-title}
::::
...
**Usage examples:** The Template Method pattern is quite common in PHP
frameworks. The pattern simplifies the extension of a default
...
In this example, the **Template Method** pattern defines a skeleton of
the algorithm of message posting to social networks. Each subclass
represents a separate social network and implements all the steps
differently, but reuses the base algorithm.
