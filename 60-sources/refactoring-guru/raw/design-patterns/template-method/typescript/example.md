...
# **Template Method** in TypeScript {#template-method-in-typescript .pattern-example-title-block-title}
::::
...
TypeScript frameworks. Developers often use it to provide framework
users with a simple means of extending standard functionality using
inheritance.
