...
::: dd
If you only want one special method, which doesn\'t exist in service
class, and you can\'t extend it, move it to the client class and pass
the object of a service class as a parameter.
:::
:::::
::::::
