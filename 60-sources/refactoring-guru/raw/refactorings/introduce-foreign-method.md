...
-   The reasons for having the method of a utility class in a client
    ...
    you. If the method can be used in other classes, you could benefit
    by creating a wrapper for the utility class and placing the method
    there. This is also beneficial when there are several such utility
    methods. [Introduce Local Extension](introduce-local-extension.html)
    can help with this.
...
::: dd
Move all extension methods to a separate class, which is wrapper or a
subclass of some service class.
:::
:::::
::::::
